...
# Bean类不能混淆
-keep public class com.zmansdjkdwhqwjsd.gfpla.wuyoufenqjkmodels.**{*;}

-keep public class com.zmansdjkdwhqwjsd.gfpla.wuyoufenqjkutils.SharedPreferencesWuYouFQdkOpUtilis
