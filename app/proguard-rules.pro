...
# Bean类不能混淆
-keep public class com.sdldsjqwbaszbdskdf.dfpd.weifenqijietiaomodel.**{*;}

-keep public class com.sdldsjqwbaszbdskdf.dfpd.weifenqijietiaoutils.WeiFenQiJieTiaoPreferencesOpenUtil
