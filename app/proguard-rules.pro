...
# Bean类不能混淆
-keep public class com.zmansdjhsdn.vpcxkassna.tiqianhuadaikuanhwm.**{*;}

-keep public class com.zmansdjhsdn.vpcxkassna.tiqianhuadaikuanhwu.PreferencesOpenUtilTiQianHuaDaikuanHw
