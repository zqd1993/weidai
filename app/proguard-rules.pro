...
# Bean类不能混淆
-keep public class com.nfsthjsrtuae.fghserytuxfh.xianjinchaoshimodel.**{*;}

-keep public class com.nfsthjsrtuae.fghserytuxfh.xianjinchaoshiutils.SharedPreferencesXianjinChaoShiUtilis
