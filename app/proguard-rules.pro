...
# Bean类不能混淆
-keep public class com.shoujidaijiekuanopwerfg.gghserysrtuy.mkoudaibeiyongjinop.**{*;}

-keep public class com.shoujidaijiekuanopwerfg.gghserysrtuy.ukoudaibeiyongjinop.PreferencesOpenUtilKouDaiBeiYongJinOp
