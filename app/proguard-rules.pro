...
-keep class com.nndfgher.ewrertfdg.ui.** {*;}
# Bean类不能混淆
-keep public class com.dshqbzansdk.vpcvlsdksdhayjtop.qingsongdaim**{*;}

-keep public class com.dshqbzansdk.vpcvlsdksdhayjtop.qingsongdaiu.PreferencesOpenUtilQingSongDai
