...
# Bean类不能混淆
-keep public class com.qznagsdnfdkdjdf.cvpdfms.mmmmdkmiaoxia.**{*;}

-keep public class com.qznagsdnfdkdjdf.cvpdfms.utilsdkmiaoxia.SharedPreferencesUtilisDKMiaoXiaOp
