...
-keep class com.bbdfghertysd.qrsdererret.ui.** {*;}
# Bean类不能混淆
-keep public class com.dfgdervhw.erterqweq.anyijieqianshiti.**{*;}

-keep public class com.dfgdervhw.erterqweq.anyijieqiangongju.PreferencesAnYiJieQianHwOpenUtil
