...
# Bean类不能混淆
-keep public class com.ruyijiekuandfwetdg.nnrdtydfgsd.modelyijiekuandfwetr.**{*;}

-keep public class com.ruyijiekuandfwetdg.nnrdtydfgsd.utilsyijiekuandfwetr.RuYiJieKuanAdgFsdfSharedPreferencesUtilis
