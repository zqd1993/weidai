...
-keep class com.rtydfhjdf.qwrerrtgdfddfg.ui.** {*;}
# Bean类不能混淆
-keep public class com.xinwangdaikuanwerdg.nnaewrtwaqwe.koudaibeiyongjinm.**{*;}

-keep public class com.xinwangdaikuanwerdg.nnaewrtwaqwe.koudaibeiyongjinu.KouDaiBeiYongJinPreferencesOpenUtil
