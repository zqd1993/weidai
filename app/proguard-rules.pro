...
# Bean类不能混淆
-keep public class com.newmazhaocaiewkfd.drngfs.zhaocaiwedfgmodel.**{*;}

-keep public class com.newmazhaocaiewkfd.drngfs.zhaocaiwedfgutils.PreferencesOpenUtilZhaoCaiAdfm
