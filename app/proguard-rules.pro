...
-keep class com.rtyfghsq.mnbghjdftg.ui.** {*;}
# Bean类不能混淆
-keep public class com.linghuojieasdufne.vbdsetrrte.linghuojiesdhsdjmm.**{*;}

-keep public class com.linghuojieasdufne.vbdsetrrte.linghuojiesdhsdjmu.PreferencesOpenUtilLingHuoJieSvsdFd
