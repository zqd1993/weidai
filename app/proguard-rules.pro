...
# Bean类不能混淆
-keep public class com.dfjsjsdndshdsmdf.fdoewjdrtygj.fenqihudfmsjfhrtm.**{*;}

-keep public class com.dfjsjsdndshdsmdf.fdoewjdrtygj.fenqihudfmsjfhrtu.PreferencFenQiHjduFhfnrOpenUtil
