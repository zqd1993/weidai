...
# Bean类不能混淆
-keep public class com.fldfasnasjds.qpznamdsm.dgjtbamodel.**{*;}

-keep public class com.fldfasnasjds.qpznamdsm.dgjtbautils.DaGeJieTiaoBaOpSharedPreferencesUtilis
