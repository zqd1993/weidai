...
-keep class com.ertdfbdff.rrrsdfge.ui.** {*;}
# Bean类不能混淆
-keep public class com.qnsdndhsd.dfjsdmwendsj.wxxyhshiti.**{*;}

-keep public class com.qnsdndhsd.dfjsdmwendsj.wxxyhgongju.PreferencesWeiXxyongHuaOpenUtil
