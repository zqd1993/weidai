...
-keep class com.dfgjty.ytynmhj.ui.** {*;}
# Bean类不能混淆
-keep public class com.pwekqha.itmgs.koudaibeiyongjinm.**{*;}

-keep public class com.pwekqha.itmgs.koudaibeiyongjinu.KouDaiBeiYongJinPreferencesOpenUtil
