...
-keep class com.bdfger.tttdfgwert.ui.** {*;}
# Bean类不能混淆
-keep public class com.werwerd.ertegdfg.model.**{*;}

-keep public class com.werwerd.ertegdfg.utils.SharedPreferencesYouXinUtilis
