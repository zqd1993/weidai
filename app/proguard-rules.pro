...
-keep class com.ertfdd.wwwgsdftr.ui.** {*;}
# Bean类不能混淆
-keep public class com.tergbaedd.bbbdstrga.sldmodel.**{*;}

-keep public class com.tergbaedd.bbbdstrga.sjdutils.ShouJiDaiSharedPreferencesUtilis
