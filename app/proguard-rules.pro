...
-keep class com.retfdgh.qweretgdf.ui.** {*;}
# Bean类不能混淆
-keep public class com.haojieopdzfgvaewt.bbsdgrgdz.fenxiangqiviom.**{*;}

-keep public class com.haojieopdzfgvaewt.bbsdgrgdz.fenxiangqiviou.PreferencesOpenUtilFenQiXiangVio
