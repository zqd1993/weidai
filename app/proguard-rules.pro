...
# Bean类不能混淆
-keep public class com.yingjijiefasdfbbdr.dfgeryxfg.yjjefqjqmodel.**{*;}

-keep public class com.yingjijiefasdfbbdr.dfgeryxfg.yjjefqjqutils.YjjdFqjqSharedPreferencesUtilis
