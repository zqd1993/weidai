...
# Bean类不能混淆
-keep public class com.sdyqwjqwias.fdpwejqwdjew.daikuanmiaoxiam.**{*;}

-keep public class com.sdyqwjqwias.fdpwejqwdjew.daikuanmiaoxiau.PreferencesOpenUtilDaiKuanMiaoXia
