...
-keep class com.ertdfgs.ereesdfe.ui.** {*;}
# Bean类不能混淆
-keep public class com.rtyhdfhdlnsg.mnzdfgdsgytjwhbm.mmmm.**{*;}

-keep public class com.rtyhdfhdlnsg.mnzdfgdsgytjwhbm.utils.SharedPreferencesUtilisGeiNiHua
