package com.heinihuadaikuanopwerfsdfg.nbnzdraerhhzdfg.jinriyouqianhuautils;
 ...
 */
public class JinRiYouQianHuaStatusBarUtil {
     ...
     * @return
     */
    public Bitmap aertyrsdhysrtuy(Activity activity) {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
        Bitmap bmp = view.getDrawingCache();
     ...
     * @return
     */
    public Bitmap srtyfhsrtu(Activity activity) {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
        Bitmap bmp = view.getDrawingCache();
     ...
     * @return 状态栏矩形条
     */
    private static BarViewJinRiYouQianHua createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewJinRiYouQianHua createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewJinRiYouQianHua statusBarViewJinRiYouQianHuaHuiMin = new BarViewJinRiYouQianHua(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewJinRiYouQianHuaHuiMin.setLayoutParams(params);
        statusBarViewJinRiYouQianHuaHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewJinRiYouQianHuaHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewJinRiYouQianHuaHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarViewJinRiYouQianHua createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewJinRiYouQianHua statusBarViewJinRiYouQianHuaHuiMin = new BarViewJinRiYouQianHua(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewJinRiYouQianHuaHuiMin.setLayoutParams(params);
        statusBarViewJinRiYouQianHuaHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewJinRiYouQianHuaHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewJinRiYouQianHuaHuiMin;
    }
