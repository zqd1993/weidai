...
public class RemindJinRiYouQianHuaDialog extends Dialog {
    ...
    public RemindJinRiYouQianHuaDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_jin_ri_you_qian_hua_normal);
    ...
    public RemindJinRiYouQianHuaDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindJinRiYouQianHuaDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindJinRiYouQianHuaDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindJinRiYouQianHuaDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }
    ...
    public RemindJinRiYouQianHuaDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
