...
public class ClickTextViewJinRiYouQianHua extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewJinRiYouQianHua(Context context) {
        super(context);
    }
    ...
    public ClickTextViewJinRiYouQianHua(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewJinRiYouQianHua(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
