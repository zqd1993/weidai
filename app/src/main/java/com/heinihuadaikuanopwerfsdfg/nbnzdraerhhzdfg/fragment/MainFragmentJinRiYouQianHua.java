...
import com.heinihuadaikuanopwerfsdfg.nbnzdraerhhzdfg.jinriyouqianhuaactivity.JinRiYouQianHuaImageAdapter;
import com.heinihuadaikuanopwerfsdfg.nbnzdraerhhzdfg.jinriyouqianhuaactivity.JumpH5ActivityJinRiYouQianHua;
import com.heinihuadaikuanopwerfsdfg.nbnzdraerhhzdfg.jinriyouqianhuaactivity.JinRiYouQianHuaMainActivity;
...
import com.heinihuadaikuanopwerfsdfg.nbnzdraerhhzdfg.jinriyouqianhuamodel.JinRiYouQianHuaBannerModel;
                    ...
                    public void onNext(JinRiYouQianHuaBaseModel<List<JinRiYouQianHuaBannerModel>> jinRiYouQianHuaBaseModel) {
                        if (jinRiYouQianHuaBaseModel != null) {
                            if (jinRiYouQianHuaBaseModel.getCode() == 200) {
                                if (jinRiYouQianHuaBaseModel.getData() != null && jinRiYouQianHuaBaseModel.getData().size() > 0) {
                                    ILFactory.getLoader().loadNet(banner_img, JinRiYouQianHuaHttpApi.HTTP_API_URL + jinRiYouQianHuaBaseModel.getData().get(0).getLogo(),
