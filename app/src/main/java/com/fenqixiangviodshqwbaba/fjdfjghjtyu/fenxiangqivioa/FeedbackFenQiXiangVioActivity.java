...
public class FeedbackFenQiXiangVioActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feedback_fen_xiang_qi_vio);
        ...
        commitBtn.setOnClickListener(v -> {
            if (feedbackEt.getText().toString().trim().isEmpty()){
                MyFenQiXiangVioToast.showShort("请输入您的意见反馈");
                return;
            } else {
                if (xStateController != null){
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            MyFenQiXiangVioToast.showShort("提交成功");
                            finish();
                        }
                    }, 2000);
                }
