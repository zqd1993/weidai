...
public class TabFenQiXiangVioAdapter extends BaseQuickAdapter<MainFenQiXiangVioActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabFenQiXiangVioAdapter(int layoutResId, @Nullable List<MainFenQiXiangVioActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainFenQiXiangVioActivity.TabModel item) {
