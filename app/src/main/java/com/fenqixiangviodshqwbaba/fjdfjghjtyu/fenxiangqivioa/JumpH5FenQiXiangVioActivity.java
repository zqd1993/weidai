...
import com.fenqixiangviodshqwbaba.fjdfjghjtyu.fenxiangqiviou.DownloadApkUtilFenQiXiangVio;
...
public class JumpH5FenQiXiangVioActivity extends XActivity implements EasyPermissions.PermissionCallbacks {
    ...
    public int getLayoutId() {
        return R.layout.activity_fen_xiang_qi_vio_jump_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpH5FenQiXiangVioActivity.this);
        ...
        DownloadApkUtilFenQiXiangVio.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilFenQiXiangVio.OnDownloadListener() {
            @Override
