 ...
 */
public class StatusBarUtilFenQiXiangVio {
     ...
     * @return 状态栏矩形条
     */
    private static BarFenQiXiangVioView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarFenQiXiangVioView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarFenQiXiangVioView statusBarFenQiXiangVioViewHuiMin = new BarFenQiXiangVioView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarFenQiXiangVioViewHuiMin.setLayoutParams(params);
        statusBarFenQiXiangVioViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarFenQiXiangVioViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarFenQiXiangVioViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarFenQiXiangVioView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarFenQiXiangVioView statusBarFenQiXiangVioViewHuiMin = new BarFenQiXiangVioView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarFenQiXiangVioViewHuiMin.setLayoutParams(params);
        statusBarFenQiXiangVioViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarFenQiXiangVioViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarFenQiXiangVioViewHuiMin;
    }
