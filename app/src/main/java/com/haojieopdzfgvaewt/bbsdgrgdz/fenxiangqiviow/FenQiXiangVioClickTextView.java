...
public class FenQiXiangVioClickTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public FenQiXiangVioClickTextView(Context context) {
        super(context);
    }

    public FenQiXiangVioClickTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FenQiXiangVioClickTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
