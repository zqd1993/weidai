package com.haojieopdzfgvaewt.bbsdgrgdz.fenxiangqiviow;
...
public class FenQiXiangVioRemindDialog extends Dialog {
    ...
    public FenQiXiangVioRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_normal_fen_xiang_qi_vio);
    ...
    public FenQiXiangVioRemindDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public FenQiXiangVioRemindDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public FenQiXiangVioRemindDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public FenQiXiangVioRemindDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public FenQiXiangVioRemindDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
