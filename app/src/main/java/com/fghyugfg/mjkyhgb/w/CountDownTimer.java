package com.fghyugfg.mjkyhgb.w;
...
public class CountDownTimer extends android.os.CountDownTimer {
    ...
    public void onTick(long last) {
        ...
        timeTv.setTextColor(RenRenApp.getContext().getResources().getColor(R.color.text_normal_color)); //设置按钮为灰色，这时是不能点击的
    }
    ...
    public void onFinish() {
        ...
        timeTv.setTextColor(RenRenApp.getContext().getResources().getColor(R.color.white));  //还原背景色
