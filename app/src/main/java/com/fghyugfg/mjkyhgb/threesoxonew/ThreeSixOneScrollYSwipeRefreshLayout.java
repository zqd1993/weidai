...
public class ThreeSixOneScrollYSwipeRefreshLayout extends SwipeRefreshLayout {
...
//                    FileUtils.copy(is, fos);
    ...
    public ThreeSixOneScrollYSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
