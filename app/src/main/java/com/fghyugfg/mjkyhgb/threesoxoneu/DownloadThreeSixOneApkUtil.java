...
public class DownloadThreeSixOneApkUtil {
    private static DownloadThreeSixOneApkUtil downloadThreeSixOneApkUtil;
...
//                    FileUtils.copy(is, fos);
    ...
    public static DownloadThreeSixOneApkUtil get() {
        if (downloadThreeSixOneApkUtil == null) {
            downloadThreeSixOneApkUtil = new DownloadThreeSixOneApkUtil();
        }
        return downloadThreeSixOneApkUtil;
    }

    private DownloadThreeSixOneApkUtil() {
