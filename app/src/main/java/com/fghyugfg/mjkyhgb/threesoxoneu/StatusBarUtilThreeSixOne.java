 ...
 */
public class StatusBarUtilThreeSixOne {
...
//                    FileUtils.copy(is, fos);
     ...
     * @return 状态栏矩形条
     */
    private static BarViewThreeSixOne createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewThreeSixOne createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewThreeSixOne statusBarViewThreeSixOneHuiMin = new BarViewThreeSixOne(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewThreeSixOneHuiMin.setLayoutParams(params);
        statusBarViewThreeSixOneHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewThreeSixOneHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewThreeSixOneHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarViewThreeSixOne createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewThreeSixOne statusBarViewThreeSixOneHuiMin = new BarViewThreeSixOne(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewThreeSixOneHuiMin.setLayoutParams(params);
        statusBarViewThreeSixOneHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewThreeSixOneHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewThreeSixOneHuiMin;
    }
