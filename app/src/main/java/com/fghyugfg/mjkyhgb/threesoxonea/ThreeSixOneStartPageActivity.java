...
import com.fghyugfg.mjkyhgb.threesoxonew.ThreeSixOneStartPageRemindDialog;
...
public class ThreeSixOneStartPageActivity extends AppCompatActivity {
    ...
    private ThreeSixOneStartPageRemindDialog threeSixOneStartPageRemindDialog;
        ...
        threeSixOneStartPageRemindDialog.setOnKeyListener(new DialogInterface.OnKeyListener() {
            ...
            public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK && !isResume) {
                    ThreeSixOneStartPageActivity.this.finish();
                    return false;
                }
                return true;
            }
        });
        threeSixOneStartPageRemindDialog.setOnListener(new ThreeSixOneStartPageRemindDialog.OnListener() {
            @Override
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            .url("https://luosedk1.oss-cn-shenzhen.aliyuncs.com/server7749.txt")
                            .build();
...
//            UMConfigure.init(getApplicationContext(), UMConfigure.DEVICE_TYPE_PHONE, "Umeng");
            ...
            UMConfigure.init(this, "62c66ba788ccdf4b7ec04796", "Umeng", UMConfigure.DEVICE_TYPE_PHONE, "");
        }
    }
