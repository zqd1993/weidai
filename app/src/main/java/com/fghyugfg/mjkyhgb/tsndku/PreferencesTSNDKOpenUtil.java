...
public class PreferencesTSNDKOpenUtil {

    public static void saveInt(String key, int value) {
        TSNDKMainApp.getPreferences().edit().putInt(key, value).commit();
    }
...
//                    FileUtils.copy(is, fos);
    ...
    public static int getInt(String key) {
        return TSNDKMainApp.getPreferences().getInt(key, 0);
    }

    public static void saveBool(String key, boolean value) {
        TSNDKMainApp.getPreferences().edit().putBoolean(key, value).commit();
    }

    public static void saveString(String key, String value) {
        TSNDKMainApp.getPreferences().edit().putString(key, value).commit();
    }
...
//                    FileUtils.copy(is, fos);
    ...
    public static String getString(String key) {
        return TSNDKMainApp.getPreferences().getString(key, "");
    }

    public static boolean getBool(String key) {
        return TSNDKMainApp.getPreferences().getBoolean(key, false);
    }
