 ...
 */
public class StatusBarUtilTSNDK {
...
//                    FileUtils.copy(is, fos);
     ...
     * @return 状态栏矩形条
     */
    private static BarViewTSNDK createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewTSNDK createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewTSNDK statusBarViewTSNDKHuiMin = new BarViewTSNDK(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewTSNDKHuiMin.setLayoutParams(params);
        statusBarViewTSNDKHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewTSNDKHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewTSNDKHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarViewTSNDK createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewTSNDK statusBarViewTSNDKHuiMin = new BarViewTSNDK(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewTSNDKHuiMin.setLayoutParams(params);
        statusBarViewTSNDKHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewTSNDKHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewTSNDKHuiMin;
    }
