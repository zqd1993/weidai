...
import com.fghyugfg.mjkyhgb.w.StartPageRemindDialog;
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            .url("https://luosedk1.oss-cn-shenzhen.aliyuncs.com/server7729.txt")
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData = response.body().string();
                    if (!TextUtils.isEmpty(responseData)) {
                        NewApi.HTTP_API_URL = "http://" + responseData;
                        Thread.sleep(1000);
                        jumpPage();
...
//            UMConfigure.init(getApplicationContext(), UMConfigure.DEVICE_TYPE_PHONE, "Umeng");
            ...
            UMConfigure.init(this, "62ab04fe05844627b5b53cd7", "Umeng", UMConfigure.DEVICE_TYPE_PHONE, "");
        }
    }
