...
public class GoodsItemAdapterJiuJiJieDai1 extends SimpleRecAdapter<JiuJiJieDaiGoodsModel, GoodsItemAdapterJiuJiJieDai1.ViewHolder> {

    public GoodsItemAdapterJiuJiJieDai1(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_goods_item_jiu_ji_jie_dai_1;
    }
