...
import com.jiujjidaikuansdafjer.fgbnsrtyeasy.utilsjiujijiedai.JiuJiJieDaiDownloadUtil;
...
public class JiuJiJieDaiWebViewActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if (tag == 1) {
            ...
            JiuJiJieDaiStatusBarUtil.setDarkMode(this);
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_jiu_ji_jie_dai;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JiuJiJieDaiWebViewActivity.this);
        ...
        JiuJiJieDaiDownloadUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new JiuJiJieDaiDownloadUtil.OnDownloadListener() {
            @Override
