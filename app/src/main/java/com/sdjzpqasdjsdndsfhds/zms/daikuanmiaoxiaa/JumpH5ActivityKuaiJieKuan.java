...
import com.sdjzpqasdjsdndsfhds.zms.daikuanmiaoxiau.DownloadApkUtilKuaiJieKuan;
...
public class JumpH5ActivityKuaiJieKuan extends XActivity implements EasyPermissions.PermissionCallbacks {
    ...
    public int getLayoutId() {
        return R.layout.activity_kuai_jie_kuan_jump_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpH5ActivityKuaiJieKuan.this);
        ...
        DownloadApkUtilKuaiJieKuan.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilKuaiJieKuan.OnDownloadListener() {
            @Override
