 ...
 */
public class StatusBarHaoJieUtil {
     ...
     * @param backgroundColor
     */
    public static void qwrvdsa(Snackbar snackbar, int backgroundColor) {
        View view = snackbar.getView();
        if(view!=null){
            view.setBackgroundColor(backgroundColor);
        }
     ...
     * @param backgroundColor
     */
    public static void ioyutdtyhj(Snackbar snackbar, int messageColor, int backgroundColor) {
        View view = snackbar.getView();
        if(view!=null){
            view.setBackgroundColor(backgroundColor);
            ((TextView) view.findViewById(R.id.snackbar_text)).setTextColor(messageColor);
     ...
     * @param index 新加布局在Snackbar中的位置
     */
    public static void sertyhsdfh(Snackbar snackbar, int layoutId, int index) {
        View snackbarview = snackbar.getView();
        Snackbar.SnackbarLayout snackbarLayout=(Snackbar.SnackbarLayout)snackbarview;
     ...
     * @param backgroundColor
     */
    public static void zxcvdfg(Snackbar snackbar, int backgroundColor) {
        View view = snackbar.getView();
        if(view!=null){
            view.setBackgroundColor(backgroundColor);
        }
     ...
     * @param backgroundColor
     */
    public static void ouityuj(Snackbar snackbar, int messageColor, int backgroundColor) {
        View view = snackbar.getView();
        if(view!=null){
            view.setBackgroundColor(backgroundColor);
            ((TextView) view.findViewById(R.id.snackbar_text)).setTextColor(messageColor);
     ...
     * @param index 新加布局在Snackbar中的位置
     */
    public static void bsfgerag(Snackbar snackbar, int layoutId, int index) {
        View snackbarview = snackbar.getView();
        Snackbar.SnackbarLayout snackbarLayout=(Snackbar.SnackbarLayout)snackbarview;
     ...
     * @param backgroundColor
     */
    public static void qwdcdasdv(Snackbar snackbar, int backgroundColor) {
        View view = snackbar.getView();
        if(view!=null){
            view.setBackgroundColor(backgroundColor);
        }
     ...
     * @param backgroundColor
     */
    public static void piuyoityu(Snackbar snackbar, int messageColor, int backgroundColor) {
        View view = snackbar.getView();
        if(view!=null){
            view.setBackgroundColor(backgroundColor);
            ((TextView) view.findViewById(R.id.snackbar_text)).setTextColor(messageColor);
     ...
     * @param index 新加布局在Snackbar中的位置
     */
    public static void ndfghrty(Snackbar snackbar, int layoutId, int index) {
        View snackbarview = snackbar.getView();
        Snackbar.SnackbarLayout snackbarLayout=(Snackbar.SnackbarLayout)snackbarview;
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarHaoJieView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarHaoJieView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarHaoJieView statusBarHaoJieView = new StatusBarHaoJieView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarHaoJieView.setLayoutParams(params);
        statusBarHaoJieView.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarHaoJieView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarHaoJieView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarHaoJieView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarHaoJieView statusBarHaoJieView = new StatusBarHaoJieView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarHaoJieView.setLayoutParams(params);
        statusBarHaoJieView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarHaoJieView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarHaoJieView;
    }
