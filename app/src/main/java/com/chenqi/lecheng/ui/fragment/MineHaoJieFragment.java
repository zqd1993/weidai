...
import com.chenqi.lecheng.adapter.MineAdapterHaoJie;
import com.chenqi.lecheng.model.BaseRespHaoJieModel;
import com.chenqi.lecheng.model.ConfigHaoJieModel;
import com.chenqi.lecheng.model.MineItemModelHaoJie;
...
import com.chenqi.lecheng.ui.LoginHaoJieActivity;
import com.chenqi.lecheng.ui.activity.CancellationUserHaoJieActivity;
import com.chenqi.lecheng.ui.activity.MoreInfoHaoJieActivity;
import com.chenqi.lecheng.utils.SharedPreferencesHaoJieUtilis;
import com.chenqi.lecheng.utils.ToastHaoJieUtil;
...
import com.chenqi.lecheng.ui.activity.FeedBackHaoJieActivity;
...
public class MineHaoJieFragment extends XFragment {
    ...
    public void getGankData() {
        if (!TextUtils.isEmpty(SharedPreferencesHaoJieUtilis.getStringFromPref("API_BASE_URL"))) {
            ApiHaoJie.getGankService().getGankData()
