...
public class WelcomeYouXinDialog extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanTextYouXinView tvContent;
    ...
    public WelcomeYouXinDialog(@NonNull Context context, String title) {
    ...
    private List<SpanTextYouXinView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanTextYouXinView.TextSpanModel();
