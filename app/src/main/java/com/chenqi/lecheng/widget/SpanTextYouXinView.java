...
public class SpanTextYouXinView extends androidx.appcompat.widget.AppCompatTextView {

    private List<BaseSpanModel> spanModels;
    private SpanClickListener listener;

    public SpanTextYouXinView(Context context) {
        super(context);
    }

    public SpanTextYouXinView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public SpanTextYouXinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
