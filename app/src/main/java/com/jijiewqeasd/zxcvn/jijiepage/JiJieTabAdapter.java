...
public class JiJieTabAdapter extends BaseQuickAdapter<JiJieMainActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public JiJieTabAdapter(int layoutResId, @Nullable List<JiJieMainActivity.TabModel> data) {
...
//                    flag = deleteFile(f);
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, JiJieMainActivity.TabModel item) {
