...
public class RemindJiJieDialog extends Dialog {
...
//                    flag = deleteFile(f);
    ...
    public RemindJiJieDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_jijie_normal);
    ...
    public RemindJiJieDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindJiJieDialog setTitle(String title) {
        this.title = title;
        return this;
    }
    /**
    ...
    public RemindJiJieDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindJiJieDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindJiJieDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
