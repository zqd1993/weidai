...
public class WanRongXinYongKaProportionFrameLayout extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public WanRongXinYongKaProportionFrameLayout(@NonNull Context context) {
        super(context);
    }

    public WanRongXinYongKaProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public WanRongXinYongKaProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
