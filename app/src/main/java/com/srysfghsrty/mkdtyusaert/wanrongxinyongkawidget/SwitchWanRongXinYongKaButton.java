...
public class SwitchWanRongXinYongKaButton extends View {
    ...
    public SwitchWanRongXinYongKaButton(Context context) {
        super(context);
    }

    public SwitchWanRongXinYongKaButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
