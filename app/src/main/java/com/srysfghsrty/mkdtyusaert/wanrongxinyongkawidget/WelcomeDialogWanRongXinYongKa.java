...
public class WelcomeDialogWanRongXinYongKa extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanWanRongXinYongKaTextView tvContent;
    ...
    public WelcomeDialogWanRongXinYongKa(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_wan_rong_xin_yong_ka_welcome);
    ...
    private List<SpanWanRongXinYongKaTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanWanRongXinYongKaTextView.TextSpanModel();
