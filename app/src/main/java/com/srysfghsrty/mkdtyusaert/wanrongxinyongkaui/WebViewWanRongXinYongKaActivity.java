...
import com.srysfghsrty.mkdtyusaert.wanrongxinyongkautils.DownloadWanRongXinYongKaUtil;
...
public class WebViewWanRongXinYongKaActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if (tag == 1) {
            ...
            StatusBarUtilWanRongXinYongKa.setDarkMode(this);
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                Log.d("WebViewWanRongXinYongKaActivity", "url = " + url + "--> userAgent" + userAgent + " ---> contentDisposition = " + contentDisposition + "-->mimetype = " + mimetype + "-->contentLength = " + contentLength);
                apkUrl = url;
                checkPermission();
            }
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_wan_rong_xin_yong_ka_web_view;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewWanRongXinYongKaActivity.this);
        ...
        DownloadWanRongXinYongKaUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadWanRongXinYongKaUtil.OnDownloadListener() {
            @Override
