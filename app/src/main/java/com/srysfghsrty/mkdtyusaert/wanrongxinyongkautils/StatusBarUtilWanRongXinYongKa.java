 ...
 */
public class StatusBarUtilWanRongXinYongKa {
     ...
     * @return 状态栏矩形条
     */
    private static WanRongXinYongKaStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static WanRongXinYongKaStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        WanRongXinYongKaStatusBarView wanRongXinYongKaStatusBarView = new WanRongXinYongKaStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        wanRongXinYongKaStatusBarView.setLayoutParams(params);
        wanRongXinYongKaStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        wanRongXinYongKaStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return wanRongXinYongKaStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static WanRongXinYongKaStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        WanRongXinYongKaStatusBarView wanRongXinYongKaStatusBarView = new WanRongXinYongKaStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        wanRongXinYongKaStatusBarView.setLayoutParams(params);
        wanRongXinYongKaStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        wanRongXinYongKaStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return wanRongXinYongKaStatusBarView;
    }
