...
public class AboutUsActivityDaGeJieTiaoBaOp extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        titleTv.setText("关于");
        version_code_tv.setText(StaticUtilDaGeJieTiaoBaOp.getAppVersionName(AppDaGeJieTiaoBaOp.getContext()));
    }
    ...
    public int getLayoutId() {
        return R.layout.activity_about_us_da_ge_jie_tiao_ba_op;
    }
