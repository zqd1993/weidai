...
import com.fldfasnasjds.qpznamdsm.dgjtbautils.DownloadApkDaGeJieTiaoBaOpUtil;
...
public class DaGeJieTiaoBaOpWebViewActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_da_ge_jie_tiao_ba_op;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(DaGeJieTiaoBaOpWebViewActivity.this);
        ...
        DownloadApkDaGeJieTiaoBaOpUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkDaGeJieTiaoBaOpUtil.OnDownloadListener() {
            @Override
