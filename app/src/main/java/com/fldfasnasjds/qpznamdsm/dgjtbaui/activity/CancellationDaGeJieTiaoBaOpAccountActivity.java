package com.fldfasnasjds.qpznamdsm.dgjtbaui.activity;
...
public class CancellationDaGeJieTiaoBaOpAccountActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        commitBtn.setOnClickListener(v -> {
            daGeJieTiaoBaOpNormalDialog = new DaGeJieTiaoBaOpNormalDialog(this);
            daGeJieTiaoBaOpNormalDialog.setTitle("温馨提示")
                    .setContent("是否注销账号？注销后将不能恢复")
                    .setCancelText("取消")
                    .setLeftListener(v1 -> daGeJieTiaoBaOpNormalDialog.dismiss())
                    .setConfirmText("注销账号")
                    .setRightListener(v1 -> {
...
//                                .launch();
    ...
    public int getLayoutId() {
        return R.layout.activity_da_ge_jie_tiao_ba_op_cancellation_account;
    }
