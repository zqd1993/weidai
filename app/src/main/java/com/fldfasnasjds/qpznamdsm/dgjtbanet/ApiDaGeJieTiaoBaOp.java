...
public class ApiDaGeJieTiaoBaOp {
    ...
    public static GankDaGeJieTiaoBaOpService getGankService() {
        if (gankDaGeJieTiaoBaOpService == null) {
            synchronized (ApiDaGeJieTiaoBaOp.class) {
                if (gankDaGeJieTiaoBaOpService == null) {
                    gankDaGeJieTiaoBaOpService = XApi.getInstance().getRetrofit(API_BASE_URL, true).create(GankDaGeJieTiaoBaOpService.class);
                }
            }
        }
        return gankDaGeJieTiaoBaOpService;
    }
