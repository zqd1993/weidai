...
public class WelcomeDialogDaGeJieTiaoBaOp extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanTextViewDaGeJieTiaoBaOp tvContent;
    ...
    public WelcomeDialogDaGeJieTiaoBaOp(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_da_ge_jie_tiao_ba_op);
    ...
    private List<SpanTextViewDaGeJieTiaoBaOp.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanTextViewDaGeJieTiaoBaOp.TextSpanModel();
