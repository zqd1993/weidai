...
public class ConfigDaGeJieTiaoBaOpModel {
     ...
     * @param object
     */
    public void utyutu(Context context, String key, Object object)
    {
     ...
     * @return
     */
    public Object ertgdf(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences(FILE_NAME,
                Context.MODE_PRIVATE);
