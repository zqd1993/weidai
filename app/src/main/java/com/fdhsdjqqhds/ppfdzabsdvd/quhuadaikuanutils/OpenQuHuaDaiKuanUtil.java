...
import com.fdhsdjqqhds.ppfdzabsdvd.router.Router;
...
public class OpenQuHuaDaiKuanUtil {
    ...
    public static List<ClickTextViewQuHuaDaiKuan.SpanModel> createSpanTexts() {
        List<ClickTextViewQuHuaDaiKuan.SpanModel> spanModels = new ArrayList<>();
        ClickTextViewQuHuaDaiKuan.ClickSpanModel spanModel = new ClickTextViewQuHuaDaiKuan.ClickSpanModel();
        ClickTextViewQuHuaDaiKuan.SpanModel textSpanModel = new ClickTextViewQuHuaDaiKuan.SpanModel();
        ...
        textSpanModel = new ClickTextViewQuHuaDaiKuan.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new ClickTextViewQuHuaDaiKuan.ClickSpanModel();
    ...
    public static List<ClickTextViewQuHuaDaiKuan.SpanModel> createDlSpanTexts() {
        List<ClickTextViewQuHuaDaiKuan.SpanModel> spanModels = new ArrayList<>();
        ClickTextViewQuHuaDaiKuan.ClickSpanModel spanModel = new ClickTextViewQuHuaDaiKuan.ClickSpanModel();
        ClickTextViewQuHuaDaiKuan.SpanModel textSpanModel = new ClickTextViewQuHuaDaiKuan.SpanModel();
