 ...
 */
public class QuHuaDaiKuanStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static QuHuaDaiKuanBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static QuHuaDaiKuanBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        QuHuaDaiKuanBarView statusQuHuaDaiKuanBarViewHuiMin = new QuHuaDaiKuanBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusQuHuaDaiKuanBarViewHuiMin.setLayoutParams(params);
        statusQuHuaDaiKuanBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusQuHuaDaiKuanBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusQuHuaDaiKuanBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static QuHuaDaiKuanBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        QuHuaDaiKuanBarView statusQuHuaDaiKuanBarViewHuiMin = new QuHuaDaiKuanBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusQuHuaDaiKuanBarViewHuiMin.setLayoutParams(params);
        statusQuHuaDaiKuanBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusQuHuaDaiKuanBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusQuHuaDaiKuanBarViewHuiMin;
    }
