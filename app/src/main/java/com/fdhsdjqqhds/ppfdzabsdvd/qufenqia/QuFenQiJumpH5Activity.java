...
import com.fdhsdjqqhds.ppfdzabsdvd.qufenqiu.DownloadQuFenQiApkUtil;
...
public class QuFenQiJumpH5Activity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_qu_fen_qi_jump_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(QuFenQiJumpH5Activity.this);
        ...
        DownloadQuFenQiApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadQuFenQiApkUtil.OnDownloadListener() {
            @Override
