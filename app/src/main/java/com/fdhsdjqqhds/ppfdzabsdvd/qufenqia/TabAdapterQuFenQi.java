...
public class TabAdapterQuFenQi extends BaseQuickAdapter<MainActivityQuFenQi.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabAdapterQuFenQi(int layoutResId, @Nullable List<MainActivityQuFenQi.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainActivityQuFenQi.TabModel item) {
