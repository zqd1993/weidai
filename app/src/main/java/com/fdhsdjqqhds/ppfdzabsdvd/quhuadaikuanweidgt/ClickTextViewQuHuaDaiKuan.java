...
public class ClickTextViewQuHuaDaiKuan extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewQuHuaDaiKuan(Context context) {
        super(context);
    }

    public ClickTextViewQuHuaDaiKuan(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public ClickTextViewQuHuaDaiKuan(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
