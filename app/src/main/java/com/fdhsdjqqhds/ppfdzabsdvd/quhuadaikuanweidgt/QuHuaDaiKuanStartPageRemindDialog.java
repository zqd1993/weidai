...
public class QuHuaDaiKuanStartPageRemindDialog extends Dialog {

    @BindView(R.id.two_btn)
    TextView twoBtn;
    @BindView(R.id.tv_txt)
    ClickTextViewQuHuaDaiKuan tvTxt;
    ...
    public QuHuaDaiKuanStartPageRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_start_qu_hua_dai_kuan_page);
        ...
        tvTxt.setText(OpenQuHuaDaiKuanUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
     ...
     * @return
     */
    public static int jkktryhfgh(Context context) {
        WindowManager wm = (WindowManager) context
                .getSystemService(Context.WINDOW_SERVICE);
        DisplayMetrics outMetrics = new DisplayMetrics();
        wm.getDefaultDisplay().getMetrics(outMetrics);
     ...
     * @return
     */
    public static int mstrhery(Context context) {
        int statusHeight = -1;
        try {
            Class<?> clazz = Class.forName("com.android.internal.R$dimen");
            Object object = clazz.newInstance();
