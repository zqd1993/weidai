...
public class ProportionFrameLayoutQuHuaDaiKuan extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public ProportionFrameLayoutQuHuaDaiKuan(@NonNull Context context) {
        super(context);
    }

    public ProportionFrameLayoutQuHuaDaiKuan(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public ProportionFrameLayoutQuHuaDaiKuan(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
