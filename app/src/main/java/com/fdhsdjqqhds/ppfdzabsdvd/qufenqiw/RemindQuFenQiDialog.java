...
public class RemindQuFenQiDialog extends Dialog {
    ...
    public RemindQuFenQiDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_normal_qu_fen_qi);
    ...
    public RemindQuFenQiDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindQuFenQiDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindQuFenQiDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindQuFenQiDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindQuFenQiDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
