...
public class ClickTextViewQuFenQi extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewQuFenQi(Context context) {
        super(context);
    }

    public ClickTextViewQuFenQi(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewQuFenQi(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private SpannableString getClickableSpan(int i, ClickSpanModel spanModel) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#ff702e")), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
