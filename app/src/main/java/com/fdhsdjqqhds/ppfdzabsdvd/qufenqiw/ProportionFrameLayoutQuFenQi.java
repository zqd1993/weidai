...
public class ProportionFrameLayoutQuFenQi extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public ProportionFrameLayoutQuFenQi(@NonNull Context context) {
        super(context);
    }

    public ProportionFrameLayoutQuFenQi(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public ProportionFrameLayoutQuFenQi(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
