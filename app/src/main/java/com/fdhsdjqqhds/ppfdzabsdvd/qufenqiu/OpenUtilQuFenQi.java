...
public class OpenUtilQuFenQi {
    ...
    public static List<ClickTextViewQuFenQi.SpanModel> createSpanTexts() {
        List<ClickTextViewQuFenQi.SpanModel> spanModels = new ArrayList<>();
        ClickTextViewQuFenQi.ClickSpanModel spanModel = new ClickTextViewQuFenQi.ClickSpanModel();
        ClickTextViewQuFenQi.SpanModel textSpanModel = new ClickTextViewQuFenQi.SpanModel();
        ...
        textSpanModel = new ClickTextViewQuFenQi.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new ClickTextViewQuFenQi.ClickSpanModel();
    ...
    public static List<ClickTextViewQuFenQi.SpanModel> createDlSpanTexts() {
        List<ClickTextViewQuFenQi.SpanModel> spanModels = new ArrayList<>();
        ClickTextViewQuFenQi.ClickSpanModel spanModel = new ClickTextViewQuFenQi.ClickSpanModel();
        ClickTextViewQuFenQi.SpanModel textSpanModel = new ClickTextViewQuFenQi.SpanModel();
