 ...
 */
public class QuFenQiStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewQuFenQi createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewQuFenQi createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewQuFenQi statusBarViewQuFenQiHuiMin = new BarViewQuFenQi(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewQuFenQiHuiMin.setLayoutParams(params);
        statusBarViewQuFenQiHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewQuFenQiHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewQuFenQiHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarViewQuFenQi createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewQuFenQi statusBarViewQuFenQiHuiMin = new BarViewQuFenQi(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewQuFenQiHuiMin.setLayoutParams(params);
        statusBarViewQuFenQiHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewQuFenQiHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewQuFenQiHuiMin;
    }
