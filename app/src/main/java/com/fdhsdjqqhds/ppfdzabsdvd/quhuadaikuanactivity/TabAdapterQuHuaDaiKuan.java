...
public class TabAdapterQuHuaDaiKuan extends BaseQuickAdapter<QuHuaDaiKuanMainActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabAdapterQuHuaDaiKuan(int layoutResId, @Nullable List<QuHuaDaiKuanMainActivity.TabModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, QuHuaDaiKuanMainActivity.TabModel item) {
