...
import com.mmaeryrusu.qqzdryty.fenqihuanqianbeiutils.DownloadFenQiHuanQianBeiUtil;
...
public class WebViewActivityFenQiHuanQianBei extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if (tag == 1) {
            ...
            StatusFenQiHuanQianBeiBarUtil.setDarkMode(this);
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                Log.d("WebViewActivityFenQiHuanQianBei", "url = " + url + "--> userAgent" + userAgent + " ---> contentDisposition = " + contentDisposition + "-->mimetype = " + mimetype + "-->contentLength = " + contentLength);
                apkUrl = url;
                checkPermission();
            }
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_fen_qi_huan_qian_bei;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewActivityFenQiHuanQianBei.this);
        ...
        DownloadFenQiHuanQianBeiUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadFenQiHuanQianBeiUtil.OnDownloadListener() {
            @Override
