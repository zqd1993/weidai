...
import com.mmaeryrusu.qqzdryty.fenqihuanqianbeiutils.DownloadUtilFenQiHuanQianBei;
...
public class FenQiHuanQianBeiWebViewActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if (tag == 1) {
            ...
            StatusBarUtilFenQiHuanQianBei.setDarkMode(this);
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_fen_qi_huan_qian;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(FenQiHuanQianBeiWebViewActivity.this);
        ...
        DownloadUtilFenQiHuanQianBei.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadUtilFenQiHuanQianBei.OnDownloadListener() {
            @Override
