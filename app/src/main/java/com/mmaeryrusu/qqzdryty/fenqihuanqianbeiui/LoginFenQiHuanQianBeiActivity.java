...
import com.mmaeryrusu.qqzdryty.fenqihuanqianbeiwidget.SpanTextViewFenQiHuanQianBei;
...
public class LoginFenQiHuanQianBeiActivity extends XActivity<LoginFenQiHuanQianBeiPresent> {
    ...
    SpanTextViewFenQiHuanQianBei loginRemindTv;
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        isNeedChecked = FenQiHuanQianBeiSharedPreferencesUtilis.getBoolFromPref("is_agree_check");
        isNeedVerification = FenQiHuanQianBeiSharedPreferencesUtilis.getBoolFromPref("is_code_register");
        verificationLl.setVisibility(isNeedVerification ? View.VISIBLE : View.GONE);
        remindCb.setChecked(isNeedChecked);
        initListener();
//        ToastUtilFenQiHuanQianBei.showShort("API_BASE_URL = " + FenQiHuanQianBeiSharedPreferencesUtilis.getStringFromPref("API_BASE_URL") +
//                "API_BASE_URL_1 = " + ApiFenQiHuanQianBei.API_BASE_URL);
        getP().getCompanyInfo();
    ...
    private void initListener() {
        loginBtn.setOnClickListener(v -> {
            ...
            if (!StaticUtilFenQiHuanQianBei.isValidPhoneNumber(phoneStr)) {
    ...
    public int getLayoutId() {
        return R.layout.activity_fen_qi_huan_qian_bei_login;
    }
    ...
    private List<SpanTextViewFenQiHuanQianBei.BaseSpanModel> createSpanTexts() {
        List<SpanTextViewFenQiHuanQianBei.BaseSpanModel> spanModels = new ArrayList<>();
        SpanTextViewFenQiHuanQianBei.ClickSpanModel spanModel = new SpanTextViewFenQiHuanQianBei.ClickSpanModel();
        SpanTextViewFenQiHuanQianBei.TextSpanModel textSpanModel = new SpanTextViewFenQiHuanQianBei.TextSpanModel();
        ...
        spanModel = new SpanTextViewFenQiHuanQianBei.ClickSpanModel();
