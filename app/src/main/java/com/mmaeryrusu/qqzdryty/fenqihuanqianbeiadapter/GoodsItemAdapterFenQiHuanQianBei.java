...
public class GoodsItemAdapterFenQiHuanQianBei extends SimpleRecAdapter<FenQiHuanQianBeiGoodsModel, GoodsItemAdapterFenQiHuanQianBei.ViewHolder> {
    ...
    public int getLayoutId() {
        return R.layout.adapter_goods_item_fen_qi_huan_qian;
    }

    @Override
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        FenQiHuanQianBeiGoodsModel model = data.get(i);
        ...
        if (!TextUtils.isEmpty(SharedPreferencesFenQiHuanQianBeiUtilis.getStringFromPref("API_BASE_URL"))) {
            Glide.with(context).load(SharedPreferencesFenQiHuanQianBeiUtilis.getStringFromPref("API_BASE_URL") + model.getImgs()).into(viewHolder.productImg);
        }
