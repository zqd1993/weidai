...
public class MineAdapter1FenQiHuanQianBei extends SimpleRecAdapter<FenQiHuanQianBeiMineItemModel, MineAdapter1FenQiHuanQianBei.ViewHolder> {

    public MineAdapter1FenQiHuanQianBei(Context context) {
        super(context);
    }
