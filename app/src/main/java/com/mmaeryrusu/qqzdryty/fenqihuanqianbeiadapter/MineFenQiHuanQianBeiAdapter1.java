...
public class MineFenQiHuanQianBeiAdapter1 extends SimpleRecAdapter<FenQiHuanQianBeiMineItemModel, MineFenQiHuanQianBeiAdapter1.ViewHolder> {

    public MineFenQiHuanQianBeiAdapter1(Context context) {
        super(context);
    }
