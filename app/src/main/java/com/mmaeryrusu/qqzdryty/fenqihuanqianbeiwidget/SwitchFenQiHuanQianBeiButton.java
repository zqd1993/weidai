...
public class SwitchFenQiHuanQianBeiButton extends View {
    ...
    public SwitchFenQiHuanQianBeiButton(Context context) {
        super(context);
    }

    public SwitchFenQiHuanQianBeiButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
