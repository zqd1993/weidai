...
public interface GankFenQiHuanQianBeiService {
    ...
    Flowable<BaseRespFenQiHuanQianBeiModel<List<GoodsFenQiHuanQianBeiModel>>> productList(@Body RequestBody model);

    @POST("/api/index/aindex")
    Flowable<BaseRespFenQiHuanQianBeiModel<List<GoodsFenQiHuanQianBeiModel>>> aindex(@Body RequestBody model);
