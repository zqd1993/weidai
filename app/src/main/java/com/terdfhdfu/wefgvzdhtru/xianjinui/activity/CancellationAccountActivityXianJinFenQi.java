...
public class CancellationAccountActivityXianJinFenQi extends XActivity {
...
//        c.drawColor(0x00ffffff);
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        commitBtn.setOnClickListener(v -> {
            XianJinFenQiToastUtil.showShort("注销已提交，请耐心等待..");
            finish();
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_xian_jin_cancellation_account;
    }
