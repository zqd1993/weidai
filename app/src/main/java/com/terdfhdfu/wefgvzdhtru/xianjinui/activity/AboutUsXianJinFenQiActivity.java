...
import com.terdfhdfu.wefgvzdhtru.XianJinFenQiApp;
...
public class AboutUsXianJinFenQiActivity extends XActivity {
...
//        c.drawColor(0x00ffffff);
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        titleTv.setText("关于");
        version_tv.setText("当前版本号：v" + StaticXianJinFenQiUtil.getAppVersionName(XianJinFenQiApp.getContext()));
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_about_us_xian_jin;
    }
