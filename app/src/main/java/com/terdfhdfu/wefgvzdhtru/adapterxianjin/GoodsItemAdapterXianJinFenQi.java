...
public class GoodsItemAdapterXianJinFenQi extends SimpleRecAdapter<GoodsModelXianJinFenQi, GoodsItemAdapterXianJinFenQi.ViewHolder> {

    public GoodsItemAdapterXianJinFenQi(Context context) {
        super(context);
    }
...
//        c.drawColor(0x00ffffff);
    ...
    public int getLayoutId() {
        return R.layout.adapter_goods_item_xian_jin;
    }

    @Override
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        GoodsModelXianJinFenQi model = data.get(i);
        ...
        if (!TextUtils.isEmpty(XianJinFenQiSharedPreferencesUtilis.getStringFromPref("API_BASE_URL"))) {
            Glide.with(context).load(XianJinFenQiSharedPreferencesUtilis.getStringFromPref("API_BASE_URL") + model.getImgs()).into(viewHolder.productImg);
        }
