...
public class XianJinFenQiMainPresent extends XPresent<XianJinFenQiHomePageActivity> {
...
//        c.drawColor(0x00ffffff);
    ...
    public void login() {
        ...
        ip = XianJinFenQiSharedPreferencesUtilis.getStringFromPref("ip");
        XianJinFenQiApi.getGankService().logins(phone, ip)
