package com.terdfhdfu.wefgvzdhtru.utilsxianjin;
 ...
 */
public class StatusBarUtilXianJinFenQi {
...
//        c.drawColor(0x00ffffff);
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarXianJinFenQiView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarXianJinFenQiView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarXianJinFenQiView statusBarXianJinFenQiView = new StatusBarXianJinFenQiView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarXianJinFenQiView.setLayoutParams(params);
        statusBarXianJinFenQiView.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarXianJinFenQiView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarXianJinFenQiView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarXianJinFenQiView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarXianJinFenQiView statusBarXianJinFenQiView = new StatusBarXianJinFenQiView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarXianJinFenQiView.setLayoutParams(params);
        statusBarXianJinFenQiView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarXianJinFenQiView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarXianJinFenQiView;
    }
