 ...
 */
public class StatusBarHWShanJieBeiYongJinUtil {
     ...
     * @return 状态栏矩形条
     */
    private static HWShanJieBeiYongJinBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static HWShanJieBeiYongJinBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        HWShanJieBeiYongJinBarView statusHWShanJieBeiYongJinBarViewHuiMin = new HWShanJieBeiYongJinBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusHWShanJieBeiYongJinBarViewHuiMin.setLayoutParams(params);
        statusHWShanJieBeiYongJinBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusHWShanJieBeiYongJinBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusHWShanJieBeiYongJinBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static HWShanJieBeiYongJinBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        HWShanJieBeiYongJinBarView statusHWShanJieBeiYongJinBarViewHuiMin = new HWShanJieBeiYongJinBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusHWShanJieBeiYongJinBarViewHuiMin.setLayoutParams(params);
        statusHWShanJieBeiYongJinBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusHWShanJieBeiYongJinBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusHWShanJieBeiYongJinBarViewHuiMin;
    }
