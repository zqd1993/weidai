...
public class StartPageHWShanJieBeiYongJinRemindDialog extends Dialog {

    @BindView(R.id.two_btn)
    TextView twoBtn;
    @BindView(R.id.tv_txt)
    ClickHWShanJieBeiYongJinTextView tvTxt;
    @BindView(R.id.one_btn)
    TextView oneBtn;

    private OnListener onListener;

    public StartPageHWShanJieBeiYongJinRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hw_shan_jie_bei_yong_jie_dialog_start_page);
        ...
        tvTxt.setText(OpenHWShanJieBeiYongJinUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
