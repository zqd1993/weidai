...
public class RemindHWShanJieBeiYongJinDialog extends Dialog {
    ...
    public RemindHWShanJieBeiYongJinDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hw_shan_jie_bei_yong_jie_dialog_normal);
    ...
    public RemindHWShanJieBeiYongJinDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindHWShanJieBeiYongJinDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindHWShanJieBeiYongJinDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindHWShanJieBeiYongJinDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindHWShanJieBeiYongJinDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
