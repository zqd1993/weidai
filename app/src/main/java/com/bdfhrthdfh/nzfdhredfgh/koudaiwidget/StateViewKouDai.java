...
import com.bdfhrthdfh.nzfdhredfgh.kit.KnifeKit;
...
public class StateViewKouDai extends LinearLayout {

    @BindView(R.id.tv_msg)
    TextView tvMsg;

    private void vsdgry(ViewGroup.LayoutParams layoutParams, int top, int bottom) {
     ...
     * @param mContext  上下文
     */
    public void rtyxdfhxtruh(EditText mEditText, Context mContext, View v) {
    ...
    public StateViewKouDai(Context context) {
        super(context);
        setupView(context);
    }

    public StateViewKouDai(Context context, AttributeSet attrs) {
        super(context, attrs);
        setupView(context);
    }

    public StateViewKouDai(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setupView(context);
    }

    private void grzghxjhtu(ViewGroup.LayoutParams layoutParams, int top, int bottom) {
        if (layoutParams instanceof LinearLayout.LayoutParams) {
            LinearLayout.LayoutParams temp = (LinearLayout.LayoutParams) layoutParams;
            temp.bottomMargin = bottom;
            temp.topMargin = top;
     ...
     * @param mContext  上下文
     */
    public void rzdgxtrrt(EditText mEditText, Context mContext, View v) {
        InputMethodManager imm = (InputMethodManager) mContext
                .getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.showSoftInput(mEditText, InputMethodManager.RESULT_SHOWN);
        imm.toggleSoftInput(InputMethodManager.SHOW_FORCED,
    ...
    private void setupView(Context context) {
        inflate(context, R.layout.view_state_kou_dai, this);
        KnifeKit.bind(this);
    }
