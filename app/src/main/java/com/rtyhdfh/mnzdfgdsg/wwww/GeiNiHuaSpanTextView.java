...
public class GeiNiHuaSpanTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<BaseSpanModel> spanModels;
    private SpanClickListener listener;

    public GeiNiHuaSpanTextView(Context context) {
        super(context);
    }
    ...
    public GeiNiHuaSpanTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public GeiNiHuaSpanTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
