...
public class DaiKuanQianBaoNormalDialog extends Dialog {
    ...
    public DaiKuanQianBaoNormalDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_dai_kuan_qian_bao_normal);
    ...
    public DaiKuanQianBaoNormalDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public DaiKuanQianBaoNormalDialog hideLeftBtn() {
        hideLeftBtn = true;
        return this;
    }

    public DaiKuanQianBaoNormalDialog setTitle(String title) {
        this.title = title;
        return this;
    }

    public DaiKuanQianBaoNormalDialog setImg(int imgRes) {
        this.imgRes = imgRes;
        return this;
    }


    public DaiKuanQianBaoNormalDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public DaiKuanQianBaoNormalDialog setLeftListener(View.OnClickListener listener) {
        this.leftListener = listener;
        return this;
    }

    public DaiKuanQianBaoNormalDialog setRightListener(View.OnClickListener listener) {
        this.rightListener = listener;
        return this;
    }

    public DaiKuanQianBaoNormalDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
//        this.tvCancel.setText(tvCancel);
        return this;
    }

    public DaiKuanQianBaoNormalDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
