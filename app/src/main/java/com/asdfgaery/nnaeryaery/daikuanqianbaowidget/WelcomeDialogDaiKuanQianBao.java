...
public class WelcomeDialogDaiKuanQianBao extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    DaiKuanQianBaoSpanTextView tvContent;
    ...
    public WelcomeDialogDaiKuanQianBao(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_dai_kuan_qian_bao_welcome);
    ...
    private List<DaiKuanQianBaoSpanTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new DaiKuanQianBaoSpanTextView.TextSpanModel();
