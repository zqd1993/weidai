...
public class SwitchDaiKuanQianBaoButton extends View {
    ...
    public SwitchDaiKuanQianBaoButton(Context context) {
        super(context);
    }

    public SwitchDaiKuanQianBaoButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
