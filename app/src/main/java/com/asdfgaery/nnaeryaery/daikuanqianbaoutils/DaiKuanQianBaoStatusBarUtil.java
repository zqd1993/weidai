 ...
 */
public class DaiKuanQianBaoStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewDaiKuanQianBao createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewDaiKuanQianBao createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewDaiKuanQianBao statusBarViewDaiKuanQianBao = new StatusBarViewDaiKuanQianBao(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewDaiKuanQianBao.setLayoutParams(params);
        statusBarViewDaiKuanQianBao.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewDaiKuanQianBao.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewDaiKuanQianBao;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewDaiKuanQianBao createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewDaiKuanQianBao statusBarViewDaiKuanQianBao = new StatusBarViewDaiKuanQianBao(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewDaiKuanQianBao.setLayoutParams(params);
        statusBarViewDaiKuanQianBao.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewDaiKuanQianBao.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewDaiKuanQianBao;
    }
