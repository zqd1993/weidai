...
import com.asdfgaery.nnaeryaery.daikuanqianbaoutils.DaiKuanQianBaoDownloadUtil;
...
public class WebViewActivityDaiKuanQianBao extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if (tag == 1) {
            ...
            DaiKuanQianBaoStatusBarUtil.setDarkMode(this);
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                Log.d("WebViewActivityDiXiDaiKuan", "url = " + url + "--> userAgent" + userAgent + " ---> contentDisposition = " + contentDisposition + "-->mimetype = " + mimetype + "-->contentLength = " + contentLength);
                apkUrl = url;
                checkPermission();
            }
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_dai_kuan_qian_bao;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewActivityDaiKuanQianBao.this);
        ...
        DaiKuanQianBaoDownloadUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DaiKuanQianBaoDownloadUtil.OnDownloadListener() {
            @Override
