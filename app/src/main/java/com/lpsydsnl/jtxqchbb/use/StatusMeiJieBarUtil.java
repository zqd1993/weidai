 ...
 */
public class StatusMeiJieBarUtil {
     ...
     * @return
     */
    public static boolean mghjgf(Context mContext) {
        ConnectivityManager mgr = (ConnectivityManager) mContext.getSystemService(Context.CONNECTIVITY_SERVICE);
        if (mgr != null) {
            NetworkInfo[] info = mgr.getAllNetworkInfo();
            if (info != null) {
     ...
     * @return
     */
    public static boolean vsdret(Context mContext, boolean distinguish, int type) {
        if (mContext != null) {
            ConnectivityManager mConnectivityManager = (ConnectivityManager) mContext.getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo mMobileNetworkInfo;
            if (distinguish) {
     ...
     * @return
     */
    public static boolean mhjgdh(Context mContext) {
        ConnectivityManager mgr = (ConnectivityManager) mContext.getSystemService(Context.CONNECTIVITY_SERVICE);
        if (mgr != null) {
            NetworkInfo[] info = mgr.getAllNetworkInfo();
            if (info != null) {
     ...
     * @return
     */
    public static boolean vdsfewr(Context mContext, boolean distinguish, int type) {
        if (mContext != null) {
            ConnectivityManager mConnectivityManager = (ConnectivityManager) mContext.getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo mMobileNetworkInfo;
            if (distinguish) {
     ...
     * @return
     */
    public static boolean mhgjhgdh(Context mContext) {
        ConnectivityManager mgr = (ConnectivityManager) mContext.getSystemService(Context.CONNECTIVITY_SERVICE);
        if (mgr != null) {
            NetworkInfo[] info = mgr.getAllNetworkInfo();
            if (info != null) {
     ...
     * @return
     */
    public static boolean bdsfwer(Context mContext) {
        ConnectivityManager mgr = (ConnectivityManager) mContext.getSystemService(Context.CONNECTIVITY_SERVICE);
        if (mgr != null) {
            NetworkInfo[] info = mgr.getAllNetworkInfo();
            if (info != null) {
     ...
     * @return
     */
    public static boolean fwer4r(Context mContext, boolean distinguish, int type) {
        if (mContext != null) {
            ConnectivityManager mConnectivityManager = (ConnectivityManager) mContext.getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo mMobileNetworkInfo;
            if (distinguish) {
     ...
     * @return 状态栏矩形条
     */
    private static MeiJieBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static MeiJieBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        MeiJieBarView statusMeiJieBarViewHuiMin = new MeiJieBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusMeiJieBarViewHuiMin.setLayoutParams(params);
        statusMeiJieBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusMeiJieBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusMeiJieBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static MeiJieBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        MeiJieBarView statusMeiJieBarViewHuiMin = new MeiJieBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusMeiJieBarViewHuiMin.setLayoutParams(params);
        statusMeiJieBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusMeiJieBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusMeiJieBarViewHuiMin;
    }
