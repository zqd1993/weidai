...
public class ClickTextViewKouDaiBeiYongJinOp extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewKouDaiBeiYongJinOp(Context context) {
        super(context);
    }

    public ClickTextViewKouDaiBeiYongJinOp(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewKouDaiBeiYongJinOp(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private SpannableString getClickableSpan(int i, ClickSpanModel spanModel) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#0131b9")), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
