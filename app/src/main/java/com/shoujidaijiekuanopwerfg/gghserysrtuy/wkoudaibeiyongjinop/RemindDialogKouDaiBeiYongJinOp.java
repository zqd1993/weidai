package com.shoujidaijiekuanopwerfg.gghserysrtuy.wkoudaibeiyongjinop;
...
public class RemindDialogKouDaiBeiYongJinOp extends Dialog {
    ...
    public RemindDialogKouDaiBeiYongJinOp(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_kou_dai_bei_yong_jin_op_normal);
    ...
    public RemindDialogKouDaiBeiYongJinOp showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindDialogKouDaiBeiYongJinOp setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindDialogKouDaiBeiYongJinOp setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindDialogKouDaiBeiYongJinOp setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindDialogKouDaiBeiYongJinOp setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
