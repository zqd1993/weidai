...
import com.shoujidaijiekuanopwerfg.gghserysrtuy.ukoudaibeiyongjinop.DownloadApkUtilKouDaiBeiYongJinOp;
...
public class JumpKouDaiBeiYongJinOpH5Activity extends XActivity implements EasyPermissions.PermissionCallbacks {
    ...
    public int getLayoutId() {
        return R.layout.activity_kou_dai_bei_yong_jin_op_jump_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpKouDaiBeiYongJinOpH5Activity.this);
        ...
        DownloadApkUtilKouDaiBeiYongJinOp.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilKouDaiBeiYongJinOp.OnDownloadListener() {
            @Override
