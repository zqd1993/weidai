...
public class TabKouDaiBeiYongJinOpAdapter extends BaseQuickAdapter<MainKouDaiBeiYongJinOpwActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabKouDaiBeiYongJinOpAdapter(int layoutResId, @Nullable List<MainKouDaiBeiYongJinOpwActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainKouDaiBeiYongJinOpwActivity.TabModel item) {
