...
public class FeedbackActivityKouDaiBeiYongJinOp extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kou_dai_bei_yong_jin_op_feedback);
        ...
        commitBtn.setOnClickListener(v -> {
            if (feedbackEt.getText().toString().trim().isEmpty()){
                MyKouDaiBeiYongJinOpToast.showShort("请输入您的意见反馈");
                return;
            } else {
                if (xStateController != null){
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            MyKouDaiBeiYongJinOpToast.showShort("提交成功");
                            finish();
                        }
                    }, 2000);
                }
