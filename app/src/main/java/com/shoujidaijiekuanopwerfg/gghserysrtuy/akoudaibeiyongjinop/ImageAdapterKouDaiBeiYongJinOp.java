...
public class ImageAdapterKouDaiBeiYongJinOp extends BannerAdapter<ProductModelKouDaiBeiYongJinOp, ImageAdapterKouDaiBeiYongJinOp.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public ImageAdapterKouDaiBeiYongJinOp(List<ProductModelKouDaiBeiYongJinOp> datas) {
        super(datas);
    }

    @Override
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_banner_item_kou_dai_bei_yong_jin_op, parent, false);
        return new ImageAdapterKouDaiBeiYongJinOp.ImageHolder(view);
    }

    @Override
    public void onBindView(ImageHolder holder, ProductModelKouDaiBeiYongJinOp data, int position, int size) {
        ...
        ILFactory.getLoader().loadNet(holder.product_img, HttpKouDaiBeiYongJinOpApi.HTTP_API_URL + data.getProductLogo(),
    ...
    public interface BannerClickedListener{
        void onBannerClicked(ProductModelKouDaiBeiYongJinOp entity);
    }
