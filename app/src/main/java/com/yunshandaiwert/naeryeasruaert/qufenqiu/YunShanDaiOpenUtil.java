...
public class YunShanDaiOpenUtil {
    ...
    public static void getValue(XActivity activity, Class<?> to, Bundle bundle) {
            HttpYunShanDaiApi.getInterfaceUtils().getValue("VIDEOTAPE")
                        ...
                        public void onNext(YunShanDaiBaseModel<ConfigYunShanDaiEntity> configEntity) {
                            if (configEntity != null) {
                                if (configEntity.getData() != null) {
                                    YunShanDaiPreferencesOpenUtil.saveBool("NO_RECORD", !configEntity.getData().getVideoTape().equals("0"));
                                    jumpPage(activity, to, bundle, false);
                                }
                            }
                        }
    ...
    public static List<YunShanDaiClickTextView.SpanModel> createSpanTexts() {
        List<YunShanDaiClickTextView.SpanModel> spanModels = new ArrayList<>();
        YunShanDaiClickTextView.ClickSpanModel spanModel = new YunShanDaiClickTextView.ClickSpanModel();
        YunShanDaiClickTextView.SpanModel textSpanModel = new YunShanDaiClickTextView.SpanModel();
        ...
        textSpanModel = new YunShanDaiClickTextView.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new YunShanDaiClickTextView.ClickSpanModel();
    ...
    public static List<YunShanDaiClickTextView.SpanModel> createDlSpanTexts() {
        List<YunShanDaiClickTextView.SpanModel> spanModels = new ArrayList<>();
        YunShanDaiClickTextView.ClickSpanModel spanModel = new YunShanDaiClickTextView.ClickSpanModel();
        YunShanDaiClickTextView.SpanModel textSpanModel = new YunShanDaiClickTextView.SpanModel();
