 ...
 */
public class YunShanDaiStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static YunShanDaiBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static YunShanDaiBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        YunShanDaiBarView statusYunShanDaiBarViewHuiMin = new YunShanDaiBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusYunShanDaiBarViewHuiMin.setLayoutParams(params);
        statusYunShanDaiBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusYunShanDaiBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusYunShanDaiBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static YunShanDaiBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        YunShanDaiBarView statusYunShanDaiBarViewHuiMin = new YunShanDaiBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusYunShanDaiBarViewHuiMin.setLayoutParams(params);
        statusYunShanDaiBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusYunShanDaiBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusYunShanDaiBarViewHuiMin;
    }
