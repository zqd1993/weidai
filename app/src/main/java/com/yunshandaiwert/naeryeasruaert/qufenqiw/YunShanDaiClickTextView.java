...
public class YunShanDaiClickTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public YunShanDaiClickTextView(Context context) {
        super(context);
    }

    public YunShanDaiClickTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public YunShanDaiClickTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private SpannableString getClickableSpan(int i, ClickSpanModel spanModel) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#6d67e3")), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
