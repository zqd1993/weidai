...
public class YunShanDaiRemindDialog extends Dialog {
    ...
    public YunShanDaiRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_yun_shan_dai_normal);
    ...
    public YunShanDaiRemindDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public YunShanDaiRemindDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public YunShanDaiRemindDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public YunShanDaiRemindDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public YunShanDaiRemindDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
