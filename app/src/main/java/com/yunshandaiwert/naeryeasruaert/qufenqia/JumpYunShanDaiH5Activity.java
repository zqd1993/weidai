...
import com.yunshandaiwert.naeryeasruaert.qufenqiu.YunShanDaiDownloadApkUtil;
...
public class JumpYunShanDaiH5Activity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_yun_shan_dai_jump_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpYunShanDaiH5Activity.this);
        ...
        YunShanDaiDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new YunShanDaiDownloadApkUtil.OnDownloadListener() {
            @Override
