...
public class TabYunShanDaiAdapter extends BaseQuickAdapter<YunShanDaiMainActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabYunShanDaiAdapter(int layoutResId, @Nullable List<YunShanDaiMainActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, YunShanDaiMainActivity.TabModel item) {
