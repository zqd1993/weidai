...
public class TabYouBeiAdapter extends BaseQuickAdapter<MainYouBeiActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabYouBeiAdapter(int layoutResId, @Nullable List<MainYouBeiActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainYouBeiActivity.TabModel item) {
