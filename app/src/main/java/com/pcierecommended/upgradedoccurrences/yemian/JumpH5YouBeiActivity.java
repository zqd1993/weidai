...
import com.pcierecommended.upgradedoccurrences.mvp.XActivity;
import com.pcierecommended.upgradedoccurrences.gongju.DownloadYouBeiApkUtil;
...
public class JumpH5YouBeiActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpH5YouBeiActivity.this);
        ...
        DownloadYouBeiApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadYouBeiApkUtil.OnDownloadListener() {
            @Override
