...
import com.pcierecommended.upgradedoccurrences.chajian.YouBeiClickTextView;
...
public class OpenYouBeiUtil {
    ...
    public static List<YouBeiClickTextView.SpanModel> createSpanTexts(){
        List<YouBeiClickTextView.SpanModel> spanModels = new ArrayList<>();
        YouBeiClickTextView.ClickSpanModel spanModel = new YouBeiClickTextView.ClickSpanModel();
        YouBeiClickTextView.SpanModel textSpanModel = new YouBeiClickTextView.SpanModel();
        ...
        textSpanModel = new YouBeiClickTextView.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new YouBeiClickTextView.ClickSpanModel();
    ...
    public static List<YouBeiClickTextView.SpanModel> createDlSpanTexts() {
        List<YouBeiClickTextView.SpanModel> spanModels = new ArrayList<>();
        YouBeiClickTextView.ClickSpanModel spanModel = new YouBeiClickTextView.ClickSpanModel();
        YouBeiClickTextView.SpanModel textSpanModel = new YouBeiClickTextView.SpanModel();
