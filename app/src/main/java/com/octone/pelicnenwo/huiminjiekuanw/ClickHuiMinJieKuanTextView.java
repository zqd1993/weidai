...
public class ClickHuiMinJieKuanTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickHuiMinJieKuanTextView(Context context) {
        super(context);
    }

    public ClickHuiMinJieKuanTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickHuiMinJieKuanTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * @return
     */
    public int rtydrtudrftu(Context context)
    {
     ...
     * @return
     */
    public Bitmap mmtyikdrty(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public Bitmap xbnxftyurty(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public int urtyxfghjdrtu(Context context)
    {
     ...
     * @return
     */
    public Bitmap xfghgyfcudtyu(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public Bitmap fghfdrftyudrty(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public int jdrtujfgjdrtyu(Context context)
    {
     ...
     * @return
     */
    public Bitmap zzzdryftghj(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public Bitmap xfbnfxcgjdrturst(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
