...
public interface HuiMinJieKuanInterfaceUtils {
    ...
    @GET("/app/user/login")
    Flowable<HuiMinJieKuanBaseModel<DlModelHuiMinJieKuan>> login(@Query("phone") String phone, @Query("code") String code, @Query("device") String device, @Query("ip") String ip);
