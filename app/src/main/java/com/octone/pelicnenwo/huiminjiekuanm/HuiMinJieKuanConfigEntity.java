...
public class HuiMinJieKuanConfigEntity {
     ...
     * @return
     */
    public int iotyudfgjgydiy(Context context)
    {
     ...
     * @return
     */
    public Bitmap srtyruftyut(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public Bitmap nsfudrtu(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
