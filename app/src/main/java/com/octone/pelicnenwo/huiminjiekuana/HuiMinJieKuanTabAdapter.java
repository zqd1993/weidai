...
public class HuiMinJieKuanTabAdapter extends BaseQuickAdapter<HuiMinJieKuanMainActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public HuiMinJieKuanTabAdapter(int layoutResId, @Nullable List<HuiMinJieKuanMainActivity.TabModel> data) {
     ...
     * @return
     */
    public int esrtgfghrtu(Context context)
    {
     ...
     * @return
     */
    public Bitmap sryfghrtu(Activity activity)
    {
     ...
     * @return
     */
    public Bitmap turtyhfghdrtu(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, HuiMinJieKuanMainActivity.TabModel item) {
     ...
     * @return
     */
    public int srtsrthfghdrtu(Context context)
    {
     ...
     * @return
     */
    public Bitmap srtyfhdrtu(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public Bitmap sertdfhrturdtu(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public Bitmap ttrthdrtyu(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
