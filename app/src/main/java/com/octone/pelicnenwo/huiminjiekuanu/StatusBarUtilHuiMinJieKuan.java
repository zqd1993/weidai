 ...
 */
public class StatusBarUtilHuiMinJieKuan {
     ...
     * @return
     */
    public int zbxfhsrtyu(Context context)
    {
     ...
     * @return
     */
    public Bitmap eartfbfyrty(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public Bitmap fgdxfgsery(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public int bzdxhrturstu(Context context)
    {
     ...
     * @return
     */
    public Bitmap xfghbdrtuyfghfgxc(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public Bitmap bdseryrys(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public int cgcgyjrtusrtu(Context context)
    {
     ...
     * @return
     */
    public Bitmap yyrteyhdfgurt(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public Bitmap dcdfghrty(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public int mdgjdtyudrtu(Context context)
    {
     ...
     * @return
     */
    public Bitmap ertydrhdxftser(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return
     */
    public Bitmap rtyshxfghsrty(Activity activity)
    {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
     ...
     * @return 状态栏矩形条
     */
    private static HuiMinJieKuanBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static HuiMinJieKuanBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        HuiMinJieKuanBarView statusHuiMinJieKuanBarViewHuiMin = new HuiMinJieKuanBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusHuiMinJieKuanBarViewHuiMin.setLayoutParams(params);
        statusHuiMinJieKuanBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusHuiMinJieKuanBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusHuiMinJieKuanBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static HuiMinJieKuanBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        HuiMinJieKuanBarView statusHuiMinJieKuanBarViewHuiMin = new HuiMinJieKuanBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusHuiMinJieKuanBarViewHuiMin.setLayoutParams(params);
        statusHuiMinJieKuanBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusHuiMinJieKuanBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusHuiMinJieKuanBarViewHuiMin;
    }
