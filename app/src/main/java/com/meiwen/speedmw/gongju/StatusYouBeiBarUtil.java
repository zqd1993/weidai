 ...
 */
public class StatusYouBeiBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarYouBeiView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarYouBeiView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarYouBeiView statusBarYouBeiViewHuiMin = new BarYouBeiView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarYouBeiViewHuiMin.setLayoutParams(params);
        statusBarYouBeiViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarYouBeiViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarYouBeiViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarYouBeiView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarYouBeiView statusBarYouBeiViewHuiMin = new BarYouBeiView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarYouBeiViewHuiMin.setLayoutParams(params);
        statusBarYouBeiViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarYouBeiViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarYouBeiViewHuiMin;
    }
