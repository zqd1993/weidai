...
public class DlYouBeiActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        readTv.setText(OpenYouBeiUtil.createDlSpanTexts(), position -> {
            ...
            OpenYouBeiUtil.getValue(DlYouBeiActivity.this, JumpH5YouBeiActivity.class, bundle);
        });
                        ...
                        public void onNext(BaseYouBeiModel<DlYouBeiModel> dlModel) {
                            ...
                            if (dlModel != null && dlModel.getCode() == 200) {
                                if (dlModel.getData() != null && dlModel.getCode() == 200) {
                                    ...
                                    OpenYouBeiUtil.getValue(DlYouBeiActivity.this, MainYouBeiActivity.class, null, true);
                                }
                            } else {
