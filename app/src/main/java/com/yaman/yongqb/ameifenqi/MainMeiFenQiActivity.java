...
import com.yaman.yongqb.fmeifenqi.MainFragmentMeiFenQi;
import com.yaman.yongqb.fmeifenqi.ProductMeiFenQiFragment;
...
public class MainMeiFenQiActivity extends XActivity {
    ...
    private MeiFenQiTabAdapter meiFenQiTabAdapter;
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        initAdapter();
        fragments.add(new MainFragmentMeiFenQi());
        fragments.add(new ProductMeiFenQiFragment());
        fragments.add(new MeiFenQiSetFragment());
        mainViewPager.setUserInputEnabled(false);
        mainViewPager.setAdapter(new FragmentMeiFenQiAdapter(getSupportFragmentManager(), getLifecycle(), fragments));
    ...
    private void initAdapter(){
        if (meiFenQiTabAdapter == null){
            meiFenQiTabAdapter = new MeiFenQiTabAdapter(R.layout.adapter_mei_fen_qi_tab, tabModels);
            meiFenQiTabAdapter.setHasStableIds(true);
            meiFenQiTabAdapter.setClickedListener(position -> {
                mainViewPager.setCurrentItem(position, false);
            });
            bottomRvy.setHasFixedSize(true);
            bottomRvy.setLayoutManager(new GridLayoutManager(this, 3));
            bottomRvy.setAdapter(meiFenQiTabAdapter);
        }
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_main_mei_fen_qi;
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK
            ...
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                MyToastMeiFenQi.showShort("再按一次退出程序");
