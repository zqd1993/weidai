...
public class MeiFenQiStartPageRemindDialog extends Dialog {

    @BindView(R.id.two_btn)
    TextView twoBtn;
    @BindView(R.id.tv_txt)
    MeiFenQiClickTextView tvTxt;
    ...
    public MeiFenQiStartPageRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_mei_fen_qi_start_page);
        ...
        tvTxt.setText(OpenMeiFenQiUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
