package com.yaman.yongqb.umeifenqi;
 ...
 */
public class StatusMeiFenQiBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewMeiFenQi createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewMeiFenQi createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewMeiFenQi statusBarViewMeiFenQiHuiMin = new BarViewMeiFenQi(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewMeiFenQiHuiMin.setLayoutParams(params);
        statusBarViewMeiFenQiHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewMeiFenQiHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewMeiFenQiHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarViewMeiFenQi createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewMeiFenQi statusBarViewMeiFenQiHuiMin = new BarViewMeiFenQi(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewMeiFenQiHuiMin.setLayoutParams(params);
        statusBarViewMeiFenQiHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewMeiFenQiHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewMeiFenQiHuiMin;
    }
