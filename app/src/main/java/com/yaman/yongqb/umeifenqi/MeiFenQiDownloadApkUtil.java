...
public class MeiFenQiDownloadApkUtil {
    private static MeiFenQiDownloadApkUtil meiFenQiDownloadApkUtil;
    private final OkHttpClient client;

    public static MeiFenQiDownloadApkUtil get() {
        if (meiFenQiDownloadApkUtil == null) {
            meiFenQiDownloadApkUtil = new MeiFenQiDownloadApkUtil();
        }
        return meiFenQiDownloadApkUtil;
    }
    ...
    private MeiFenQiDownloadApkUtil() {
