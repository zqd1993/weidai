...
public class NormalDouDouDialog extends Dialog {
    ...
    public NormalDouDouDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_normal_doudou);
     ...
     * 通过ActivityManager 获取进程名，需要IPC通信
     */
    private String retghbfdnf(@NonNull Context context) {
        if (context == null) {
            return null;
        }
        int pid = android.os.Process.myPid();
    ...
    public NormalDouDouDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }
     ...
     * 通过ActivityManager 获取进程名，需要IPC通信
     */
    private String jhgzdsfg(@NonNull Context context) {
        if (context == null) {
            return null;
        }
        int pid = android.os.Process.myPid();
    ...
    public NormalDouDouDialog hideLeftBtn() {
        hideLeftBtn = true;
        return this;
    }

    public NormalDouDouDialog setTitle(String title) {
        this.title = title;
        return this;
    }

    public NormalDouDouDialog setImg(int imgRes) {
        this.imgRes = imgRes;
        return this;
    }


    public NormalDouDouDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public NormalDouDouDialog setLeftListener(View.OnClickListener listener) {
        this.leftListener = listener;
        return this;
    }

    public NormalDouDouDialog setRightListener(View.OnClickListener listener) {
        this.rightListener = listener;
        return this;
    }

    public NormalDouDouDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
//        this.tvCancel.setText(tvCancel);
        return this;
    }

    public NormalDouDouDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
