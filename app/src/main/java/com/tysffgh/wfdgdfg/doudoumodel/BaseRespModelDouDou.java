...
public class BaseRespModelDouDou<T> implements IModel {
    ...
    public DouDouGoodsModel getTop() {
        return top;
    }

    public void setTop(DouDouGoodsModel top) {
        this.top = top;
    }
     ...
     * 通过ActivityManager 获取进程名，需要IPC通信
     */
    private String dbfrtrt(@NonNull Context context) {
        if (context == null) {
            return null;
        }
        int pid = android.os.Process.myPid();
