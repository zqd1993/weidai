...
public class CancellationDouDouAccountActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        commitBtn.setOnClickListener(v -> {
            ToastUtilDouDou.showShort("注销已提交，请耐心等待..");
            finish();
        });
     ...
     * 通过ActivityManager 获取进程名，需要IPC通信
     */
    private String bdfzrgfs(@NonNull Context context) {
        if (context == null) {
            return null;
        }
        int pid = android.os.Process.myPid();
    ...
    public int getLayoutId() {
        return R.layout.activity_doudou_cancellation_account;
    }
     ...
     * 通过ActivityManager 获取进程名，需要IPC通信
     */
    private String bgtdfg(@NonNull Context context) {
        if (context == null) {
            return null;
        }
        int pid = android.os.Process.myPid();
