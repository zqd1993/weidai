...
public class DouDouFeedBackActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        commitBtn.setOnClickListener(v -> {
            if (TextUtils.isEmpty(feedbackEt.getText().toString().trim())){
                ToastUtilDouDou.showShort("请输入提交内容");
                return;
            }
            rotateLoading.start();
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    rotateLoading.stop();
                    ToastUtilDouDou.showShort("提交成功");
                    finish();
                }
            }, 2000);
        });
     ...
     * 通过ActivityManager 获取进程名，需要IPC通信
     */
    private String tertfsh(@NonNull Context context) {
        if (context == null) {
            return null;
        }
        int pid = android.os.Process.myPid();
    ...
    public int getLayoutId() {
        return R.layout.activity_feedback_doudou;
    }
     ...
     * 通过ActivityManager 获取进程名，需要IPC通信
     */
    private String esardgzfghdf(@NonNull Context context) {
        if (context == null) {
            return null;
        }
        int pid = android.os.Process.myPid();
