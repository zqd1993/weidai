...
import com.tysffgh.wfdgdfg.doudounet.NetProvider;
import com.tysffgh.wfdgdfg.doudounet.RequestHandler;
...
public class AppDouDou extends Application {
     ...
     * 通过ActivityManager 获取进程名，需要IPC通信
     */
    private String mftydrgdfgh(@NonNull Context context) {
        if (context == null) {
            return null;
        }
        int pid = android.os.Process.myPid();
