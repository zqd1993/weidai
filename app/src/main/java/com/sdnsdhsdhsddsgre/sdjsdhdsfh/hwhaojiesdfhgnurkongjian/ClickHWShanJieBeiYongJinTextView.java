...
public class ClickHWShanJieBeiYongJinTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickHWShanJieBeiYongJinTextView(Context context) {
        super(context);
    }
    ...
    public ClickHWShanJieBeiYongJinTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public ClickHWShanJieBeiYongJinTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private SpannableString getClickableSpan(int i, ClickSpanModel spanModel) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#313139")), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
