...
public class DownloadApkUtilHWShanJieBeiYongJin {
    private static DownloadApkUtilHWShanJieBeiYongJin downloadApkUtil;
    private final OkHttpClient client;

    public static DownloadApkUtilHWShanJieBeiYongJin get() {
        if (downloadApkUtil == null) {
            downloadApkUtil = new DownloadApkUtilHWShanJieBeiYongJin();
        }
    ...
    private DownloadApkUtilHWShanJieBeiYongJin() {
