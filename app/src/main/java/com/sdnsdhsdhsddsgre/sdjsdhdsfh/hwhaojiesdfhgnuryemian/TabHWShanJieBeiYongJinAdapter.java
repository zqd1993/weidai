...
import com.sdnsdhsdhsddsgre.sdjsdhdsfh.BuildConfig;
...
public class TabHWShanJieBeiYongJinAdapter extends BaseQuickAdapter<MainHWShanJieBeiYongJinActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabHWShanJieBeiYongJinAdapter(int layoutResId, @Nullable List<MainHWShanJieBeiYongJinActivity.TabModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainHWShanJieBeiYongJinActivity.TabModel item) {
        ...
        if (item.isChecked()){
            ...
            tabName.setTextColor(mContext.getResources().getColor(R.color.color_cd9a79));
        } else {
