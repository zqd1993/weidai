 ...
 */
public class StatusWuYouFQdkOpBarUtil {
    ...
    // 把json字符串变成实体类Bean并对对应参数赋值
    public <T> T tregfghdfg(String gsonString, Class<T> cls) {
        try {
            Gson gson = new Gson();
            T t = gson.fromJson(gsonString, cls);
            return t;
    ...
    // 把json字符串变成List<T>集合
    public <T> List<T> mgsdg(String gsonString, Class<T> cls) {
        List<T> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<T>>() {
    ...
    // 把json字符串变成List<Map<String, T>集合
    public <T> List<Map<String, T>> ertyrgdfg(String gsonString) {
        List<Map<String, T>> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<Map<String, T>>>() {
    ...
    // 把json字符串变成实体类Bean并对对应参数赋值
    public <T> T uyrthgfhs(String gsonString, Class<T> cls) {
        try {
            Gson gson = new Gson();
            T t = gson.fromJson(gsonString, cls);
            return t;
    ...
    // 把json字符串变成List<T>集合
    public <T> List<T> jdgdfg(String gsonString, Class<T> cls) {
        List<T> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<T>>() {
    ...
    // 把json字符串变成List<Map<String, T>集合
    public <T> List<Map<String, T>> werfghdfh(String gsonString) {
        List<Map<String, T>> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<Map<String, T>>>() {
    ...
    // 把json字符串变成Map集合
    public <T> Map<String, T> hdfgdfgdg(String gsonString) {
        Map<String, T> map = null;
        try {
            Gson gson = new Gson();
            map = gson.fromJson(gsonString, new TypeToken<Map<String, T>>() {
    ...
    // 把json字符串变成实体类Bean并对对应参数赋值
    public <T> T mawefgdfgds(String gsonString, Class<T> cls) {
        try {
            Gson gson = new Gson();
            T t = gson.fromJson(gsonString, cls);
            return t;
    ...
    // 把json字符串变成List<T>集合
    public <T> List<T> sdfsdbdfhd(String gsonString, Class<T> cls) {
        List<T> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<T>>() {
    ...
    // 把json字符串变成List<Map<String, T>集合
    public <T> List<Map<String, T>> igsdfb(String gsonString) {
        List<Map<String, T>> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<Map<String, T>>>() {
    ...
    // 把json字符串变成Map集合
    public <T> Map<String, T> yergdfsh(String gsonString) {
        Map<String, T> map = null;
        try {
            Gson gson = new Gson();
            map = gson.fromJson(gsonString, new TypeToken<Map<String, T>>() {
     ...
     * @return 状态栏矩形条
     */
    private static WuYouFQdkOpStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static WuYouFQdkOpStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        WuYouFQdkOpStatusBarView wuYouFQdkOpStatusBarView = new WuYouFQdkOpStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        wuYouFQdkOpStatusBarView.setLayoutParams(params);
        wuYouFQdkOpStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        wuYouFQdkOpStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return wuYouFQdkOpStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static WuYouFQdkOpStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        WuYouFQdkOpStatusBarView wuYouFQdkOpStatusBarView = new WuYouFQdkOpStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        wuYouFQdkOpStatusBarView.setLayoutParams(params);
        wuYouFQdkOpStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        wuYouFQdkOpStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return wuYouFQdkOpStatusBarView;
    }
