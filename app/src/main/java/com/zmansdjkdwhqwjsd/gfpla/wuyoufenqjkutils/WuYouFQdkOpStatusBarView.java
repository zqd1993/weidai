...
public class WuYouFQdkOpStatusBarView extends View {
    ...
    public WuYouFQdkOpStatusBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public WuYouFQdkOpStatusBarView(Context context) {
        super(context);
    }
