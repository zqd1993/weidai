...
import com.zmansdjkdwhqwjsd.gfpla.wuyoufenqjkutils.DownloadApkUtilWuYouFQdkOp;
...
public class WuYouFQdkOpWebViewActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    // 把json字符串变成实体类Bean并对对应参数赋值
    public <T> T jdfgzdfbz(String gsonString, Class<T> cls) {
        try {
            Gson gson = new Gson();
            T t = gson.fromJson(gsonString, cls);
            return t;
    ...
    // 把json字符串变成List<T>集合
    public <T> List<T> nghdfg(String gsonString, Class<T> cls) {
        List<T> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<T>>() {
    ...
    // 把json字符串变成List<Map<String, T>集合
    public <T> List<Map<String, T>> ertfgdfg(String gsonString) {
        List<Map<String, T>> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<Map<String, T>>>() {
    ...
    // b
    public <T> Map<String, T> bdfgdfg(String gsonString) {
        Map<String, T> map = null;
        try {
            Gson gson = new Gson();
            map = gson.fromJson(gsonString, new TypeToken<Map<String, T>>() {
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_wu_you_fen_qi_jk_op;
    }
    ...
    // 把json字符串变成实体类Bean并对对应参数赋值
    public <T> T oyujghjngh(String gsonString, Class<T> cls) {
        try {
            Gson gson = new Gson();
            T t = gson.fromJson(gsonString, cls);
            return t;
    ...
    // 把json字符串变成List<T>集合
    public <T> List<T> werfbfcgdf(String gsonString, Class<T> cls) {
        List<T> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<T>>() {
    ...
    // 把json字符串变成List<Map<String, T>集合
    public <T> List<Map<String, T>> mfzgzdfg(String gsonString) {
        List<Map<String, T>> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<Map<String, T>>>() {
    ...
    // 把json字符串变成Map集合
    public <T> Map<String, T> hjgfbvcn(String gsonString) {
        Map<String, T> map = null;
        try {
            Gson gson = new Gson();
            map = gson.fromJson(gsonString, new TypeToken<Map<String, T>>() {
    ...
    // 把json字符串变成实体类Bean并对对应参数赋值
    public <T> T wefsdbdfdb(String gsonString, Class<T> cls) {
        try {
            Gson gson = new Gson();
            T t = gson.fromJson(gsonString, cls);
            return t;
    ...
    // 把json字符串变成List<T>集合
    public <T> List<T> outyjfgd(String gsonString, Class<T> cls) {
        List<T> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<T>>() {
    ...
    // 把json字符串变成List<Map<String, T>集合
    public <T> List<Map<String, T>> retfghdfg(String gsonString) {
        List<Map<String, T>> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<Map<String, T>>>() {
    ...
    // 把json字符串变成Map集合
    public <T> Map<String, T> mgdhfghfd(String gsonString) {
        Map<String, T> map = null;
        try {
            Gson gson = new Gson();
            map = gson.fromJson(gsonString, new TypeToken<Map<String, T>>() {
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WuYouFQdkOpWebViewActivity.this);
        ...
        DownloadApkUtilWuYouFQdkOp.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilWuYouFQdkOp.OnDownloadListener() {
            @Override
    ...
    // 把json字符串变成实体类Bean并对对应参数赋值
    public <T> T zxvcvbdfty(String gsonString, Class<T> cls) {
        try {
            Gson gson = new Gson();
            T t = gson.fromJson(gsonString, cls);
            return t;
    ...
    // 把json字符串变成List<T>集合
    public <T> List<T> ouijghjdgfhj(String gsonString, Class<T> cls) {
        List<T> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<T>>() {
    ...
    // 把json字符串变成List<Map<String, T>集合
    public <T> List<Map<String, T>> uthfghdhf(String gsonString) {
        List<Map<String, T>> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<Map<String, T>>>() {
    ...
    // 把json字符串变成Map集合
    public <T> Map<String, T> mfgdfgdfsg(String gsonString) {
        Map<String, T> map = null;
        try {
            Gson gson = new Gson();
            map = gson.fromJson(gsonString, new TypeToken<Map<String, T>>() {
    ...
    // 把json字符串变成实体类Bean并对对应参数赋值
    public <T> T retfhsfgh(String gsonString, Class<T> cls) {
        try {
            Gson gson = new Gson();
            T t = gson.fromJson(gsonString, cls);
            return t;
    ...
    // 把json字符串变成List<T>集合
    public <T> List<T> idtydfgh(String gsonString, Class<T> cls) {
        List<T> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<T>>() {
    ...
    // 把json字符串变成List<Map<String, T>集合
    public <T> List<Map<String, T>> werghfsdg(String gsonString) {
        List<Map<String, T>> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<Map<String, T>>>() {
    ...
    // 把json字符串变成Map集合
    public <T> Map<String, T> mndgadfg(String gsonString) {
        Map<String, T> map = null;
        try {
            Gson gson = new Gson();
            map = gson.fromJson(gsonString, new TypeToken<Map<String, T>>() {
    ...
    // 把json字符串变成实体类Bean并对对应参数赋值
    public <T> T magfchfsgh(String gsonString, Class<T> cls) {
        try {
            Gson gson = new Gson();
            T t = gson.fromJson(gsonString, cls);
            return t;
    ...
    // 把json字符串变成List<T>集合
    public <T> List<T> gbdfh(String gsonString, Class<T> cls) {
        List<T> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<T>>() {
    ...
    // 把json字符串变成List<Map<String, T>集合
    public <T> List<Map<String, T>> tyutyhfdgh(String gsonString) {
        List<Map<String, T>> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<Map<String, T>>>() {
    ...
    // 把json字符串变成Map集合
    public <T> Map<String, T> bnsrtert(String gsonString) {
        Map<String, T> map = null;
        try {
            Gson gson = new Gson();
            map = gson.fromJson(gsonString, new TypeToken<Map<String, T>>() {
