...
public class WelcomeWuYouFQdkOpDialog extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    WuYouFQdkOpSpanTextView tvContent;
    ...
    public WelcomeWuYouFQdkOpDialog(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog__wu_you_fen_qi_jk_op_welcome);
    ...
    private List<WuYouFQdkOpSpanTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new WuYouFQdkOpSpanTextView.TextSpanModel();
