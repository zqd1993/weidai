 ...
 */
public class StatusXiaoNiuBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static XiaoNiuStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static XiaoNiuStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        XiaoNiuStatusBarView xiaoNiuStatusBarView = new XiaoNiuStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        xiaoNiuStatusBarView.setLayoutParams(params);
        xiaoNiuStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        xiaoNiuStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return xiaoNiuStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static XiaoNiuStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        XiaoNiuStatusBarView xiaoNiuStatusBarView = new XiaoNiuStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        xiaoNiuStatusBarView.setLayoutParams(params);
        xiaoNiuStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        xiaoNiuStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return xiaoNiuStatusBarView;
    }
