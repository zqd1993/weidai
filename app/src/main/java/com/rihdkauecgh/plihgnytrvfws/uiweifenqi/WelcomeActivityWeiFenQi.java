...
import com.rihdkauecgh.plihgnytrvfws.widgetweifenqi.WeiFenQiWelcomeDialog;
...
public class WelcomeActivityWeiFenQi extends AppCompatActivity {
        ...
        weiFenQiWelcomeDialog.setOnKeyListener(new DialogInterface.OnKeyListener() {
            ...
            public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_BACK && !isResume) {
                    WelcomeActivityWeiFenQi.this.finish();
                    return false;
                }
                return true;
            }
        });
        weiFenQiWelcomeDialog.setOnClickedListener(new WeiFenQiWelcomeDialog.OnClickedListener() {
            @Override
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            .url("https://luosedk1.oss-cn-shenzhen.aliyuncs.com/server7709.txt")
                            .build();
                    ...
                    if (!TextUtils.isEmpty(responseData)) {
                        if (responseData.contains(",")) {
                            ...
                            if (net.length > 1) {
                                WeiFenQiSharedPreferencesUtilis.saveStringIntoPref("HTTP_API_URL", "http://" + net[0]);
                                WeiFenQiSharedPreferencesUtilis.saveStringIntoPref("AGREEMENT", net[1]);
                                Thread.sleep(1000);
                                jumpPage();
                            }
                        }
    ...
    protected void onDestroy() {
        if (weiFenQiWelcomeDialog != null) {
            weiFenQiWelcomeDialog.dismiss();
            weiFenQiWelcomeDialog = null;
        }
        super.onDestroy();
    }
...
//            UMConfigure.init(getApplicationContext(), UMConfigure.DEVICE_TYPE_PHONE, "Umeng");
            ...
            UMConfigure.init(this, "62cc2f3505844627b5e43fa9", "Umeng", UMConfigure.DEVICE_TYPE_PHONE, "");
        }
    }
