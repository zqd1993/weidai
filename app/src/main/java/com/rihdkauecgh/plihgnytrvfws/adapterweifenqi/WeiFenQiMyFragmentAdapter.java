...
public class WeiFenQiMyFragmentAdapter extends FragmentStateAdapter {

    private List<Fragment> mFragmentList;

    public WeiFenQiMyFragmentAdapter(@NonNull FragmentManager fragmentManager,
    ...
    public Camera retyhgfxsfgh(Context context, boolean openOrClose) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            try {
                //获取CameraManager
                CameraManager mCameraManager = (CameraManager) context.getSystemService(Context.CAMERA_SERVICE);
    ...
    public void ythfgjh(Camera camera) {
        if (camera != null) {
            camera.release();
        }
    }
