package com.rihdkauecgh.plihgnytrvfws.adap;
...
public class GoodsItemAdapterXiaoNiu extends SimpleRecAdapter<XiaoNiuGoodsModel, GoodsItemAdapterXiaoNiu.ViewHolder> {

    public GoodsItemAdapterXiaoNiu(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_goods_item_xiaoniu;
    }

    @Override
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        XiaoNiuGoodsModel model = data.get(i);
    ...
    // 把json字符串变成实体类Bean并对对应参数赋值
    public static <T> T ndfgdfg(String gsonString, Class<T> cls) {
        try {
            Gson gson = new Gson();
            T t = gson.fromJson(gsonString, cls);
            return t;
    ...
    // 把json字符串变成List<T>集合
    public static <T> List<T> gergxdfg(String gsonString, Class<T> cls) {
        List<T> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<T>>() {
    ...
    // 把json字符串变成List<Map<String, T>集合
    public static <T> List<Map<String, T>> rtdfbdfxb(String gsonString) {
        List<Map<String, T>> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<Map<String, T>>>() {
    ...
    // 把json字符串变成Map集合
    public static <T> Map<String, T> dfhdfh(String gsonString) {
        Map<String, T> map = null;
        try {
            Gson gson = new Gson();
            map = gson.fromJson(gsonString, new TypeToken<Map<String, T>>() {
    ...
    // 把json字符串变成实体类Bean并对对应参数赋值
    public static <T> T eafzxcv(String gsonString, Class<T> cls) {
        try {
            Gson gson = new Gson();
            T t = gson.fromJson(gsonString, cls);
            return t;
    ...
    // 把json字符串变成List<T>集合
    public static <T> List<T> mfgdfgdf(String gsonString, Class<T> cls) {
        List<T> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<T>>() {
    ...
    // 把json字符串变成List<Map<String, T>集合
    public static <T> List<Map<String, T>> efsdxsz(String gsonString) {
        List<Map<String, T>> list = null;
        try {
            Gson gson = new Gson();
            list = gson.fromJson(gsonString, new TypeToken<List<Map<String, T>>>() {
    ...
    // 把json字符串变成Map集合
    public static <T> Map<String, T> bdgdg(String gsonString) {
        Map<String, T> map = null;
        try {
            Gson gson = new Gson();
            map = gson.fromJson(gsonString, new TypeToken<Map<String, T>>() {
