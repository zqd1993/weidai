...
public class XiaoNiuMineAdapter extends SimpleRecAdapter<MineItemXiaoNiuModel, XiaoNiuMineAdapter.ViewHolder> {

    public XiaoNiuMineAdapter(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_xiaoniu_mine_item;
    }
