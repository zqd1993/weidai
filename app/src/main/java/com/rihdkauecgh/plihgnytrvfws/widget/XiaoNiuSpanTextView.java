...
public class XiaoNiuSpanTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<BaseSpanModel> spanModels;
    private SpanClickListener listener;

    public XiaoNiuSpanTextView(Context context) {
        super(context);
    }

    public XiaoNiuSpanTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public XiaoNiuSpanTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
