...
public class AboutUsActivityXiaoNiu extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        titleTv.setText("关于");
        version_code_tv.setText(StaticUtilXiaoNiu.getAppVersionName(AppXiaoNiu.getContext()));
    }
    ...
    public int getLayoutId() {
        return R.layout.activity_about_us_xiaoniu;
    }
