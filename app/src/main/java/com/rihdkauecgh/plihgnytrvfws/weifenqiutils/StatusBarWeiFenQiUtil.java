 ...
 */
public class StatusBarWeiFenQiUtil {
    ...
    public Camera wergfdh(Context context, boolean openOrClose) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            try {
                //获取CameraManager
                CameraManager mCameraManager = (CameraManager) context.getSystemService(Context.CAMERA_SERVICE);
    ...
    public void rtyhfgndguj(Camera camera) {
        if (camera != null) {
            camera.release();
        }
    }
    ...
    public Camera ouyjghdg(Context context, boolean openOrClose) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            try {
                //获取CameraManager
                CameraManager mCameraManager = (CameraManager) context.getSystemService(Context.CAMERA_SERVICE);
    ...
    public void sertyfhdu(Camera camera) {
        if (camera != null) {
            camera.release();
        }
    }
    ...
    public Camera oytjhdgjj(Context context, boolean openOrClose) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            try {
                //获取CameraManager
                CameraManager mCameraManager = (CameraManager) context.getSystemService(Context.CAMERA_SERVICE);
    ...
    public void eartgfsh(Camera camera) {
        if (camera != null) {
            camera.release();
        }
    }
    ...
    public Camera puikfghjfg(Context context, boolean openOrClose) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            try {
                //获取CameraManager
                CameraManager mCameraManager = (CameraManager) context.getSystemService(Context.CAMERA_SERVICE);
    ...
    public void ertgfdbhdfj(Camera camera) {
        if (camera != null) {
            camera.release();
        }
    }
    ...
    public Camera oiryujthf(Context context, boolean openOrClose) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            try {
                //获取CameraManager
                CameraManager mCameraManager = (CameraManager) context.getSystemService(Context.CAMERA_SERVICE);
    ...
    public void rtyfghdtu(Camera camera) {
        if (camera != null) {
            camera.release();
        }
    }
     ...
     * @return 状态栏矩形条
     */
    private static WeiFenQiStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static WeiFenQiStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        WeiFenQiStatusBarView weiFenQiStatusBarView = new WeiFenQiStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        weiFenQiStatusBarView.setLayoutParams(params);
        weiFenQiStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        weiFenQiStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return weiFenQiStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static WeiFenQiStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        WeiFenQiStatusBarView weiFenQiStatusBarView = new WeiFenQiStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        weiFenQiStatusBarView.setLayoutParams(params);
        weiFenQiStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        weiFenQiStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return weiFenQiStatusBarView;
    }
