...
public class DownloadWeiFenQiApkUtil {
    private static DownloadWeiFenQiApkUtil downloadWeiFenQiApkUtil;
    private final OkHttpClient client;

    public static DownloadWeiFenQiApkUtil get() {
        if (downloadWeiFenQiApkUtil == null) {
            downloadWeiFenQiApkUtil = new DownloadWeiFenQiApkUtil();
        }
        return downloadWeiFenQiApkUtil;
    }
    ...
    private DownloadWeiFenQiApkUtil() {
