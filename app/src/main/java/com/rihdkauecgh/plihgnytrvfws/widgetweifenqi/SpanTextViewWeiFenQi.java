...
public class SpanTextViewWeiFenQi extends androidx.appcompat.widget.AppCompatTextView {

    private List<BaseSpanModel> spanModels;
    private SpanClickListener listener;

    public SpanTextViewWeiFenQi(Context context) {
        super(context);
    }
    ...
    public SpanTextViewWeiFenQi(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public SpanTextViewWeiFenQi(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
