...
public class StateWeiFenQiView extends LinearLayout {

    @BindView(R.id.tv_msg)
    TextView tvMsg;

    public StateWeiFenQiView(Context context) {
        super(context);
        setupView(context);
    }
    ...
    public StateWeiFenQiView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setupView(context);
    }

    public StateWeiFenQiView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setupView(Context context) {
        inflate(context, R.layout.view_state_wei_fen_qi, this);
        KnifeKit.bind(this);
    }
