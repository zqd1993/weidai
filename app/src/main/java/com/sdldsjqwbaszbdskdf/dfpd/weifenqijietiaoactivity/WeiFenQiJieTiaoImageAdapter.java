...
import com.sdldsjqwbaszbdskdf.dfpd.imageloader.ILFactory;
import com.sdldsjqwbaszbdskdf.dfpd.imageloader.ILoader;
...
public class WeiFenQiJieTiaoImageAdapter extends BannerAdapter<ProductWeiFenQiJieTiaoModel, WeiFenQiJieTiaoImageAdapter.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public WeiFenQiJieTiaoImageAdapter(List<ProductWeiFenQiJieTiaoModel> datas) {
        super(datas);
    }

    @Override
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_banner_item_wei_fen_qi_jie_tiao, parent, false);
        return new WeiFenQiJieTiaoImageAdapter.ImageHolder(view);
    }
    ...
    @Override
    public void onBindView(ImageHolder holder, ProductWeiFenQiJieTiaoModel data, int position, int size) {
        ...
        holder.shuliang_tv.setText(String.valueOf(data.getPassingRate()));
            ILFactory.getLoader().loadNet(holder.product_img, WeiFenQiJieTiaoApi.HTTP_API_URL + data.getProductLogo(),
    ...
    public interface BannerClickedListener {
        void onBannerClicked(ProductWeiFenQiJieTiaoModel entity);
    }
