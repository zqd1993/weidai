package com.sdldsjqwbaszbdskdf.dfpd.weifenqijietiaoutils;
 ...
 */
public class StatusBarUtilWeiFenQiJieTiao {
     ...
     * @return 状态栏矩形条
     */
    private static BarWeiFenQiJieTiaoView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarWeiFenQiJieTiaoView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarWeiFenQiJieTiaoView statusBarWeiFenQiJieTiaoViewHuiMin = new BarWeiFenQiJieTiaoView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarWeiFenQiJieTiaoViewHuiMin.setLayoutParams(params);
        statusBarWeiFenQiJieTiaoViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarWeiFenQiJieTiaoViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarWeiFenQiJieTiaoViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarWeiFenQiJieTiaoView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarWeiFenQiJieTiaoView statusBarWeiFenQiJieTiaoViewHuiMin = new BarWeiFenQiJieTiaoView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarWeiFenQiJieTiaoViewHuiMin.setLayoutParams(params);
        statusBarWeiFenQiJieTiaoViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarWeiFenQiJieTiaoViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarWeiFenQiJieTiaoViewHuiMin;
    }
