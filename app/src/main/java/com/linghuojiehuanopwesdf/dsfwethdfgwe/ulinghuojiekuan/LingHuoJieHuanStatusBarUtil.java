 ...
 */
public class LingHuoJieHuanStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewLingHuoJieHuan createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewLingHuoJieHuan createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewLingHuoJieHuan statusBarViewLingHuoJieHuanHuiMin = new BarViewLingHuoJieHuan(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewLingHuoJieHuanHuiMin.setLayoutParams(params);
        statusBarViewLingHuoJieHuanHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewLingHuoJieHuanHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewLingHuoJieHuanHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarViewLingHuoJieHuan createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewLingHuoJieHuan statusBarViewLingHuoJieHuanHuiMin = new BarViewLingHuoJieHuan(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewLingHuoJieHuanHuiMin.setLayoutParams(params);
        statusBarViewLingHuoJieHuanHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewLingHuoJieHuanHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewLingHuoJieHuanHuiMin;
    }
