...
public class RemindLingHuoJieHuanDialog extends Dialog {
    ...
    public RemindLingHuoJieHuanDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_ling_huo_jie_huan_normal);
    ...
    public RemindLingHuoJieHuanDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindLingHuoJieHuanDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindLingHuoJieHuanDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindLingHuoJieHuanDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindLingHuoJieHuanDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
