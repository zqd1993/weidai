...
public class ClickLingHuoJieHuanTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickLingHuoJieHuanTextView(Context context) {
        super(context);
    }

    public ClickLingHuoJieHuanTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickLingHuoJieHuanTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
