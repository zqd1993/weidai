...
import com.linghuojiehuanopwesdf.dsfwethdfgwe.ulinghuojiekuan.DownloadLingHuoJieHuanApkUtil;
...
public class JumpH5LingHuoJieHuanActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_jump_ling_huo_jie_huan_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpH5LingHuoJieHuanActivity.this);
        ...
        DownloadLingHuoJieHuanApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadLingHuoJieHuanApkUtil.OnDownloadListener() {
            @Override
