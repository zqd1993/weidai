...
public class ImageLingHuoJieHuanAdapter extends BannerAdapter<ProductLingHuoJieHuanModel, ImageLingHuoJieHuanAdapter.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public ImageLingHuoJieHuanAdapter(List<ProductLingHuoJieHuanModel> datas) {
        super(datas);
    }

    @Override
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_banner_item_ling_huo_jie_huan, parent, false);
        return new ImageLingHuoJieHuanAdapter.ImageHolder(view);
    }

    @Override
    public void onBindView(ImageHolder holder, ProductLingHuoJieHuanModel data, int position, int size) {
        ...
        ILFactory.getLoader().loadNet(holder.product_img, HttpLingHuoJieHuanApi.HTTP_API_URL + data.getProductLogo(),
    ...
    public interface BannerClickedListener {
        void onBannerClicked(ProductLingHuoJieHuanModel entity);
    }
