...
import com.jiekuanzhijiasdoert.fghirtidfks.utilsjiekuanzhijia.JieKuanZhiJiaDownloadUtil;
...
public class WebViewActivityJieKuanZhiJia extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_jie_kuan_zhi_jia;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewActivityJieKuanZhiJia.this);
        ...
        JieKuanZhiJiaDownloadUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new JieKuanZhiJiaDownloadUtil.OnDownloadListener() {
            @Override
