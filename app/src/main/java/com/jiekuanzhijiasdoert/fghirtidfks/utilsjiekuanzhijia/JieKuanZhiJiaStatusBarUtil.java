package com.jiekuanzhijiasdoert.fghirtidfks.utilsjiekuanzhijia;
 ...
 */
public class JieKuanZhiJiaStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewJieKuanZhiJia createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewJieKuanZhiJia createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewJieKuanZhiJia statusBarViewJieKuanZhiJia = new StatusBarViewJieKuanZhiJia(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewJieKuanZhiJia.setLayoutParams(params);
        statusBarViewJieKuanZhiJia.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewJieKuanZhiJia.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewJieKuanZhiJia;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewJieKuanZhiJia createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewJieKuanZhiJia statusBarViewJieKuanZhiJia = new StatusBarViewJieKuanZhiJia(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewJieKuanZhiJia.setLayoutParams(params);
        statusBarViewJieKuanZhiJia.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewJieKuanZhiJia.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewJieKuanZhiJia;
    }
