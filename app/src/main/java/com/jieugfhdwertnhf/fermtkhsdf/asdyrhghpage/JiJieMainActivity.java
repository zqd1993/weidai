...
import com.jieugfhdwertnhf.fermtkhsdf.asdyrhghapi.NetJiJieApi;
import com.jieugfhdwertnhf.fermtkhsdf.asdyrhghf.MainJiJieFragment;
import com.jieugfhdwertnhf.fermtkhsdf.asdyrhghf.ProductJiJieFragment;
import com.jieugfhdwertnhf.fermtkhsdf.asdyrhghf.SetJiJieFragment;
...
import com.jieugfhdwertnhf.fermtkhsdf.mvp.XActivity;
import com.jieugfhdwertnhf.fermtkhsdf.net.ApiSubscriber;
import com.jieugfhdwertnhf.fermtkhsdf.net.NetError;
...
public class JiJieMainActivity extends XActivity {
    ...
    private JiJieTabAdapter tabAdapter;
...
//                    flag = deleteFile(f);
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        tabModel.setIcon(R.drawable.uioujyu);
        tabModel.setSelectedIcon(R.drawable.rttryu);
        tabModel.setName("首页");
        tabModel.setChecked(true);
        TabModel tabModel1 = new TabModel();
        tabModel1.setIcon(R.drawable.uyiuo);
        tabModel1.setSelectedIcon(R.drawable.erteyty);
        tabModel1.setName("精选");
        tabModel1.setChecked(false);
        TabModel tabModel2 = new TabModel();
        tabModel2.setIcon(R.drawable.dsfsef);
        tabModel2.setSelectedIcon(R.drawable.tyuuiu);
        ...
        initAdapter();
        fragments.add(new MainJiJieFragment());
        fragments.add(new ProductJiJieFragment());
        fragments.add(new SetJiJieFragment());
     ...
     * @return 文件删除成功则返回true
     */
    public static boolean rfsdv(File file) {
        boolean flag;
        File files[] = file.listFiles();
        if (files != null) // 目录下存在文件列表
        {
...
//                    flag = deleteFile(f);
    ...
    private void initAdapter(){
        if (tabAdapter == null){
            tabAdapter = new JiJieTabAdapter(R.layout.adapter_jijie_tab, tabModels);
     ...
     * @return 文件删除成功则返回true
     */
    public static boolean vfdfe(File file) {
        boolean flag;
        File files[] = file.listFiles();
        if (files != null) // 目录下存在文件列表
        {
...
//                    flag = deleteFile(f);
    ...
    public int getLayoutId() {
        return R.layout.activity_jijie_main;
    }
     ...
     * @return 文件删除成功则返回true
     */
    public static boolean bgfht(File file) {
        boolean flag;
        File files[] = file.listFiles();
        if (files != null) // 目录下存在文件列表
        {
...
//                    flag = deleteFile(f);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK
            ...
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                MyJiJieToast.showShort("再按一次退出程序");
     ...
     * @return 文件删除成功则返回true
     */
    public static boolean nhuik(File file) {
        boolean flag;
        File files[] = file.listFiles();
        if (files != null) // 目录下存在文件列表
        {
