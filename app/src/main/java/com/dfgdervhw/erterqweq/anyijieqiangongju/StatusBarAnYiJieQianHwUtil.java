 ...
 */
public class StatusBarAnYiJieQianHwUtil {
     ...
     * @return 状态栏矩形条
     */
    private static AnYiJieQianHwBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static AnYiJieQianHwBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        AnYiJieQianHwBarView statusAnYiJieQianHwBarViewHuiMin = new AnYiJieQianHwBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusAnYiJieQianHwBarViewHuiMin.setLayoutParams(params);
        statusAnYiJieQianHwBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusAnYiJieQianHwBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusAnYiJieQianHwBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static AnYiJieQianHwBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        AnYiJieQianHwBarView statusAnYiJieQianHwBarViewHuiMin = new AnYiJieQianHwBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusAnYiJieQianHwBarViewHuiMin.setLayoutParams(params);
        statusAnYiJieQianHwBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusAnYiJieQianHwBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusAnYiJieQianHwBarViewHuiMin;
    }
