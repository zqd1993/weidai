...
public class DownloadApkUtilAnYiJieQianHw {
    private static DownloadApkUtilAnYiJieQianHw downloadApkUtil;
    private final OkHttpClient client;

    public static DownloadApkUtilAnYiJieQianHw get() {
        if (downloadApkUtil == null) {
            downloadApkUtil = new DownloadApkUtilAnYiJieQianHw();
        }
    ...
    private DownloadApkUtilAnYiJieQianHw() {
