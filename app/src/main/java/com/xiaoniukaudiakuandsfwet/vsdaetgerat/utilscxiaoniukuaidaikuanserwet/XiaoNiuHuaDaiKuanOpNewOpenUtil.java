...
import com.xiaoniukaudiakuandsfwet.vsdaetgerat.router.Router;
...
public class XiaoNiuHuaDaiKuanOpNewOpenUtil {

    public static void showErrorInfo(Context context, NetError error) {
        if (error != null) {
            if (error.getType() == NetError.ParseError) {
                XiaoNiuHuaDaiKuanOpNewMyToast.showShort("数据解析异常");
            } else if (error.getType() == NetError.AuthError) {
                XiaoNiuHuaDaiKuanOpNewMyToast.showShort("身份验证异常");
            } else if (error.getType() == NetError.BusinessError) {
                XiaoNiuHuaDaiKuanOpNewMyToast.showShort("业务异常");
            } else if (error.getType() == NetError.NoConnectError) {
                XiaoNiuHuaDaiKuanOpNewMyToast.showShort("网络无连接");
            } else if (error.getType() == NetError.NoDataError) {
                XiaoNiuHuaDaiKuanOpNewMyToast.showShort("数据为空");
            } else if (error.getType() == NetError.OtherError) {
                XiaoNiuHuaDaiKuanOpNewMyToast.showShort("其他异常");
            }
        }
    }
    ...
    public static List<XiaoNiuHuaDaiKuanOpNewClickTextView.SpanModel> createSpanTexts() {
        List<XiaoNiuHuaDaiKuanOpNewClickTextView.SpanModel> spanModels = new ArrayList<>();
        XiaoNiuHuaDaiKuanOpNewClickTextView.ClickSpanModel spanModel = new XiaoNiuHuaDaiKuanOpNewClickTextView.ClickSpanModel();
        XiaoNiuHuaDaiKuanOpNewClickTextView.SpanModel textSpanModel = new XiaoNiuHuaDaiKuanOpNewClickTextView.SpanModel();
        ...
        textSpanModel = new XiaoNiuHuaDaiKuanOpNewClickTextView.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new XiaoNiuHuaDaiKuanOpNewClickTextView.ClickSpanModel();
    ...
    public static List<XiaoNiuHuaDaiKuanOpNewClickTextView.SpanModel> createDlSpanTexts() {
        List<XiaoNiuHuaDaiKuanOpNewClickTextView.SpanModel> spanModels = new ArrayList<>();
        XiaoNiuHuaDaiKuanOpNewClickTextView.ClickSpanModel spanModel = new XiaoNiuHuaDaiKuanOpNewClickTextView.ClickSpanModel();
        XiaoNiuHuaDaiKuanOpNewClickTextView.SpanModel textSpanModel = new XiaoNiuHuaDaiKuanOpNewClickTextView.SpanModel();
