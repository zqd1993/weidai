 ...
 */
public class XiaoNiuHuaDaiKuanOpNewStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static XiaoNiuHuaDaiKuanOpNewOpNewBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static XiaoNiuHuaDaiKuanOpNewOpNewBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        XiaoNiuHuaDaiKuanOpNewOpNewBarView statusXiaoNiuHuaDaiKuanOpNewBarViewHuiMin = new XiaoNiuHuaDaiKuanOpNewOpNewBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusXiaoNiuHuaDaiKuanOpNewBarViewHuiMin.setLayoutParams(params);
        statusXiaoNiuHuaDaiKuanOpNewBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusXiaoNiuHuaDaiKuanOpNewBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusXiaoNiuHuaDaiKuanOpNewBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static XiaoNiuHuaDaiKuanOpNewOpNewBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        XiaoNiuHuaDaiKuanOpNewOpNewBarView statusXiaoNiuHuaDaiKuanOpNewBarViewHuiMin = new XiaoNiuHuaDaiKuanOpNewOpNewBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusXiaoNiuHuaDaiKuanOpNewBarViewHuiMin.setLayoutParams(params);
        statusXiaoNiuHuaDaiKuanOpNewBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusXiaoNiuHuaDaiKuanOpNewBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusXiaoNiuHuaDaiKuanOpNewBarViewHuiMin;
    }
