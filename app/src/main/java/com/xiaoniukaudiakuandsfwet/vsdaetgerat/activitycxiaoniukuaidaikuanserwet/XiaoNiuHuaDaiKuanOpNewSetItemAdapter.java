...
public class XiaoNiuHuaDaiKuanOpNewSetItemAdapter extends BaseQuickAdapter<XiaoNiuHuaDaiKuanOpNewSetModel, BaseViewHolder> {

    private OnClickListener onClickListener;

    public XiaoNiuHuaDaiKuanOpNewSetItemAdapter(int layoutResId, @Nullable List<XiaoNiuHuaDaiKuanOpNewSetModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, XiaoNiuHuaDaiKuanOpNewSetModel item) {
