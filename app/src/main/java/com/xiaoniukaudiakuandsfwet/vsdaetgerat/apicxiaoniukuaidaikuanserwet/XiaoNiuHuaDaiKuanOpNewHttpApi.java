...
public class XiaoNiuHuaDaiKuanOpNewHttpApi {
    ...
    private static XiaoNiuHuaDaiKuanOpNewInterfaceUtils xiaoNiuHuaDaiKuanOpNewInterfaceUtils;

    public static XiaoNiuHuaDaiKuanOpNewInterfaceUtils getInterfaceUtils() {
        if (xiaoNiuHuaDaiKuanOpNewInterfaceUtils == null) {
            synchronized (XiaoNiuHuaDaiKuanOpNewHttpApi.class) {
                if (xiaoNiuHuaDaiKuanOpNewInterfaceUtils == null) {
                    xiaoNiuHuaDaiKuanOpNewInterfaceUtils = XApi.getInstance().getRetrofit(HTTP_API_URL, true).create(XiaoNiuHuaDaiKuanOpNewInterfaceUtils.class);
                }
            }
        }
        return xiaoNiuHuaDaiKuanOpNewInterfaceUtils;
    }
