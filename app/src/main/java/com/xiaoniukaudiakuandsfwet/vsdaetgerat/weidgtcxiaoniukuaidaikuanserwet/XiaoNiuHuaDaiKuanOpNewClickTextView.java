...
public class XiaoNiuHuaDaiKuanOpNewClickTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public XiaoNiuHuaDaiKuanOpNewClickTextView(Context context) {
        super(context);
    }

    public XiaoNiuHuaDaiKuanOpNewClickTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
     ...
     * @return
     */
    public static int wretdzfhxfjh(Context context) {
     ...
     * @return
     */
    public static int srtyxdfhrtu(Context context) {
        WindowManager wm = (WindowManager) context
                .getSystemService(Context.WINDOW_SERVICE);
        DisplayMetrics outMetrics = new DisplayMetrics();
        wm.getDefaultDisplay().getMetrics(outMetrics);
     ...
     * @return
     */
    public static int mtysrtyhsry(Context context) {
        int statusHeight = -1;
        try {
    ...
    public XiaoNiuHuaDaiKuanOpNewClickTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private SpannableString getClickableSpan(int i, ClickSpanModel spanModel) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#8a13c5")), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
     ...
     * @return
     */
    public static int ktyidthxfj(Context context) {
        WindowManager wm = (WindowManager) context
                .getSystemService(Context.WINDOW_SERVICE);
        DisplayMetrics outMetrics = new DisplayMetrics();
        wm.getDefaultDisplay().getMetrics(outMetrics);
     ...
     * @return
     */
    public static int werzgzery(Context context) {
        WindowManager wm = (WindowManager) context
                .getSystemService(Context.WINDOW_SERVICE);
        DisplayMetrics outMetrics = new DisplayMetrics();
        wm.getDefaultDisplay().getMetrics(outMetrics);
     ...
     * @return
     */
    public static int msrtyhaeher(Context context) {
        int statusHeight = -1;
        try {
            Class<?> clazz = Class.forName("com.android.internal.R$dimen");
            Object object = clazz.newInstance();
