...
public class XiaoNiuHuaDaiKuanOpNewStartPageRemindDialog extends Dialog {

    @BindView(R.id.two_btn)
    TextView twoBtn;
    @BindView(R.id.tv_txt)
    XiaoNiuHuaDaiKuanOpNewClickTextView tvTxt;
    ...
    public XiaoNiuHuaDaiKuanOpNewStartPageRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_start_xiao_niu_hua_dai_kuan_op_new_page);
        ...
        tvTxt.setText(XiaoNiuHuaDaiKuanOpNewOpenUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
