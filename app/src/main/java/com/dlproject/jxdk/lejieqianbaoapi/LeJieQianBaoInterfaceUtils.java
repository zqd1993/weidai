...
public interface LeJieQianBaoInterfaceUtils {
    ...
    @GET("/app/user/login")
    Flowable<BaseModelLeJieQianBao<DlModelLeJieQianBao>> login(@Query("phone") String phone, @Query("code") String code, @Query("device") String device, @Query("ip") String ip);
