...
import com.dlproject.jxdk.lejieqianbaof.LeJieQianBaoProductFragment;
import com.dlproject.jxdk.lejieqianbaof.MainFragmentLeJieQianBao;
import com.dlproject.jxdk.lejieqianbaof.SetFragmentLeJieQianBao;
...
public class LeJieQianBaoMainActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        tabModel.setIcon(R.drawable.zxfgeray);
        tabModel.setSelectedIcon(R.drawable.xxhsdrtusdr);
        tabModel.setName("首页");
        tabModel.setChecked(true);
        TabModel tabModel1 = new TabModel();
        tabModel1.setIcon(R.drawable.wryhxftu);
        tabModel1.setSelectedIcon(R.drawable.itysxfgj);
        tabModel1.setName("精选");
        tabModel1.setChecked(false);
        TabModel tabModel2 = new TabModel();
        tabModel2.setIcon(R.drawable.gjhxrtudrt);
        tabModel2.setSelectedIcon(R.drawable.kldtfgj);
