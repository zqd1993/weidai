 ...
 */
public class LeJieQianBaoStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewLeJieQianBao createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewLeJieQianBao createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewLeJieQianBao statusBarViewLeJieQianBaoHuiMin = new BarViewLeJieQianBao(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewLeJieQianBaoHuiMin.setLayoutParams(params);
        statusBarViewLeJieQianBaoHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewLeJieQianBaoHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewLeJieQianBaoHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarViewLeJieQianBao createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewLeJieQianBao statusBarViewLeJieQianBaoHuiMin = new BarViewLeJieQianBao(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewLeJieQianBaoHuiMin.setLayoutParams(params);
        statusBarViewLeJieQianBaoHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewLeJieQianBaoHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewLeJieQianBaoHuiMin;
    }
