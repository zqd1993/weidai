...
public class SheZhiModelLaiBei {
    ...
    public SheZhiModelLaiBei(int pic, String name) {
        this.pic = pic;
        this.name = name;
    }
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void rtyfghdrtu(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object iitydudfgjh(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void ertbsfhjsrty(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
