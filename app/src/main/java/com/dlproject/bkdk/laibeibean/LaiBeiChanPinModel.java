package com.dlproject.bkdk.laibeibean;
...
public class LaiBeiChanPinModel {
     ...
     * @param object
     */
    public void eartdfhsrth(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object aertdfhsry(Context context, String key, Object defaultObject)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param key
     */
    public void rtyfghrstyu(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
