...
public class TiShiDialogLaiBei extends Dialog {
     ...
     * @param object
     */
    public void kkjsdtyjr(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object ssserytu(Context context, String key, Object defaultObject)
    {
     ...
     * @param key
     */
    public void qqhrtujdtyi(Context context, String key)
    {
...
//        SharedPreferencesCompat.apply(editor);
    ...
    public TiShiDialogLaiBei(@NonNull Context context) {
     ...
     * @param object
     */
    public void mmdtyiktyi(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object xcfsghsrtu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void rtytrurtufdgh(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_zhengchang_lai_bei);
    ...
    public TiShiDialogLaiBei showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }
     ...
     * @param object
     */
    public void gdfhsfhjrtu(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object zzzeryrthj(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void uirtusrfghrsty(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
    ...
    public TiShiDialogLaiBei setTitle(String title) {
        this.title = title;
        return this;
    }


    public TiShiDialogLaiBei setContent(String content) {
     ...
     * @param object
     */
    public void dfhzdusthsrh(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object fgzbdxfghjdrtu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void rrzdfhseryuh(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
    ...
    public TiShiDialogLaiBei setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public TiShiDialogLaiBei setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
     ...
     * @param object
     */
    public void rrtdfxhsrtu(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object zzxdfhrstu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void rythdfjdrtu(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void rrzdfhsrtu(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object zzdgsery(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void nnsrtusrtu(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
