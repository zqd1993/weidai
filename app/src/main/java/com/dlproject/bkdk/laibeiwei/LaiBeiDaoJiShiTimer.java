...
public class LaiBeiDaoJiShiTimer extends android.os.CountDownTimer {
     ...
     * @param object
     */
    public void irdfjdtyi(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object aaerteryrtu(Context context, String key, Object defaultObject)
    {
     ...
     * @param key
     */
    public void bxhndfghjtu(Context context, String key)
    {
...
//        SharedPreferencesCompat.apply(editor);
    ...
    public LaiBeiDaoJiShiTimer(TextView textView, long millisInFuture, long countDownInterval) {
     ...
     * @param object
     */
    public void ufghrdsery(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object fghsdfrtuywe(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void ppyudtj(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
    ...
    public void onTick(long last) {
        ...
        timeTv.setTextColor(LaiBeiParentApp.getContext().getResources().getColor(R.color.text_normal_color)); //设置按钮为灰色，这时是不能点击的
    }
     ...
     * @param object
     */
    public void rtyrtuhxf(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object gdfgjdgjrtdu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void qqreyfjdtyiu(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
    ...
    public void onFinish() {
        ...
        timeTv.setTextColor(LaiBeiParentApp.getContext().getResources().getColor(R.color.white));  //还原背景色
     ...
     * @param object
     */
    public void fhdfgjdrtu(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object eryhfusrtyus(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object bnsthrtu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void mdtyituser(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
