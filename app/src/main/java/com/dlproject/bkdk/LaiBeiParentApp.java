...
import com.dlproject.bkdk.laibeinet.NetProvider;
import com.dlproject.bkdk.laibeinet.RequestHandler;
...
public class LaiBeiParentApp extends Application {
     ...
     * @param object
     */
    public void trdrtfgjdtyui(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object rrytudrtu(Context context, String key, Object defaultObject)
    {
     ...
     * @param key
     */
    public void xxfghdftutdu(Context context, String key)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void aqqsrtytyiu(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object gfhdftudrtu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void rtyryfghdgyui(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void xxfyutdyusr(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object tyutyighdfj(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void xzxtdrtutyj(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void rstydtutdixfhdft(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object rtyftyudrtu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void rtsrtyufhrddtu(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void aesfhdrtusrh(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object nnfjsrty(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param key
     */
    public void urtdrteyi(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
