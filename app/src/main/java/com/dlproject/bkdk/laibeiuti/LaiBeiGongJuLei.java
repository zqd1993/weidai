...
public class LaiBeiGongJuLei {
     ...
     * @param object
     */
    public void puersdfhsrtut(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object srtyfxghjdfgj(Context context, String key, Object defaultObject)
    {
     ...
     * @param key
     */
    public void srtyfhdftu(Context context, String key)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void uurthxfgj(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object zxxzhxftyurtu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void rtufdghj(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
    ...
    public static void getValue(XActivity activity, Class<?> to, Bundle bundle) {
        WangLuoApiLaiBei.getInterfaceUtils().getValue("VIDEOTAPE")
                    ...
                    public void onNext(ParentModelLaiBei<LaiBeiPeiZhiEntity> configEntity) {
                        if (configEntity != null) {
                            if (configEntity.getData() != null) {
                                SPFileLaiBei.saveBool("NO_RECORD", !configEntity.getData().getVideoTape().equals("0"));
     ...
     * @param object
     */
    public void zrdyfgjhdtyu(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object rrydfhrtu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void rtyfthjd(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void rstygfhdfg(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object jkjdftdrty(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void rtdufghjdtyi(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void srtyfhfgj(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object opudj(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void jkmjdtyu(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void llgjdrtu(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object sshtrhrtsu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void pyuifgj(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
    ...
    public static List<DianJiViewLaiBei.SpanModel> createDlSpanTexts() {
        List<DianJiViewLaiBei.SpanModel> spanModels = new ArrayList<>();
        DianJiViewLaiBei.ClickSpanModel spanModel = new DianJiViewLaiBei.ClickSpanModel();
        DianJiViewLaiBei.SpanModel textSpanModel = new DianJiViewLaiBei.SpanModel();
     ...
     * @param object
     */
    public void tryfghdfu(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object dxhxfghdrtu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void iusrthfgu(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void zxhxfghrtu(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object srtyfghdftu(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void nnmdstjdtu(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
