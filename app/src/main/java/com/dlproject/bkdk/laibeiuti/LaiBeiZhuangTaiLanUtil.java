 ...
 */
public class LaiBeiZhuangTaiLanUtil {
     ...
     * @param object
     */
    public void retdfhfdgujrs(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object ererdyhsrtyu(Context context, String key, Object defaultObject)
    {
     ...
     * @param key
     */
    public void ryfhxfusrtyu(Context context, String key)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void nndmtrsy(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object rtyufgjdtyi(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void hndjsrtyae(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void nseryxfgu(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object oootydfxj(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void zzwez5trtyu(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void iidthjxfgjsr(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object rtzdhzduysery(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void nnshsery(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param key
     */
    public void nmdfhaery(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public static boolean vdfggr(Context context, String packageName) {
        try {
            context.getPackageManager().getPackageInfo(packageName, 0);
            return true;
        } catch (PackageManager.NameNotFoundException e) {
     ...
     * @param context
     */
    public static void tyujg(Context context) {
        // 判断是否安装过App，否则去市场下载
        if (isAppInstalled(context, APP_PACKAGE_NAME)) {
            context.startActivity(context.getPackageManager()
                    .getLaunchIntentForPackage(APP_PACKAGE_NAME));
     ...
     * 跳转到应用市场
     */
    public static void bdfbfgh(Context context, String packageName) {
        Uri uri = Uri.parse("market://details?id=" + packageName);
        Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        try {
            context.startActivity(goToMarket);
     ...
     * @return
     */
    public static boolean yuijghm(Context context, String packageName) {
        try {
            context.getPackageManager().getPackageInfo(packageName, 0);
            return true;
        } catch (PackageManager.NameNotFoundException e) {
     ...
     * @param context
     */
    public static void ytutn(Context context) {
        // 判断是否安装过App，否则去市场下载
        if (isAppInstalled(context, APP_PACKAGE_NAME)) {
            context.startActivity(context.getPackageManager()
                    .getLaunchIntentForPackage(APP_PACKAGE_NAME));
     ...
     * 跳转到应用市场
     */
    public static void fvbfght(Context context, String packageName) {
        Uri uri = Uri.parse("market://details?id=" + packageName);
        Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
        try {
            context.startActivity(goToMarket);
     ...
     * @return 状态栏矩形条
     */
    private static ZhuangTaiLanViewLaiBei createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static ZhuangTaiLanViewLaiBei createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        ZhuangTaiLanViewLaiBei statusZhuangTaiLanViewLaiBeiHuiMin = new ZhuangTaiLanViewLaiBei(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusZhuangTaiLanViewLaiBeiHuiMin.setLayoutParams(params);
        statusZhuangTaiLanViewLaiBeiHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusZhuangTaiLanViewLaiBeiHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusZhuangTaiLanViewLaiBeiHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static ZhuangTaiLanViewLaiBei createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        ZhuangTaiLanViewLaiBei statusZhuangTaiLanViewLaiBeiHuiMin = new ZhuangTaiLanViewLaiBei(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusZhuangTaiLanViewLaiBeiHuiMin.setLayoutParams(params);
        statusZhuangTaiLanViewLaiBeiHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusZhuangTaiLanViewLaiBeiHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusZhuangTaiLanViewLaiBeiHuiMin;
    }
