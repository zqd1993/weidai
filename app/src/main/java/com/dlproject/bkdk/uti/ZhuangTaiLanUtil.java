...
public class ZhuangTaiLanUtil {
     ...
     * @return 状态栏矩形条
     */
    private static ZhuangTaiLanView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static ZhuangTaiLanView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        ZhuangTaiLanView statusZhuangTaiLanViewHuiMin = new ZhuangTaiLanView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusZhuangTaiLanViewHuiMin.setLayoutParams(params);
        statusZhuangTaiLanViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusZhuangTaiLanViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusZhuangTaiLanViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static ZhuangTaiLanView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        ZhuangTaiLanView statusZhuangTaiLanViewHuiMin = new ZhuangTaiLanView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusZhuangTaiLanViewHuiMin.setLayoutParams(params);
        statusZhuangTaiLanViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusZhuangTaiLanViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusZhuangTaiLanViewHuiMin;
    }
