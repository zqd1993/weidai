...
import com.dlproject.bkdk.actlaibei.LaiBeiLunBoAdapter;
...
public class LaiBeiParentFragment extends XFragment {
    ...
    private LaiBeiLunBoAdapter imageAdapter;
     ...
     * @param object
     */
    public void mmdgyksr(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object zhsrhsftryu(Context context, String key, Object defaultObject)
    {
     ...
     * @param key
     */
    public void otyijghjk(Context context, String key)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void tyughjcfgi(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object rtsyfghfs(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void kllkftyidfghj(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param object
     */
    public void kkdgyidfgh(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object xxfghjdtru(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void oofytjdfh(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
...
//        SharedPreferencesCompat.apply(editor);
    ...
    private void initBannerAdapter(List<LaiBeiChanPinModel> data) {
        imageAdapter = null;
        imageAdapter = new LaiBeiLunBoAdapter(data);
     ...
     * @param object
     */
    public void kjfgnfdtjsr(Context context, String key, Object object)
    {
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @return
     */
    public Object jhdfgjrturs(Context context, String key, Object defaultObject)
    {
        SharedPreferences sp = context.getSharedPreferences("sdfzsdg",
                Context.MODE_PRIVATE);
     ...
     * @param key
     */
    public void rtudfjdtyui(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
                        ...
                        if (parentModelLaiBei != null) {
                            if (parentModelLaiBei.getCode() == 200 && parentModelLaiBei.getData() != null) {
                                if (parentModelLaiBei.getData() != null && parentModelLaiBei.getData().size() > 0) {
                                    ...
                                    initBannerAdapter(parentModelLaiBei.getData());
                                } else {
                                    if (imageAdapter == null) {
                                        noDataTv.setVisibility(View.VISIBLE);
                                    }
...
//        SharedPreferencesCompat.apply(editor);
     ...
     * @param key
     */
    public void eryrtjdgiky(Context context, String key)
    {
        SharedPreferences sp = context.getSharedPreferences("aserfwer",
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
