...
public class FragmentAdapterKuaiFq extends FragmentStateAdapter {

    private List<Fragment> fragments;

    public FragmentAdapterKuaiFq(@NonNull FragmentManager fragmentManager, Lifecycle lifecycle, List<Fragment> fragments) {
