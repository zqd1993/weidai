...
public class SetItemKuaiFqAdapter extends BaseQuickAdapter<KuaiFqSetModel, BaseViewHolder> {

    private OnClickListener onClickListener;

    public SetItemKuaiFqAdapter(int layoutResId, @Nullable List<KuaiFqSetModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, KuaiFqSetModel item) {
