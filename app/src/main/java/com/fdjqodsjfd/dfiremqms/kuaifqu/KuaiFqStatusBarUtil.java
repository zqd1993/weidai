 ...
 */
public class KuaiFqStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewKuaiFq createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewKuaiFq createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewKuaiFq statusBarViewKuaiFqHuiMin = new BarViewKuaiFq(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewKuaiFqHuiMin.setLayoutParams(params);
        statusBarViewKuaiFqHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewKuaiFqHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewKuaiFqHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarViewKuaiFq createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewKuaiFq statusBarViewKuaiFqHuiMin = new BarViewKuaiFq(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewKuaiFqHuiMin.setLayoutParams(params);
        statusBarViewKuaiFqHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewKuaiFqHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewKuaiFqHuiMin;
    }
