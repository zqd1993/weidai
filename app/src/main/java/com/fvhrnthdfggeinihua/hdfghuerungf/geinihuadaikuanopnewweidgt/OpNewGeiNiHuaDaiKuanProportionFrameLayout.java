...
public class OpNewGeiNiHuaDaiKuanProportionFrameLayout extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public OpNewGeiNiHuaDaiKuanProportionFrameLayout(@NonNull Context context) {
        super(context);
    }
    ...
    public OpNewGeiNiHuaDaiKuanProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public OpNewGeiNiHuaDaiKuanProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
