 ...
 */
public class OpNewGeiNiHuaDaiKuanStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static OpNewGeiNiHuaDaiKuanBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static OpNewGeiNiHuaDaiKuanBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        OpNewGeiNiHuaDaiKuanBarView statusOpNewGeiNiHuaDaiKuanBarViewHuiMin = new OpNewGeiNiHuaDaiKuanBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusOpNewGeiNiHuaDaiKuanBarViewHuiMin.setLayoutParams(params);
        statusOpNewGeiNiHuaDaiKuanBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusOpNewGeiNiHuaDaiKuanBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusOpNewGeiNiHuaDaiKuanBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static OpNewGeiNiHuaDaiKuanBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        OpNewGeiNiHuaDaiKuanBarView statusOpNewGeiNiHuaDaiKuanBarViewHuiMin = new OpNewGeiNiHuaDaiKuanBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusOpNewGeiNiHuaDaiKuanBarViewHuiMin.setLayoutParams(params);
        statusOpNewGeiNiHuaDaiKuanBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusOpNewGeiNiHuaDaiKuanBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusOpNewGeiNiHuaDaiKuanBarViewHuiMin;
    }
