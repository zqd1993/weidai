...
import com.fvhrnthdfggeinihua.hdfghuerungf.geinihuadaikuanopnewutils.OpNewGeiNiHuaDaiKuanDownloadApkUtil;
...
public class JumpH5ActivityJinRiYouQianHua extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_jump_h5_gei_ni_hua_dai_kuan_op_new;
    }
    ...
    public void downFile(String url) {
        ...
        OpNewGeiNiHuaDaiKuanDownloadApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new OpNewGeiNiHuaDaiKuanDownloadApkUtil.OnDownloadListener() {
            @Override
