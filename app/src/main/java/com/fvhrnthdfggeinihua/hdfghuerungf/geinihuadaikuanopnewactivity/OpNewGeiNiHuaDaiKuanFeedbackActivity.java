...
public class OpNewGeiNiHuaDaiKuanFeedbackActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gei_ni_hua_dai_kuan_op_new_feedback);
        ...
        commitBtn.setOnClickListener(v -> {
            if (feedbackEt.getText().toString().trim().isEmpty()){
                OpNewGeiNiHuaDaiKuanMyToast.showShort("请输入您的意见反馈");
                return;
            } else {
                if (xStateController != null){
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            OpNewGeiNiHuaDaiKuanMyToast.showShort("提交成功");
                            finish();
                        }
                    }, 2000);
                }
