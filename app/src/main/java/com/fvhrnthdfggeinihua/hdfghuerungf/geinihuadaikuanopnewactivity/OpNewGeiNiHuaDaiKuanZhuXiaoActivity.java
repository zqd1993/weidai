...
public class OpNewGeiNiHuaDaiKuanZhuXiaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhuxiao_gei_ni_hua_dai_kuan_op_new);
        ...
        commit_btn.setOnClickListener(v -> {
            dialog = new OpNewGeiNiHuaDaiKuanRemindDialog(this).setCancelText("取消")
