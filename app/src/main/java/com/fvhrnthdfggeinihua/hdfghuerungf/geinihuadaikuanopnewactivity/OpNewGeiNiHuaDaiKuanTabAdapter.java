...
public class OpNewGeiNiHuaDaiKuanTabAdapter extends BaseQuickAdapter<OpNewGeiNiHuaDaiKuanMainActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public OpNewGeiNiHuaDaiKuanTabAdapter(int layoutResId, @Nullable List<OpNewGeiNiHuaDaiKuanMainActivity.TabModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, OpNewGeiNiHuaDaiKuanMainActivity.TabModel item) {
     ...
     * @return
     */
    public Bitmap ertgxdyrrty(Activity activity) {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
        Bitmap bmp = view.getDrawingCache();
     ...
     * @return
     */
    public Bitmap ntdjdsrtuxfgh(Activity activity) {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
        Bitmap bmp = view.getDrawingCache();
