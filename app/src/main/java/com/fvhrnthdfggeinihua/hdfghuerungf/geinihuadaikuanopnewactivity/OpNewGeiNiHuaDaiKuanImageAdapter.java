...
public class OpNewGeiNiHuaDaiKuanImageAdapter extends BannerAdapter<OpNewGeiNiHuaDaiKuanProductModel, OpNewGeiNiHuaDaiKuanImageAdapter.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public OpNewGeiNiHuaDaiKuanImageAdapter(List<OpNewGeiNiHuaDaiKuanProductModel> datas) {
        super(datas);
    }
    ...
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_banner_item_gei_ni_hua_dai_kuan_op_new, parent, false);
        return new OpNewGeiNiHuaDaiKuanImageAdapter.ImageHolder(view);
    }

    @Override
    public void onBindView(ImageHolder holder, OpNewGeiNiHuaDaiKuanProductModel data, int position, int size) {
        ...
        holder.shuliang_tv.setText(String.valueOf(data.getPassingRate()));
            ILFactory.getLoader().loadNet(holder.product_img, OpNewGeiNiHuaDaiKuanHttpApi.HTTP_API_URL + data.getProductLogo(),
     ...
     * @return
     */
    public Bitmap asaertryru(Activity activity) {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
        Bitmap bmp = view.getDrawingCache();
     ...
     * @return
     */
    public Bitmap srtyfjhsruy(Activity activity) {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
        Bitmap bmp = view.getDrawingCache();
    ...
    public interface BannerClickedListener {
        void onBannerClicked(OpNewGeiNiHuaDaiKuanProductModel entity);
    }
