...
public class ProportionFrameLayoutSuiJieXinYongKa extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public ProportionFrameLayoutSuiJieXinYongKa(@NonNull Context context) {
        super(context);
    }

    public ProportionFrameLayoutSuiJieXinYongKa(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public ProportionFrameLayoutSuiJieXinYongKa(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
