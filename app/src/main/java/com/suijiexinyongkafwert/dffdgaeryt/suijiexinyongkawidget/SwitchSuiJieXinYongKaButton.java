...
public class SwitchSuiJieXinYongKaButton extends View {
    ...
    public SwitchSuiJieXinYongKaButton(Context context) {
        super(context);
    }

    public SwitchSuiJieXinYongKaButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
