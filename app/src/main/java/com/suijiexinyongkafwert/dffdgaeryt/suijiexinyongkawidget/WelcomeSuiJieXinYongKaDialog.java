...
public class WelcomeSuiJieXinYongKaDialog extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanSuiJieXinYongKaTextView tvContent;
    ...
    public WelcomeSuiJieXinYongKaDialog(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_sui_jie_xin_yong_ka);
    ...
    private List<SpanSuiJieXinYongKaTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanSuiJieXinYongKaTextView.TextSpanModel();
