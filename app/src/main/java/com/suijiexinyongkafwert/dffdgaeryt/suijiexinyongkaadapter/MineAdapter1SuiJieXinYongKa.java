...
public class MineAdapter1SuiJieXinYongKa extends SimpleRecAdapter<MineItemModelSuiJieXinYongKa, MineAdapter1SuiJieXinYongKa.ViewHolder> {

    public MineAdapter1SuiJieXinYongKa(Context context) {
        super(context);
    }
