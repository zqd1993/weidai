...
import com.suijiexinyongkafwert.dffdgaeryt.suijiexinyongkawidget.SpanSuiJieXinYongKaTextView;
...
import com.suijiexinyongkafwert.dffdgaeryt.suijiexinyongkapresent.LoginSuiJieXinYongKaPresent;

import okhttp3.OkHttpClient;
import okhttp3.Request;
import okhttp3.Response;

public class LoginSuiJieXinYongKaActivity extends XActivity<LoginSuiJieXinYongKaPresent> {
    ...
    SpanSuiJieXinYongKaTextView loginRemindTv;
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        isNeedChecked = SuiJieXinYongKaSharedPreferencesUtilis.getBoolFromPref("is_agree_check");
        isNeedVerification = SuiJieXinYongKaSharedPreferencesUtilis.getBoolFromPref("is_code_register");
...
//                "API_BASE_URL_1 = " + Api.API_BASE_URL);
        ...
        loginRemindTv.setText(createSpanTexts(), position -> {
            if (position == 1) {
                ...
                Router.newIntent(LoginSuiJieXinYongKaActivity.this)
    ...
    private void initListener() {
        loginBtn.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(phoneStr)) {
                ToastSuiJieXinYongKaUtil.showShort("请输入手机号");
                return;
            }
            if (!StaticSuiJieXinYongKaUtil.isValidPhoneNumber(phoneStr)) {
                ToastSuiJieXinYongKaUtil.showShort("请输入正确的手机号");
                return;
            }
            if (TextUtils.isEmpty(verificationStr) && isNeedVerification) {
                ToastSuiJieXinYongKaUtil.showShort("验证码不能为空");
                return;
            }
            if (!remindCb.isChecked()) {
                ToastSuiJieXinYongKaUtil.showShort("请阅读用户协议及隐私政策");
                return;
            }
            rotateLoading.start();
    ...
    public int getLayoutId() {
        return R.layout.activity_sui_jie_xin_yong_ka_login;
    }

    @Override
    public LoginSuiJieXinYongKaPresent newP() {
        return new LoginSuiJieXinYongKaPresent();
    }

    private List<SpanSuiJieXinYongKaTextView.BaseSpanModel> createSpanTexts() {
        List<SpanSuiJieXinYongKaTextView.BaseSpanModel> spanModels = new ArrayList<>();
        SpanSuiJieXinYongKaTextView.ClickSpanModel spanModel = new SpanSuiJieXinYongKaTextView.ClickSpanModel();
        SpanSuiJieXinYongKaTextView.TextSpanModel textSpanModel = new SpanSuiJieXinYongKaTextView.TextSpanModel();
        ...
        spanModel = new SpanSuiJieXinYongKaTextView.ClickSpanModel();
