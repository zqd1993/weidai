...
import com.suijiexinyongkafwert.dffdgaeryt.suijiexinyongkautils.DownloadSuiJieXinYongKaUtil;
...
public class WebViewSuiJieXinYongKaActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if (tag == 1) {
            ...
            StatusBarUtilSuiJieXinYongKa.setDarkMode(this);
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_sui_jie_xin_yong_ka;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewSuiJieXinYongKaActivity.this);
        ...
        DownloadSuiJieXinYongKaUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadSuiJieXinYongKaUtil.OnDownloadListener() {
            @Override
