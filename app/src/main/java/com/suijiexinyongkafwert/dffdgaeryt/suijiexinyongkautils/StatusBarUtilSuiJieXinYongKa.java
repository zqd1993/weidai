 ...
 */
public class StatusBarUtilSuiJieXinYongKa {
     ...
     * @return 状态栏矩形条
     */
    private static StatusSuiJieXinYongKaBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusSuiJieXinYongKaBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusSuiJieXinYongKaBarView statusSuiJieXinYongKaBarView = new StatusSuiJieXinYongKaBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusSuiJieXinYongKaBarView.setLayoutParams(params);
        statusSuiJieXinYongKaBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        statusSuiJieXinYongKaBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusSuiJieXinYongKaBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusSuiJieXinYongKaBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusSuiJieXinYongKaBarView statusSuiJieXinYongKaBarView = new StatusSuiJieXinYongKaBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusSuiJieXinYongKaBarView.setLayoutParams(params);
        statusSuiJieXinYongKaBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusSuiJieXinYongKaBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusSuiJieXinYongKaBarView;
    }
