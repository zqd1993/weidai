...
public class RemindLingHuoJieSvsdFdDialog extends Dialog {
    ...
    public RemindLingHuoJieSvsdFdDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_ling_huo_jie_djs_urng_normal);
    ...
    public RemindLingHuoJieSvsdFdDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindLingHuoJieSvsdFdDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindLingHuoJieSvsdFdDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindLingHuoJieSvsdFdDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindLingHuoJieSvsdFdDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
