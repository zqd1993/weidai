...
public class ClickTextViewLingHuoJieSvsdFd extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewLingHuoJieSvsdFd(Context context) {
        super(context);
    }

    public ClickTextViewLingHuoJieSvsdFd(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewLingHuoJieSvsdFd(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
