...
import com.linghuojieasdufne.vbdsetrrte.linghuojiesdhsdjmu.DownloadLingHuoJieSvsdFdApkUtil;
...
public class JumpH5ActivityLingHuoJieSvsdFd extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_jump_ling_huo_jie_djs_urng_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpH5ActivityLingHuoJieSvsdFd.this);
        ...
        DownloadLingHuoJieSvsdFdApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadLingHuoJieSvsdFdApkUtil.OnDownloadListener() {
            @Override
