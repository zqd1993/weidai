...
public class ImageAdapterLingHuoJieSvsdFd extends BannerAdapter<ProductModelLingHuoJieSvsdFd, ImageAdapterLingHuoJieSvsdFd.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public ImageAdapterLingHuoJieSvsdFd(List<ProductModelLingHuoJieSvsdFd> datas) {
        super(datas);
    }

    @Override
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_banner_item_ling_huo_jie_djs_urng, parent, false);
        return new ImageAdapterLingHuoJieSvsdFd.ImageHolder(view);
    }

    @Override
    public void onBindView(ImageHolder holder, ProductModelLingHuoJieSvsdFd data, int position, int size) {
        ...
        ILFactory.getLoader().loadNet(holder.product_img, HttpApiLingHuoJieSvsdFd.HTTP_API_URL + data.getProductLogo(),
    ...
    public interface BannerClickedListener {
        void onBannerClicked(ProductModelLingHuoJieSvsdFd entity);
    }
