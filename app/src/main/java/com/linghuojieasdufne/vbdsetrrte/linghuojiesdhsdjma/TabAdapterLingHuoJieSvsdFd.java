...
public class TabAdapterLingHuoJieSvsdFd extends BaseQuickAdapter<LingHuoJieSvsdFdMainActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabAdapterLingHuoJieSvsdFd(int layoutResId, @Nullable List<LingHuoJieSvsdFdMainActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, LingHuoJieSvsdFdMainActivity.TabModel item) {
