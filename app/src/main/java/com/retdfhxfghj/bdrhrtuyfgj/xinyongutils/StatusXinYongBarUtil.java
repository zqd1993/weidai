 ...
 */
public class StatusXinYongBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static XinYongStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static XinYongStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        XinYongStatusBarView xinYongStatusBarView = new XinYongStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        xinYongStatusBarView.setLayoutParams(params);
        xinYongStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        xinYongStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return xinYongStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static XinYongStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        XinYongStatusBarView xinYongStatusBarView = new XinYongStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        xinYongStatusBarView.setLayoutParams(params);
        xinYongStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        xinYongStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return xinYongStatusBarView;
    }
