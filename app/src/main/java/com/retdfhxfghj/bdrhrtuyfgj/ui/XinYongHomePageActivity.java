...
import com.retdfhxfghj.bdrhrtuyfgj.ui.xinyongfragment.MineFragmentXinYong;
...
import com.retdfhxfghj.bdrhrtuyfgj.xinyongadapter.MyFragmentXinYongAdapter;
import com.retdfhxfghj.bdrhrtuyfgj.xinyongpresent.MainPresentXinYong;
import com.retdfhxfghj.bdrhrtuyfgj.ui.xinyongfragment.HomePageXinYongFragment;

public class XinYongHomePageActivity extends XActivity<MainPresentXinYong> {
    ...
    private MyFragmentXinYongAdapter myFragmentXinYongAdapter;
...
//        getP().login();
        ...
        mFragments.add(new HomePageXinYongFragment());
//        mFragments.add(new ProductFragment());
        mFragments.add(new MineFragmentXinYong());

        homeViewPager.setAdapter(new MyFragmentXinYongAdapter(getSupportFragmentManager(), getLifecycle(), mFragments));
    }
    ...
    @Override
    public MainPresentXinYong newP() {
        return new MainPresentXinYong();
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK
            ...
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                XinYongToastUtil.showShort("再按一次退出程序");
