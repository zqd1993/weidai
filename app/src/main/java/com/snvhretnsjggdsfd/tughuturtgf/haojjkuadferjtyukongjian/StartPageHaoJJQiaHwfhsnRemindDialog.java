...
public class StartPageHaoJJQiaHwfhsnRemindDialog extends Dialog {

    @BindView(R.id.two_btn)
    TextView twoBtn;
    @BindView(R.id.tv_txt)
    ClickHaoJJQiaHwfhsnTextView tvTxt;
    @BindView(R.id.one_btn)
    TextView oneBtn;

    private OnListener onListener;

    public StartPageHaoJJQiaHwfhsnRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hao_jjqian_dfjr_uert_hw_dialog_start_page);
        ...
        tvTxt.setText(OpenHaoJJQiaHwfhsnUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
