...
public class ClickHaoJJQiaHwfhsnTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickHaoJJQiaHwfhsnTextView(Context context) {
        super(context);
    }
    ...
    public ClickHaoJJQiaHwfhsnTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public ClickHaoJJQiaHwfhsnTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
