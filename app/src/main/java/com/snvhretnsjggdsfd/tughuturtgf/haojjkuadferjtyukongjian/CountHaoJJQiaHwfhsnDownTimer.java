...
public class CountHaoJJQiaHwfhsnDownTimer extends android.os.CountDownTimer {
    ...
    public CountHaoJJQiaHwfhsnDownTimer(TextView textView, long millisInFuture, long countDownInterval) {
    ...
    public void onTick(long last) {
        ...
        timeTv.setTextColor(HaoJJQiaHwfhsnApp.getContext().getResources().getColor(R.color.color_bdbdc5)); //设置按钮为灰色，这时是不能点击的
    }
    ...
    public void onFinish() {
        ...
        timeTv.setTextColor(HaoJJQiaHwfhsnApp.getContext().getResources().getColor(R.color.white));  //还原背景色
