...
public class HaoJJQiaHwfhsnApi {
    ...
    private static HaoJJQiaHwfhsnInterfaceUtils interfaceUtils;
    ...
    public static HaoJJQiaHwfhsnInterfaceUtils getInterfaceUtils() {
        if (interfaceUtils == null) {
            synchronized (HaoJJQiaHwfhsnApi.class) {
                if (interfaceUtils == null) {
                    interfaceUtils = XApi.getInstance().getRetrofit(HTTP_API_URL, true).create(HaoJJQiaHwfhsnInterfaceUtils.class);
                }
            }
        }
