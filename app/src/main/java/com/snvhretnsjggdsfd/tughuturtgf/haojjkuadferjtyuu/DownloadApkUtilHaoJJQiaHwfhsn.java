...
public class DownloadApkUtilHaoJJQiaHwfhsn {
    private static DownloadApkUtilHaoJJQiaHwfhsn downloadApkUtil;
    private final OkHttpClient client;

    public static DownloadApkUtilHaoJJQiaHwfhsn get() {
        if (downloadApkUtil == null) {
            downloadApkUtil = new DownloadApkUtilHaoJJQiaHwfhsn();
        }
    ...
    private DownloadApkUtilHaoJJQiaHwfhsn() {
