...
import com.snvhretnsjggdsfd.tughuturtgf.router.Router;
...
public class OpenHaoJJQiaHwfhsnUtil {
    ...
    public static List<ClickHaoJJQiaHwfhsnTextView.SpanModel> createSpanTexts(){
        List<ClickHaoJJQiaHwfhsnTextView.SpanModel> spanModels = new ArrayList<>();
        ClickHaoJJQiaHwfhsnTextView.ClickSpanModel spanModel = new ClickHaoJJQiaHwfhsnTextView.ClickSpanModel();
        ClickHaoJJQiaHwfhsnTextView.SpanModel textSpanModel = new ClickHaoJJQiaHwfhsnTextView.SpanModel();
        ...
        textSpanModel = new ClickHaoJJQiaHwfhsnTextView.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new ClickHaoJJQiaHwfhsnTextView.ClickSpanModel();
    ...
    public static List<ClickHaoJJQiaHwfhsnTextView.SpanModel> createDlSpanTexts() {
        List<ClickHaoJJQiaHwfhsnTextView.SpanModel> spanModels = new ArrayList<>();
        ClickHaoJJQiaHwfhsnTextView.ClickSpanModel spanModel = new ClickHaoJJQiaHwfhsnTextView.ClickSpanModel();
        ClickHaoJJQiaHwfhsnTextView.SpanModel textSpanModel = new ClickHaoJJQiaHwfhsnTextView.SpanModel();
