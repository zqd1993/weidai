...
public class HaoJJQiaHwfhsnMyToast {
...
//        mac = getMachineHardwareAddress();
    ...
    private HaoJJQiaHwfhsnMyToast() {
    }


    public static void showToast(String text) {
        Toast.makeText(HaoJJQiaHwfhsnApp.getContext(), text, Toast.LENGTH_SHORT).show();
    }

    public static void showToast(int id) {
        Toast.makeText(HaoJJQiaHwfhsnApp.getContext().getApplicationContext(), id, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showShort(String message) {
        ...
        Toast.makeText(HaoJJQiaHwfhsnApp.getContext(), message, Toast.LENGTH_SHORT).show();
    }
