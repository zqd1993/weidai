 ...
 */
public class StatusBarHaoJJQiaHwfhsnUtil {
     ...
     * @return 状态栏矩形条
     */
    private static HaoJJQiaHwfhsnBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static HaoJJQiaHwfhsnBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        HaoJJQiaHwfhsnBarView statusHaoJJQiaHwfhsnBarViewHuiMin = new HaoJJQiaHwfhsnBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusHaoJJQiaHwfhsnBarViewHuiMin.setLayoutParams(params);
        statusHaoJJQiaHwfhsnBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusHaoJJQiaHwfhsnBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusHaoJJQiaHwfhsnBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static HaoJJQiaHwfhsnBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        HaoJJQiaHwfhsnBarView statusHaoJJQiaHwfhsnBarViewHuiMin = new HaoJJQiaHwfhsnBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusHaoJJQiaHwfhsnBarViewHuiMin.setLayoutParams(params);
        statusHaoJJQiaHwfhsnBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusHaoJJQiaHwfhsnBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusHaoJJQiaHwfhsnBarViewHuiMin;
    }
