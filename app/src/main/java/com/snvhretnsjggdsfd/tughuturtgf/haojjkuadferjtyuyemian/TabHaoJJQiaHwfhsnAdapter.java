...
import com.snvhretnsjggdsfd.tughuturtgf.BuildConfig;
...
public class TabHaoJJQiaHwfhsnAdapter extends BaseQuickAdapter<MainHaoJJQiaHwfhsnActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabHaoJJQiaHwfhsnAdapter(int layoutResId, @Nullable List<MainHaoJJQiaHwfhsnActivity.TabModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainHaoJJQiaHwfhsnActivity.TabModel item) {
