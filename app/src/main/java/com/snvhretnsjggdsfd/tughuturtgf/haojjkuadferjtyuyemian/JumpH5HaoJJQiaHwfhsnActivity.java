...
import com.snvhretnsjggdsfd.tughuturtgf.haojjkuadferjtyuu.DownloadApkUtilHaoJJQiaHwfhsn;
...
public class JumpH5HaoJJQiaHwfhsnActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.hao_jjqian_dfjr_uert_hw_activity_jump_h5;
    }
    ...
    public void downFile(String url) {
        ...
        DownloadApkUtilHaoJJQiaHwfhsn.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilHaoJJQiaHwfhsn.OnDownloadListener() {
            @Override
