...
public class CancellationJieAhsQidngWasdgAccountActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        commitBtn.setOnClickListener(v -> {
            jieAhsQidngWasdgNormalDialog = new JieAhsQidngWasdgNormalDialog(this);
            jieAhsQidngWasdgNormalDialog.setTitle("温馨提示")
                    .setContent("是否注销账号？注销后将不能恢复")
                    .setCancelText("取消")
                    .setLeftListener(v1 -> jieAhsQidngWasdgNormalDialog.dismiss())
                    .setConfirmText("注销账号")
                    .setRightListener(v1 -> {
...
//                                .launch();
    ...
    public int getLayoutId() {
        return R.layout.activity_sdfrt_dfjret_kyihk_etfh_cancellation_account;
    }
