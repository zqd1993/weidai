...
public class JieAhsQidngWasdgNormalDialog extends Dialog {
    ...
    public JieAhsQidngWasdgNormalDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_sdfrt_dfjret_kyihk_etfh_normal);
    ...
    public JieAhsQidngWasdgNormalDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public JieAhsQidngWasdgNormalDialog hideLeftBtn() {
        hideLeftBtn = true;
        return this;
    }
    ...
    public JieAhsQidngWasdgNormalDialog setTitle(String title) {
        this.title = title;
        return this;
    }

    public JieAhsQidngWasdgNormalDialog setImg(int imgRes) {
        this.imgRes = imgRes;
        return this;
    }


    public JieAhsQidngWasdgNormalDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public JieAhsQidngWasdgNormalDialog setLeftListener(View.OnClickListener listener) {
        this.leftListener = listener;
        return this;
    }

    public JieAhsQidngWasdgNormalDialog setRightListener(View.OnClickListener listener) {
    ...
    public JieAhsQidngWasdgNormalDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
//        this.tvCancel.setText(tvCancel);
        return this;
    }

    public JieAhsQidngWasdgNormalDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
