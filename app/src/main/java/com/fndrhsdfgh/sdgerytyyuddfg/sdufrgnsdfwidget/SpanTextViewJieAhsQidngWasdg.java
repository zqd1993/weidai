...
public class SpanTextViewJieAhsQidngWasdg extends androidx.appcompat.widget.AppCompatTextView {

    private List<BaseSpanModel> spanModels;
    private SpanClickListener listener;

    public SpanTextViewJieAhsQidngWasdg(Context context) {
        super(context);
    }

    public SpanTextViewJieAhsQidngWasdg(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public SpanTextViewJieAhsQidngWasdg(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
