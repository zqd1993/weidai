package com.nadryeary.msftusertyu.wxxyhgongju;
...
import com.nadryeary.msftusertyu.wxxyhkongjian.ClickWeiXxyongHuaTextView;
...
import com.nadryeary.msftusertyu.router.Router;
...
public class OpenWeiXxyongHuaUtil {
    ...
    public static List<ClickWeiXxyongHuaTextView.SpanModel> createSpanTexts(){
        List<ClickWeiXxyongHuaTextView.SpanModel> spanModels = new ArrayList<>();
        ClickWeiXxyongHuaTextView.ClickSpanModel spanModel = new ClickWeiXxyongHuaTextView.ClickSpanModel();
        ClickWeiXxyongHuaTextView.SpanModel textSpanModel = new ClickWeiXxyongHuaTextView.SpanModel();
        ...
        textSpanModel = new ClickWeiXxyongHuaTextView.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new ClickWeiXxyongHuaTextView.ClickSpanModel();
    ...
    public static List<ClickWeiXxyongHuaTextView.SpanModel> createDlSpanTexts() {
        List<ClickWeiXxyongHuaTextView.SpanModel> spanModels = new ArrayList<>();
        ClickWeiXxyongHuaTextView.ClickSpanModel spanModel = new ClickWeiXxyongHuaTextView.ClickSpanModel();
        ClickWeiXxyongHuaTextView.SpanModel textSpanModel = new ClickWeiXxyongHuaTextView.SpanModel();
