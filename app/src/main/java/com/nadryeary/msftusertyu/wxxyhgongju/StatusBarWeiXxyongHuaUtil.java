 ...
 */
public class StatusBarWeiXxyongHuaUtil {
     ...
     * @return 状态栏矩形条
     */
    private static WeiXxyongHuaBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static WeiXxyongHuaBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        WeiXxyongHuaBarView statusWeiXxyongHuaBarViewHuiMin = new WeiXxyongHuaBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusWeiXxyongHuaBarViewHuiMin.setLayoutParams(params);
        statusWeiXxyongHuaBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusWeiXxyongHuaBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusWeiXxyongHuaBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static WeiXxyongHuaBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        WeiXxyongHuaBarView statusWeiXxyongHuaBarViewHuiMin = new WeiXxyongHuaBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusWeiXxyongHuaBarViewHuiMin.setLayoutParams(params);
        statusWeiXxyongHuaBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusWeiXxyongHuaBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusWeiXxyongHuaBarViewHuiMin;
    }
