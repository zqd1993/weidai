...
public class RemindWeiXxyongHuaDialog extends Dialog {
    ...
    public RemindWeiXxyongHuaDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wxxyh_dialog_normal);
    ...
    public RemindWeiXxyongHuaDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindWeiXxyongHuaDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindWeiXxyongHuaDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindWeiXxyongHuaDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindWeiXxyongHuaDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
