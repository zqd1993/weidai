...
public class ClickWeiXxyongHuaTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickWeiXxyongHuaTextView(Context context) {
        super(context);
    }
    ...
    public ClickWeiXxyongHuaTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public ClickWeiXxyongHuaTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
