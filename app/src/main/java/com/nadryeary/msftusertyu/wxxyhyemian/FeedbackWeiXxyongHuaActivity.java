...
public class FeedbackWeiXxyongHuaActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.j_wxxyh_activity_feedback);
        ...
        commitBtn.setOnClickListener(v -> {
            if (feedbackEt.getText().toString().trim().isEmpty()){
                WeiXxyongHuaMyToast.showShort("请输入您的意见反馈");
                return;
            } else {
                if (xStateController != null){
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            WeiXxyongHuaMyToast.showShort("提交成功");
                            finish();
                        }
                    }, 2000);
                }
