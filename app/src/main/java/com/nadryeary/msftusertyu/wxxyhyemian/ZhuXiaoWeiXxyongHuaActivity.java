...
public class ZhuXiaoWeiXxyongHuaActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wxxyh_wxxyh_activity_zhuxiao);
        ...
        commit_btn.setOnClickListener(v -> {
            dialog = new RemindWeiXxyongHuaDialog(this).setCancelText("取消")
