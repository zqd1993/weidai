...
public class SetItemWeiXxyongHuaAdapter extends BaseQuickAdapter<SetModelWeiXxyongHua, BaseViewHolder> {

    private OnClickListener onClickListener;

    public SetItemWeiXxyongHuaAdapter(int layoutResId, @Nullable List<SetModelWeiXxyongHua> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, SetModelWeiXxyongHua item) {
