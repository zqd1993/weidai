package com.nfhyrhdhw.nfhsueshw.anyijieqiangongju;
...
import com.nfhyrhdhw.nfhsueshw.anyijieqiankongjian.ClickAnYiJieQianHwTextView;
import com.nfhyrhdhw.nfhsueshw.mvp.XActivity;
import com.nfhyrhdhw.nfhsueshw.net.NetError;
import com.nfhyrhdhw.nfhsueshw.router.Router;
...
public class OpenAnYiJieQianHwUtil {
    ...
    public static List<ClickAnYiJieQianHwTextView.SpanModel> createSpanTexts() {
        List<ClickAnYiJieQianHwTextView.SpanModel> spanModels = new ArrayList<>();
        ClickAnYiJieQianHwTextView.ClickSpanModel spanModel = new ClickAnYiJieQianHwTextView.ClickSpanModel();
        ClickAnYiJieQianHwTextView.SpanModel textSpanModel = new ClickAnYiJieQianHwTextView.SpanModel();
        ...
        textSpanModel = new ClickAnYiJieQianHwTextView.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new ClickAnYiJieQianHwTextView.ClickSpanModel();
    ...
    public static List<ClickAnYiJieQianHwTextView.SpanModel> createDlSpanTexts() {
        List<ClickAnYiJieQianHwTextView.SpanModel> spanModels = new ArrayList<>();
        ClickAnYiJieQianHwTextView.ClickSpanModel spanModel = new ClickAnYiJieQianHwTextView.ClickSpanModel();
        ClickAnYiJieQianHwTextView.SpanModel textSpanModel = new ClickAnYiJieQianHwTextView.SpanModel();
