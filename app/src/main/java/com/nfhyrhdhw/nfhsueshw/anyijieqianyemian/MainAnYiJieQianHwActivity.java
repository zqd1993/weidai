...
import com.nfhyrhdhw.nfhsueshw.anyijieqiansuipian.MainAnYiJieQianHwFragment;
import com.nfhyrhdhw.nfhsueshw.anyijieqiansuipian.SetAnYiJieQianHwFragment;
import com.nfhyrhdhw.nfhsueshw.mvp.XActivity;
import com.nfhyrhdhw.nfhsueshw.anyijieqiangongju.AnYiJieQianHwMyToast;
...
public class MainAnYiJieQianHwActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        tabModel.setIcon(R.drawable.footer_icon_n_sy);
        tabModel.setSelectedIcon(R.drawable.footer_icon_f_sy);
        tabModel.setName("首页");
        tabModel.setChecked(true);
        TabModel tabModel1 = new TabModel();
        tabModel1.setIcon(R.drawable.footer_icon_n_cp);
        tabModel1.setSelectedIcon(R.drawable.footer_icon_f_cp);
        tabModel1.setName("精选");
        tabModel1.setChecked(false);
        TabModel tabModel2 = new TabModel();
        tabModel2.setIcon(R.drawable.footer_icon_n_wd);
        tabModel2.setSelectedIcon(R.drawable.footer_icon_f_wd);
