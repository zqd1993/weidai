...
public class ZhuXiaoAnYiJieQianHwActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.an_yi_jie_qian_wxxyh_activity_zhuxiao);
        ...
        commit_btn.setOnClickListener(v -> {
            dialog = new RemindAnYiJieQianHwDialog(this).setCancelText("取消")
