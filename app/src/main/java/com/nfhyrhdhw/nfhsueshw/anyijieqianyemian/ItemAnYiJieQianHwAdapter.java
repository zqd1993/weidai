...
import com.nfhyrhdhw.nfhsueshw.base.SimpleRecAdapter;
import com.nfhyrhdhw.nfhsueshw.kit.KnifeKit;
import com.nfhyrhdhw.nfhsueshw.anyijieqianshiti.AnYiJieQianHwItemModel;

import butterknife.BindView;

public class ItemAnYiJieQianHwAdapter extends SimpleRecAdapter<AnYiJieQianHwItemModel, ItemAnYiJieQianHwAdapter.ItemViewHolder> {

    public ItemAnYiJieQianHwAdapter(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_item_layout_an_yi_jie_qian;
    }

    @Override
    public void onBindViewHolder(ItemViewHolder itemViewHolder, int position) {
        AnYiJieQianHwItemModel model = data.get(position);
