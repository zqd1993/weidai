...
import com.nfhyrhdhw.nfhsueshw.BuildConfig;
...
public class TabAnYiJieQianHwAdapter extends BaseQuickAdapter<MainAnYiJieQianHwActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabAnYiJieQianHwAdapter(int layoutResId, @Nullable List<MainAnYiJieQianHwActivity.TabModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainAnYiJieQianHwActivity.TabModel item) {
