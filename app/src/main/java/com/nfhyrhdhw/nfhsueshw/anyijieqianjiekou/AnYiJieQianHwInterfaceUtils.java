package com.nfhyrhdhw.nfhsueshw.anyijieqianjiekou;
...
//    }
    ...
    Flowable<BaseAnYiJieQianHwModel<List<ProductAnYiJieQianHwModel>>> productList(@Query("mobileType") int mobileType, @Query("phone") String phone);
