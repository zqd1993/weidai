...
import com.dqlsdjdhwnew.fdhqwenhwnew.mghwnewu.DownloadApkUtilMangGuoHWNew;
...
public class JumpH5MangGuoHWNewActivity extends XActivity implements EasyPermissions.PermissionCallbacks {
    ...
    public int getLayoutId() {
        return R.layout.activity_mang_guo_hw_new_jump_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpH5MangGuoHWNewActivity.this);
        ...
        DownloadApkUtilMangGuoHWNew.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilMangGuoHWNew.OnDownloadListener() {
            @Override
