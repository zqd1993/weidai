...
public class TabMangGuoHWNewAdapter extends BaseQuickAdapter<MainMangGuoHWNewActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabMangGuoHWNewAdapter(int layoutResId, @Nullable List<MainMangGuoHWNewActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainMangGuoHWNewActivity.TabModel item) {
