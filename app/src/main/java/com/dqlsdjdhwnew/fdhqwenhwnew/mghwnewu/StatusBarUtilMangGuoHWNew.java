 ...
 */
public class StatusBarUtilMangGuoHWNew {
     ...
     * @return 状态栏矩形条
     */
    private static BarMangGuoHWNewView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarMangGuoHWNewView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarMangGuoHWNewView statusBarMangGuoHWNewViewHuiMin = new BarMangGuoHWNewView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarMangGuoHWNewViewHuiMin.setLayoutParams(params);
        statusBarMangGuoHWNewViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarMangGuoHWNewViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarMangGuoHWNewViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarMangGuoHWNewView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarMangGuoHWNewView statusBarMangGuoHWNewViewHuiMin = new BarMangGuoHWNewView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarMangGuoHWNewViewHuiMin.setLayoutParams(params);
        statusBarMangGuoHWNewViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarMangGuoHWNewViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarMangGuoHWNewViewHuiMin;
    }
