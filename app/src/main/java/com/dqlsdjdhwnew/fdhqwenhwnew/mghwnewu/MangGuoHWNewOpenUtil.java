...
public class MangGuoHWNewOpenUtil {
    ...
    public static List<MangGuoHWNewClickTextView.SpanModel> createSpanTexts() {
        List<MangGuoHWNewClickTextView.SpanModel> spanModels = new ArrayList<>();
        MangGuoHWNewClickTextView.ClickSpanModel spanModel = new MangGuoHWNewClickTextView.ClickSpanModel();
        MangGuoHWNewClickTextView.SpanModel textSpanModel = new MangGuoHWNewClickTextView.SpanModel();
        ...
        textSpanModel = new MangGuoHWNewClickTextView.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new MangGuoHWNewClickTextView.ClickSpanModel();
    ...
    public static List<MangGuoHWNewClickTextView.SpanModel> createDlSpanTexts() {
        List<MangGuoHWNewClickTextView.SpanModel> spanModels = new ArrayList<>();
        MangGuoHWNewClickTextView.ClickSpanModel spanModel = new MangGuoHWNewClickTextView.ClickSpanModel();
        MangGuoHWNewClickTextView.SpanModel textSpanModel = new MangGuoHWNewClickTextView.SpanModel();
