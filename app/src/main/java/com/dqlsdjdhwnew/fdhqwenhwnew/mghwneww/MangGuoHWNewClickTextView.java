...
public class MangGuoHWNewClickTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public MangGuoHWNewClickTextView(Context context) {
        super(context);
    }

    public MangGuoHWNewClickTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MangGuoHWNewClickTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
