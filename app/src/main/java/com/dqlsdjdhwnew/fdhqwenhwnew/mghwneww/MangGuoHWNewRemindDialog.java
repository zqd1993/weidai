...
public class MangGuoHWNewRemindDialog extends Dialog {
    ...
    public MangGuoHWNewRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_normal_mang_guo_hw_new);
    ...
    public MangGuoHWNewRemindDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public MangGuoHWNewRemindDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public MangGuoHWNewRemindDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public MangGuoHWNewRemindDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public MangGuoHWNewRemindDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
