package com.akjsdhfkjhj.kahssj.widget;
...
public class PuTongDialog extends Dialog {
    ...
    public PuTongDialog(@NonNull Context context) {
    ...
    public PuTongDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public PuTongDialog setTitle(String title) {
        this.title = title;
        return this;
    }

    public PuTongDialog setImg(int imgRes) {
        this.imgRes = imgRes;
        return this;
    }


    public PuTongDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public PuTongDialog setLeftListener(View.OnClickListener listener) {
        this.leftListener = listener;
        return this;
    }

    public PuTongDialog setRightListener(View.OnClickListener listener) {
        this.rightListener = listener;
        return this;
    }

    public PuTongDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public PuTongDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
