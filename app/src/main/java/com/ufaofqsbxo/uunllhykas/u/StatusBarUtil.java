package com.ufaofqsbxo.uunllhykas.u;
...
public class StatusBarUtil {
    ...
    private static StatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarView statusStatusBarViewHuiMin = new StatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusStatusBarViewHuiMin.setLayoutParams(params);
        statusStatusBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusStatusBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusStatusBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
    ...
    private static StatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        ...
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusStatusBarViewHuiMin.setLayoutParams(params);
        statusStatusBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusStatusBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusStatusBarViewHuiMin;
    }
