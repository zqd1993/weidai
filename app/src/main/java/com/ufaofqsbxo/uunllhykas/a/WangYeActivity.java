...
import com.ufaofqsbxo.uunllhykas.u.XiaZaiApkUtil;
...
public class WangYeActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WangYeActivity.this);
        ...
        XiaZaiApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new XiaZaiApkUtil.OnDownloadListener() {
            @Override
