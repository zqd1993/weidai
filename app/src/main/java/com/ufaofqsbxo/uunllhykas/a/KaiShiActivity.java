...
import com.ufaofqsbxo.uunllhykas.w.StartPageRemindDialog;
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            .url("https://luosedk1.oss-cn-shenzhen.aliyuncs.com/server7728.txt")
                            .build();
...
//            UMConfigure.init(getApplicationContext(), UMConfigure.DEVICE_TYPE_PHONE, "Umeng");
            ...
            UMConfigure.init(this, "62ab036c05844627b5b53c40", "Umeng", UMConfigure.DEVICE_TYPE_PHONE, "");
        }
    }
}
