...
public class ImageAdapterZhaoCaiAdfm extends BannerAdapter<ProductModelZhaoCaiAdfm, ImageAdapterZhaoCaiAdfm.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public ImageAdapterZhaoCaiAdfm(List<ProductModelZhaoCaiAdfm> datas) {
        super(datas);
    }

    @Override
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_banner_item_zhao_cai_endfi_weng, parent, false);
        return new ImageAdapterZhaoCaiAdfm.ImageHolder(view);
    }

    @Override
    public void onBindView(ImageHolder holder, ProductModelZhaoCaiAdfm data, int position, int size) {
        ...
        ILFactory.getLoader().loadNet(holder.product_img, PreferencesOpenUtilZhaoCaiAdfm.getString("HTTP_API_URL") + data.getProductLogo(),
    ...
    public interface BannerClickedListener {
        void onBannerClicked(ProductModelZhaoCaiAdfm entity);
    }
