...
public class TabZhaoCaiAdfmAdapter extends BaseQuickAdapter<MainZhaoCaiAdfmActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabZhaoCaiAdfmAdapter(int layoutResId, @Nullable List<MainZhaoCaiAdfmActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainZhaoCaiAdfmActivity.TabModel item) {
