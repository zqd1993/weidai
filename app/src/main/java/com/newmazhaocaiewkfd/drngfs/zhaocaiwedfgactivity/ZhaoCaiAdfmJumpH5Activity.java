...
import com.newmazhaocaiewkfd.drngfs.zhaocaiwedfgutils.DownloadApkUtilZhaoCaiAdfm;
...
public class ZhaoCaiAdfmJumpH5Activity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_zhao_cai_endfi_weng_jump_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(ZhaoCaiAdfmJumpH5Activity.this);
        ...
        DownloadApkUtilZhaoCaiAdfm.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilZhaoCaiAdfm.OnDownloadListener() {
            @Override
