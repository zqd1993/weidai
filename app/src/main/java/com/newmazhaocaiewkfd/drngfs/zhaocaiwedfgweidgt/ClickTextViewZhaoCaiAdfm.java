...
public class ClickTextViewZhaoCaiAdfm extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewZhaoCaiAdfm(Context context) {
        super(context);
    }

    public ClickTextViewZhaoCaiAdfm(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewZhaoCaiAdfm(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private SpannableString getClickableSpan(int i, ClickSpanModel spanModel) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#3e57e1")), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
