package com.newmazhaocaiewkfd.drngfs.zhaocaiwedfgweidgt;
...
public class RemindZhaoCaiAdfmDialog extends Dialog {
    ...
    public RemindZhaoCaiAdfmDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_zhao_cai_endfi_weng_normal);
    ...
    public RemindZhaoCaiAdfmDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindZhaoCaiAdfmDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindZhaoCaiAdfmDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindZhaoCaiAdfmDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindZhaoCaiAdfmDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
