...
public class ProportionFrameLayoutZhaoCaiAdfm extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public ProportionFrameLayoutZhaoCaiAdfm(@NonNull Context context) {
        super(context);
    }

    public ProportionFrameLayoutZhaoCaiAdfm(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public ProportionFrameLayoutZhaoCaiAdfm(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
