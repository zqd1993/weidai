 ...
 */
public class StatusBarZhaoCaiAdfmUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarZhaoCaiAdfmView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarZhaoCaiAdfmView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarZhaoCaiAdfmView statusBarZhaoCaiAdfmViewHuiMin = new BarZhaoCaiAdfmView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarZhaoCaiAdfmViewHuiMin.setLayoutParams(params);
        statusBarZhaoCaiAdfmViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarZhaoCaiAdfmViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarZhaoCaiAdfmViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarZhaoCaiAdfmView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarZhaoCaiAdfmView statusBarZhaoCaiAdfmViewHuiMin = new BarZhaoCaiAdfmView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarZhaoCaiAdfmViewHuiMin.setLayoutParams(params);
        statusBarZhaoCaiAdfmViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarZhaoCaiAdfmViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarZhaoCaiAdfmViewHuiMin;
    }
