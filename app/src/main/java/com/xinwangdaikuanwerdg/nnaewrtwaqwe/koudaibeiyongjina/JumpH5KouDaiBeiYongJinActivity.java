...
import com.xinwangdaikuanwerdg.nnaewrtwaqwe.koudaibeiyongjinu.DownloadApkUtilKouDaiBeiYongJin;
...
public class JumpH5KouDaiBeiYongJinActivity extends XActivity implements EasyPermissions.PermissionCallbacks {
    ...
    public int getLayoutId() {
        return R.layout.activity_jump_h5_kou_dai_bei_yong_jin;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpH5KouDaiBeiYongJinActivity.this);
        ...
        DownloadApkUtilKouDaiBeiYongJin.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilKouDaiBeiYongJin.OnDownloadListener() {
            @Override
