...
public class ClickTextViewKouDaiBeiYongJin extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewKouDaiBeiYongJin(Context context) {
        super(context);
    }

    public ClickTextViewKouDaiBeiYongJin(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewKouDaiBeiYongJin(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
