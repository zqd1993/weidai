 ...
 */
public class StatusBarUtilJieDianQian {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarJieDianQianView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarJieDianQianView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarJieDianQianView statusBarJieDianQianView = new StatusBarJieDianQianView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarJieDianQianView.setLayoutParams(params);
        statusBarJieDianQianView.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarJieDianQianView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarJieDianQianView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarJieDianQianView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarJieDianQianView statusBarJieDianQianView = new StatusBarJieDianQianView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarJieDianQianView.setLayoutParams(params);
        statusBarJieDianQianView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarJieDianQianView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarJieDianQianView;
    }
