 ...
 */
public class StatusBarDaiKuanMiaoXiaUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarDaiKuanMiaoXiaView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarDaiKuanMiaoXiaView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarDaiKuanMiaoXiaView statusBarDaiKuanMiaoXiaViewHuiMin = new BarDaiKuanMiaoXiaView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarDaiKuanMiaoXiaViewHuiMin.setLayoutParams(params);
        statusBarDaiKuanMiaoXiaViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarDaiKuanMiaoXiaViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarDaiKuanMiaoXiaViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarDaiKuanMiaoXiaView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarDaiKuanMiaoXiaView statusBarDaiKuanMiaoXiaViewHuiMin = new BarDaiKuanMiaoXiaView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarDaiKuanMiaoXiaViewHuiMin.setLayoutParams(params);
        statusBarDaiKuanMiaoXiaViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarDaiKuanMiaoXiaViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarDaiKuanMiaoXiaViewHuiMin;
    }
