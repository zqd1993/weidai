...
public class WelcomeDialogJieDianQian extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanTextViewJieDianQian tvContent;
    ...
    public WelcomeDialogJieDianQian(@NonNull Context context, String title) {
    ...
    private List<SpanTextViewJieDianQian.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanTextViewJieDianQian.TextSpanModel();
