...
public class JieDianQianNormalDialog extends Dialog {
    ...
    public JieDianQianNormalDialog(@NonNull Context context) {
    ...
    public JieDianQianNormalDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public JieDianQianNormalDialog hideLeftBtn() {
        hideLeftBtn = true;
        return this;
    }

    public JieDianQianNormalDialog setTitle(String title) {
        this.title = title;
        return this;
    }

    public JieDianQianNormalDialog setImg(int imgRes) {
        this.imgRes = imgRes;
        return this;
    }


    public JieDianQianNormalDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public JieDianQianNormalDialog setLeftListener(View.OnClickListener listener) {
        this.leftListener = listener;
        return this;
    }

    public JieDianQianNormalDialog setRightListener(View.OnClickListener listener) {
        this.rightListener = listener;
        return this;
    }

    public JieDianQianNormalDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
//        this.tvCancel.setText(tvCancel);
        return this;
    }

    public JieDianQianNormalDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
