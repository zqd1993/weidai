...
public class RemindDaiKuanMiaoXiaDialog extends Dialog {
    ...
    public RemindDaiKuanMiaoXiaDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_dai_kuan_miao_xia_normal);
    ...
    public RemindDaiKuanMiaoXiaDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindDaiKuanMiaoXiaDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindDaiKuanMiaoXiaDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindDaiKuanMiaoXiaDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindDaiKuanMiaoXiaDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
