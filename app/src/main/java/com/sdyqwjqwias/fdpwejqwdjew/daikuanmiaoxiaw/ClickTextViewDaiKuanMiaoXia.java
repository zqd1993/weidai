...
public class ClickTextViewDaiKuanMiaoXia extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewDaiKuanMiaoXia(Context context) {
        super(context);
    }

    public ClickTextViewDaiKuanMiaoXia(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewDaiKuanMiaoXia(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
