...
import com.sdyqwjqwias.fdpwejqwdjew.jiedianqianutils.DownloadJieDianQianApkUtil;
...
public class WebViewActivityJieDianQian extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewActivityJieDianQian.this);
        ...
        DownloadJieDianQianApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadJieDianQianApkUtil.OnDownloadListener() {
            @Override
