...
public class DaiKuanMiaoXiaTabAdapter extends BaseQuickAdapter<MainDaiKuanMiaoXiaActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public DaiKuanMiaoXiaTabAdapter(int layoutResId, @Nullable List<MainDaiKuanMiaoXiaActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainDaiKuanMiaoXiaActivity.TabModel item) {
