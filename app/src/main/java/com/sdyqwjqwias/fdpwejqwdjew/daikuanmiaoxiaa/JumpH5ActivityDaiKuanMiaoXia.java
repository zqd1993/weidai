...
import com.sdyqwjqwias.fdpwejqwdjew.daikuanmiaoxiau.DownloadApkUtilDaiKuanMiaoXia;
...
public class JumpH5ActivityDaiKuanMiaoXia extends XActivity implements EasyPermissions.PermissionCallbacks {
    ...
    public int getLayoutId() {
        return R.layout.activity_dai_kuan_miao_xia_jump_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpH5ActivityDaiKuanMiaoXia.this);
        ...
        DownloadApkUtilDaiKuanMiaoXia.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilDaiKuanMiaoXia.OnDownloadListener() {
            @Override
