...
public class ImageDaiKuanMiaoXiaAdapter extends BannerAdapter<ProductDaiKuanMiaoXiaModel, ImageDaiKuanMiaoXiaAdapter.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public ImageDaiKuanMiaoXiaAdapter(List<ProductDaiKuanMiaoXiaModel> datas) {
        super(datas);
    }

    @Override
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_dai_kuan_miao_xia_banner_item, parent, false);
        return new ImageDaiKuanMiaoXiaAdapter.ImageHolder(view);
    }

    @Override
    public void onBindView(ImageHolder holder, ProductDaiKuanMiaoXiaModel data, int position, int size) {
        ...
        ILFactory.getLoader().loadNet(holder.product_img, DaiKuanMiaoXiaHttpApi.HTTP_API_URL + data.getProductLogo(),
    ...
    public interface BannerClickedListener{
        void onBannerClicked(ProductDaiKuanMiaoXiaModel entity);
    }
