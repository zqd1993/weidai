...
public class SwitchQueQianMaBossButton extends View {
    ...
    public SwitchQueQianMaBossButton(Context context) {
        super(context);
    }

    public SwitchQueQianMaBossButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
