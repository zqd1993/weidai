...
public class ProportionFrameLayoutQueQianMaBoss extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public ProportionFrameLayoutQueQianMaBoss(@NonNull Context context) {
        super(context);
    }

    public ProportionFrameLayoutQueQianMaBoss(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public ProportionFrameLayoutQueQianMaBoss(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
