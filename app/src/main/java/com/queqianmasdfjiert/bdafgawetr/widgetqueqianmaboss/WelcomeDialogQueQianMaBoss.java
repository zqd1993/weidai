...
public class WelcomeDialogQueQianMaBoss extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanQueQianMaBossTextView tvContent;
    ...
    public WelcomeDialogQueQianMaBoss(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_que_qian_ma_boss_welcome);
    ...
    private List<SpanQueQianMaBossTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanQueQianMaBossTextView.TextSpanModel();
