...
public class NormalQueQianMaBossDialog extends Dialog {
    ...
    public NormalQueQianMaBossDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_normal_que_qian_ma_boss);
    ...
    public NormalQueQianMaBossDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public NormalQueQianMaBossDialog hideLeftBtn() {
        hideLeftBtn = true;
        return this;
    }

    public NormalQueQianMaBossDialog setTitle(String title) {
        this.title = title;
        return this;
    }

    public NormalQueQianMaBossDialog setImg(int imgRes) {
        this.imgRes = imgRes;
        return this;
    }


    public NormalQueQianMaBossDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public NormalQueQianMaBossDialog setLeftListener(View.OnClickListener listener) {
        this.leftListener = listener;
        return this;
    }

    public NormalQueQianMaBossDialog setRightListener(View.OnClickListener listener) {
        this.rightListener = listener;
        return this;
    }

    public NormalQueQianMaBossDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
//        this.tvCancel.setText(tvCancel);
        return this;
    }

    public NormalQueQianMaBossDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
