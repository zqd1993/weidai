 ...
 */
public class StatusBarQueQianMaBossUtil {
     ...
     * @return 状态栏矩形条
     */
    private static QueQianMaBossStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static QueQianMaBossStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        QueQianMaBossStatusBarView queQianMaBossStatusBarView = new QueQianMaBossStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        queQianMaBossStatusBarView.setLayoutParams(params);
        queQianMaBossStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        queQianMaBossStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return queQianMaBossStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static QueQianMaBossStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        QueQianMaBossStatusBarView queQianMaBossStatusBarView = new QueQianMaBossStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        queQianMaBossStatusBarView.setLayoutParams(params);
        queQianMaBossStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        queQianMaBossStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return queQianMaBossStatusBarView;
    }
