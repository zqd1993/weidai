...
public class GoodsItemQueQianMaBossAdapter extends SimpleRecAdapter<GoodsQueQianMaBossModel, GoodsItemQueQianMaBossAdapter.ViewHolder> {

    public GoodsItemQueQianMaBossAdapter(Context context) {
        super(context);
    }
