...
import com.queqianmasdfjiert.bdafgawetr.utilsqueqianmaboss.DownloadUtilQueQianMaBoss;
...
public class QueQianMaBossWebViewActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
...
//        StatusBarQueQianMaBossUtil.setDarkMode(this);
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                Log.d("QueQianMaBossWebViewActivity", "url = " + url + "--> userAgent" + userAgent + " ---> contentDisposition = " + contentDisposition + "-->mimetype = " + mimetype + "-->contentLength = " + contentLength);
                apkUrl = url;
                checkPermission();
            }
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_que_qian_ma_boss;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(QueQianMaBossWebViewActivity.this);
        ...
        DownloadUtilQueQianMaBoss.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadUtilQueQianMaBoss.OnDownloadListener() {
            @Override
