...
import com.dfgderv.erterqweq.imageloader.ILFactory;
import com.dfgderv.erterqweq.imageloader.ILoader;
...
public class MiaoJieGoodsItemAdapter extends SimpleRecAdapter<GoodsModel, MiaoJieGoodsItemAdapter.ViewHolder> {

    public MiaoJieGoodsItemAdapter(Context context) {
        super(context);
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        if (!TextUtils.isEmpty(SharedPreferencesUtilis.getStringFromPref("API_BASE_URL"))) {
            ILFactory.getLoader().loadNet(viewHolder.productImg, SharedPreferencesUtilis.getStringFromPref("API_BASE_URL") + model.getProductLogo(), new ILoader.Options(R.mipmap.app_logo, R.mipmap.app_logo));
        }
