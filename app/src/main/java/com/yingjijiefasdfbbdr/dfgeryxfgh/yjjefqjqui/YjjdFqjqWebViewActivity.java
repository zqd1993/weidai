package com.yingjijiefasdfbbdr.dfgeryxfgh.yjjefqjqui;
...
import com.yingjijiefasdfbbdr.dfgeryxfgh.yjjefqjqutils.DownloadUtilYjjdFqjq;
...
public class YjjdFqjqWebViewActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                Log.d("YjjdFqjqWebViewActivity", "url = " + url + "--> userAgent" + userAgent + " ---> contentDisposition = " + contentDisposition + "-->mimetype = " + mimetype + "-->contentLength = " + contentLength);
                apkUrl = url;
                checkPermission();
            }
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_yjjdfqjq;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(YjjdFqjqWebViewActivity.this);
        ...
        DownloadUtilYjjdFqjq.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadUtilYjjdFqjq.OnDownloadListener() {
            @Override
