...
public class SwitchButtonYjjdFqjq extends View {
    ...
    public SwitchButtonYjjdFqjq(Context context) {
        super(context);
    }

    public SwitchButtonYjjdFqjq(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
