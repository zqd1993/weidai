...
public class WelcomeYjjdFqjqDialog extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanYjjdFqjqTextView tvContent;
    ...
    public WelcomeYjjdFqjqDialog(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_yjjdfqjq_welcome);
    ...
    private List<SpanYjjdFqjqTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanYjjdFqjqTextView.TextSpanModel();
