...
public class GoodsItemYjjdFqjqAdapter1 extends SimpleRecAdapter<GoodsModelYjjdFqjq, GoodsItemYjjdFqjqAdapter1.ViewHolder> {

    public GoodsItemYjjdFqjqAdapter1(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_yjjdfqjq_goods_item_1;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.parent_fl.setOnClickListener(v -> {
