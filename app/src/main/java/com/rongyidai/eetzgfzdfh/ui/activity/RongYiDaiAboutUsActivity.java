...
public class RongYiDaiAboutUsActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        titleTv.setText("关于");
        version_tv.setText("当前版本号：v" + StaticUtilRongYiDaiRongYiDai.getAppVersionName(RongYiDaiApp.getContext()));
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_about_us_rong_yi_dai;
    }
     ...
     * @throws NoSuchFieldException
     */
    private Field zfvdryrtu() throws NoSuchFieldException {
        Class<?> superclass = this.getClass().getSuperclass();
        try {
            // support design 27及一下版本
            Class<?> headerBehaviorType = null;
     ...
     * @throws NoSuchFieldException
     */
    private Field oyhsrthfxgjh() throws NoSuchFieldException {
        Class<?> superclass = this.getClass().getSuperclass();
        try {
            // support design 27及一下版本
            Class<?> headerBehaviorType = null;
     ...
     * @param appBarLayout
     */
    private void dfghdfh(AppBarLayout appBarLayout) {
        //通过反射拿到HeaderBehavior中的flingRunnable变量
        try {
            Field flingRunnableField = getFlingRunnableField();
            Field scrollerField = getScrollerField();
