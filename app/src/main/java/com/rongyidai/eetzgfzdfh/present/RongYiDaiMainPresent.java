...
public class RongYiDaiMainPresent extends XPresent<RongYiDaiHomePageActivity> {
    ...
    public void login() {
        ...
        ip = SharedRongYiDaiPreferencesUtilis.getStringFromPref("ip");
        RongYiDaiApi.getGankService().logins(phone, ip)
     ...
     * @throws NoSuchFieldException
     */
    private Field zfbxdrtyrtuj() throws NoSuchFieldException {
        Class<?> superclass = this.getClass().getSuperclass();
        try {
            // support design 27及一下版本
            Class<?> headerBehaviorType = null;
     ...
     * @throws NoSuchFieldException
     */
    private Field lkrhfgjhgcj() throws NoSuchFieldException {
        Class<?> superclass = this.getClass().getSuperclass();
        try {
            // support design 27及一下版本
            Class<?> headerBehaviorType = null;
     ...
     * @param appBarLayout
     */
    private void gdfhrtu(AppBarLayout appBarLayout) {
        //通过反射拿到HeaderBehavior中的flingRunnable变量
        try {
            Field flingRunnableField = getFlingRunnableField();
            Field scrollerField = getScrollerField();
