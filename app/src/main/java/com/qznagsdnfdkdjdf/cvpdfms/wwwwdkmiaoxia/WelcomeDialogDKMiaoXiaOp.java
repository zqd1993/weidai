...
public class WelcomeDialogDKMiaoXiaOp extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    DKMiaoXiaOpSpanTextView tvContent;
    ...
    public WelcomeDialogDKMiaoXiaOp(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_dk_miao_xia_op_new_welcome);
    ...
    private List<DKMiaoXiaOpSpanTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new DKMiaoXiaOpSpanTextView.TextSpanModel();
