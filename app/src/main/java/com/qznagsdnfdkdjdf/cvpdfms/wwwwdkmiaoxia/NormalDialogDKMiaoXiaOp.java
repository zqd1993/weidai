...
public class NormalDialogDKMiaoXiaOp extends Dialog {
    ...
    public NormalDialogDKMiaoXiaOp(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_normal_dk_miao_xia_op_new);
    ...
    public NormalDialogDKMiaoXiaOp showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public NormalDialogDKMiaoXiaOp hideLeftBtn() {
        hideLeftBtn = true;
        return this;
    }

    public NormalDialogDKMiaoXiaOp setTitle(String title) {
        this.title = title;
        return this;
    }

    public NormalDialogDKMiaoXiaOp setImg(int imgRes) {
        this.imgRes = imgRes;
        return this;
    }
    ...
    public NormalDialogDKMiaoXiaOp setContent(String content) {
        this.content = content;
        return this;
    }

    public NormalDialogDKMiaoXiaOp setLeftListener(View.OnClickListener listener) {
        this.leftListener = listener;
        return this;
    }

    public NormalDialogDKMiaoXiaOp setRightListener(View.OnClickListener listener) {
    ...
    public NormalDialogDKMiaoXiaOp setCancelText(String tvCancel) {
        cancel = tvCancel;
//        this.tvCancel.setText(tvCancel);
        return this;
    }

    public NormalDialogDKMiaoXiaOp setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
