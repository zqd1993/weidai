...
import com.qznagsdnfdkdjdf.cvpdfms.uuuudkmiaoxia.fragmentdkmiaoxia.MineDKMiaoXiaOpFragment;
...
import com.qznagsdnfdkdjdf.cvpdfms.aaaadkmiaoxia.DKMiaoXiaOpMyFragmentAdapter;
import com.qznagsdnfdkdjdf.cvpdfms.ppppdkmiaoxia.DKMiaoXiaOpMainPresent;

public class HomePageActivityDKMiaoXiaOp extends XActivity<DKMiaoXiaOpMainPresent> {
    ...
    private DKMiaoXiaOpMyFragmentAdapter DKMiaoXiaOpMyFragmentAdapter;
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        mFragments.add(HomePageFragmentDKMiaoXiaOp.getInstant(1));
        mFragments.add(HomePageFragmentDKMiaoXiaOp.getInstant(2));
        mFragments.add(new MineDKMiaoXiaOpFragment());

        homeViewPager.setAdapter(new DKMiaoXiaOpMyFragmentAdapter(getSupportFragmentManager(), getLifecycle(), mFragments));
    }
    ...
    public int getLayoutId() {
        return R.layout.activity_home_page_dk_miao_xia_op_new;
    }

    @Override
    public DKMiaoXiaOpMainPresent newP() {
        return new DKMiaoXiaOpMainPresent();
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK
            ...
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                ToastUtilDKMiaoXiaOp.showShort("再按一次退出程序");
    ...
    public void getValue() {
        ApiDKMiaoXiaOp.getGankService().getValve("VIDEOTAPE")
                    ...
                    public void onNext(BaseRespModelDKMiaoXiaOp<ConfigDKMiaoXiaOpModel> gankResults) {
                        if (gankResults != null) {
                            if (gankResults.getData() != null) {
                                SharedPreferencesUtilisDKMiaoXiaOp.saveBoolIntoPref("NO_RECORD", !gankResults.getData().getVideoTape().equals("0"));
