...
import com.qznagsdnfdkdjdf.cvpdfms.utilsdkmiaoxia.DownloadApkUtilDKMiaoXiaOp;
...
public class DKMiaoXiaOpWebViewActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_dk_miao_xia_op_new;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(DKMiaoXiaOpWebViewActivity.this);
        ...
        DownloadApkUtilDKMiaoXiaOp.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilDKMiaoXiaOp.OnDownloadListener() {
            @Override
