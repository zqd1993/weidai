package com.koudaixinyongkasdafiwetr.bbadysery.koudaixinyongkaui;
...
import com.koudaixinyongkasdafiwetr.bbadysery.koudaixinyongkautils.KouDaiDownloadUtil;
import com.koudaixinyongkasdafiwetr.bbadysery.mvp.XActivity;
import com.koudaixinyongkasdafiwetr.bbadysery.koudaixinyongkautils.StatusKouDaiBarUtil;
...
public class WebViewActivityKouDai extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if (tag == 1) {
            ...
            StatusKouDaiBarUtil.setDarkMode(this);
    ...
    public int getLayoutId() {
        return R.layout.activity_kou_dai_web_view;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewActivityKouDai.this);
        ...
        KouDaiDownloadUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new KouDaiDownloadUtil.OnDownloadListener() {
            @Override
