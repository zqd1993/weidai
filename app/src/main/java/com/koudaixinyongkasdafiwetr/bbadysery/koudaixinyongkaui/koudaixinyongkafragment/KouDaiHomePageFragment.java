...
import com.koudaixinyongkasdafiwetr.bbadysery.koudaixinyongkapresent.HomePagePresentKouDai;
...
public class KouDaiHomePageFragment extends XFragment<HomePagePresentKouDai> {
    ...
    public GoodsModelKouDai goodsModelKouDai, topGoodsModelKouDai;
...
//        });
        topImg.setOnClickListener(v -> {
            productClick(topGoodsModelKouDai);
        });
    }

    @Override
    public int getLayoutId() {
        return R.layout.fragment_kou_dai_home_page;
    }

    private void wertzdfhgdzh(ViewGroup.LayoutParams layoutParams, int top, int bottom) {
        if (layoutParams instanceof LinearLayout.LayoutParams) {
            LinearLayout.LayoutParams temp = (LinearLayout.LayoutParams) layoutParams;
            temp.bottomMargin = bottom;
            temp.topMargin = top;
    ...
    @Override
    public HomePagePresentKouDai newP() {
        return new HomePagePresentKouDai();
    }
    ...
    private void werdzfgh(ViewGroup.LayoutParams layoutParams, int top, int bottom) {
        if (layoutParams instanceof LinearLayout.LayoutParams) {
            LinearLayout.LayoutParams temp = (LinearLayout.LayoutParams) layoutParams;
            temp.bottomMargin = bottom;
            temp.topMargin = top;
     ...
     * @param mContext  上下文
     */
    public void ertgfgh(EditText mEditText, Context mContext, View v) {
        InputMethodManager imm = (InputMethodManager) mContext
                .getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.showSoftInput(mEditText, InputMethodManager.RESULT_SHOWN);
        imm.toggleSoftInput(InputMethodManager.SHOW_FORCED,
