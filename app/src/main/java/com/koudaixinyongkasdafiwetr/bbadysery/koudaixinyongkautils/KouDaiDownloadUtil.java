...
public class KouDaiDownloadUtil {
    private static KouDaiDownloadUtil kouDaiDownloadUtil;
    private final OkHttpClient okHttpClient;

    public static KouDaiDownloadUtil get() {
        if (kouDaiDownloadUtil == null) {
            kouDaiDownloadUtil = new KouDaiDownloadUtil();
        }
        return kouDaiDownloadUtil;
    }

    private void vdsgerydgh(ViewGroup.LayoutParams layoutParams, int top, int bottom) {
     ...
     * @param mContext  上下文
     */
    public void greyutdjhdrt(EditText mEditText, Context mContext, View v) {
    ...
    private void gerhgdxfjh5(ViewGroup.LayoutParams layoutParams, int top, int bottom) {
        if (layoutParams instanceof LinearLayout.LayoutParams) {
            LinearLayout.LayoutParams temp = (LinearLayout.LayoutParams) layoutParams;
            temp.bottomMargin = bottom;
            temp.topMargin = top;
     ...
     * @param mContext  上下文
     */
    public void wertdfhft(EditText mEditText, Context mContext, View v) {
        InputMethodManager imm = (InputMethodManager) mContext
                .getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.showSoftInput(mEditText, InputMethodManager.RESULT_SHOWN);
        imm.toggleSoftInput(InputMethodManager.SHOW_FORCED,
