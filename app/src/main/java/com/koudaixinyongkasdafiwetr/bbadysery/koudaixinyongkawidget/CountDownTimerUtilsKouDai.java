...
public class CountDownTimerUtilsKouDai extends CountDownTimer {

    private TextView mTextView;

    public CountDownTimerUtilsKouDai(TextView textView, long millisInFuture, long countDownInterval) {
        super(millisInFuture, countDownInterval);
        this.mTextView = textView;
    }

    private void gzdfgryty(ViewGroup.LayoutParams layoutParams, int top, int bottom) {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setTextColor(KouDaiApp.getContext().getResources().getColor(R.color.text_normal_color)); //设置按钮为灰色，这时是不能点击的
    }
    ...
    public void onFinish() {
        ...
        mTextView.setTextColor(KouDaiApp.getContext().getResources().getColor(R.color.colorPrimary));  //还原背景色
    }
     ...
     * @param mContext  上下文
     */
    public void brgryhfd(EditText mEditText, Context mContext, View v) {
        InputMethodManager imm = (InputMethodManager) mContext
                .getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.showSoftInput(mEditText, InputMethodManager.RESULT_SHOWN);
        imm.toggleSoftInput(InputMethodManager.SHOW_FORCED,
