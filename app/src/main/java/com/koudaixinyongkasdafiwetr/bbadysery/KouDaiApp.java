package com.koudaixinyongkasdafiwetr.bbadysery;
...
import com.koudaixinyongkasdafiwetr.bbadysery.koudaixinyongkanet.NetProvider;
import com.koudaixinyongkasdafiwetr.bbadysery.koudaixinyongkanet.RequestHandler;
...
public class KouDaiApp extends Application {

    private static Context context;

    private void rgtzdryy(ViewGroup.LayoutParams layoutParams, int top, int bottom) {
     ...
     * @param mContext  上下文
     */
    public void retgzdryty(EditText mEditText, Context mContext, View v) {
        InputMethodManager imm = (InputMethodManager) mContext
                .getSystemService(Context.INPUT_METHOD_SERVICE);
        imm.showSoftInput(mEditText, InputMethodManager.RESULT_SHOWN);
        imm.toggleSoftInput(InputMethodManager.SHOW_FORCED,
