package com.koudaixinyongkasdafiwetr.bbadysery.koudaixinyongkaadapter;
...
import com.koudaixinyongkasdafiwetr.bbadysery.base.SimpleRecAdapter;
import com.koudaixinyongkasdafiwetr.bbadysery.kit.KnifeKit;
...
public class GoodsItemAdapterKouDai extends SimpleRecAdapter<GoodsModelKouDai, GoodsItemAdapterKouDai.ViewHolder> {

    public GoodsItemAdapterKouDai(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_goods_item_kou_dai;
    }

    @Override
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        GoodsModelKouDai model = data.get(i);
        viewHolder.productNameTv.setText(model.getTitle());
        Glide.with(context).load(KouDaiApi.API_BASE_URL + model.getImgs()).into(viewHolder.productImg);
