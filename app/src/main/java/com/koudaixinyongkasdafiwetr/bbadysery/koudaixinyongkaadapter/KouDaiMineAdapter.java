...
public class KouDaiMineAdapter extends SimpleRecAdapter<KouDaiMineItemModel, KouDaiMineAdapter.ViewHolder> {

    public KouDaiMineAdapter(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_mine_kou_dai_item;
    }
