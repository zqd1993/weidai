...
public class WelcomeDialogJiuJiJieTiaojghsdf extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    JiuJiJieTiaojghsdfSpanTextView tvContent;
    ...
    public WelcomeDialogJiuJiJieTiaojghsdf(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_jiu_ji_jie_tiao_boss_welcome);
    ...
    private List<JiuJiJieTiaojghsdfSpanTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new JiuJiJieTiaojghsdfSpanTextView.TextSpanModel();
