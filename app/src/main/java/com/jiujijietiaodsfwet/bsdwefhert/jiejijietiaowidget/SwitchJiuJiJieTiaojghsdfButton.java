...
public class SwitchJiuJiJieTiaojghsdfButton extends View {
    ...
    public SwitchJiuJiJieTiaojghsdfButton(Context context) {
        super(context);
    }

    public SwitchJiuJiJieTiaojghsdfButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
