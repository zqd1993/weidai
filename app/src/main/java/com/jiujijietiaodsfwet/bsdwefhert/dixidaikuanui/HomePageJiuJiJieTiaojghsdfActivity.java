...
import com.jiujijietiaodsfwet.bsdwefhert.dixidaikuanui.jiejijietiaofragment.JiuJiJieTiaojghsdfMineFragment;
import com.jiujijietiaodsfwet.bsdwefhert.dixidaikuanui.jiejijietiaofragment.HomePageJiuJiJieTiaojghsdfFragment;
import com.jiujijietiaodsfwet.bsdwefhert.dixidaikuanui.jiejijietiaofragment.ProductJiuJiJieTiaojghsdfFragment;
...
public class HomePageJiuJiJieTiaojghsdfActivity extends XActivity<MainJiuJiJieTiaojghsdfPresent> {
    ...
    private int[] uncheckedIcon = {R.drawable.xcvnberysdfgu, R.drawable.bzdyzrew, R.drawable.vnawetxfgu};
    private int[] checkedIcon = {R.drawable.qwetgzduu, R.drawable.fgjsertyzdfgh,R.drawable.lyuptyjxfgj};
