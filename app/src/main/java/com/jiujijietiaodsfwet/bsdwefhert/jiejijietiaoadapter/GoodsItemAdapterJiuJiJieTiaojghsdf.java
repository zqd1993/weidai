...
public class GoodsItemAdapterJiuJiJieTiaojghsdf extends SimpleRecAdapter<GoodsModelJiuJiJieTiaojghsdf, GoodsItemAdapterJiuJiJieTiaojghsdf.ViewHolder> {

    public GoodsItemAdapterJiuJiJieTiaojghsdf(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_goods_item_jiu_ji_jie_tiao_boss;
    }
