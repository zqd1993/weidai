 ...
 */
public class JiuJiJieTiaojghsdfStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewJiuJiJieTiaojghsdf createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewJiuJiJieTiaojghsdf createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewJiuJiJieTiaojghsdf statusBarViewJiuJiJieTiaojghsdf = new StatusBarViewJiuJiJieTiaojghsdf(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewJiuJiJieTiaojghsdf.setLayoutParams(params);
        statusBarViewJiuJiJieTiaojghsdf.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewJiuJiJieTiaojghsdf.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewJiuJiJieTiaojghsdf;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewJiuJiJieTiaojghsdf createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewJiuJiJieTiaojghsdf statusBarViewJiuJiJieTiaojghsdf = new StatusBarViewJiuJiJieTiaojghsdf(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewJiuJiJieTiaojghsdf.setLayoutParams(params);
        statusBarViewJiuJiJieTiaojghsdf.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewJiuJiJieTiaojghsdf.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewJiuJiJieTiaojghsdf;
    }
