...
import com.jiujijietiaodsfwet.bsdwefhert.jiejijietiaoutils.JiuJiJieTiaojghsdfDownloadUtil;
...
public class WebViewActivityJiuJiJieTiaojghsdf extends XActivity implements EasyPermissions.PermissionCallbacks{
...
//            header_layout.setVisibility(View.VISIBLE);
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                Log.d("WebViewActivityJiuJiJieTiaojghsdf", "url = " + url + "--> userAgent" + userAgent + " ---> contentDisposition = " + contentDisposition + "-->mimetype = " + mimetype + "-->contentLength = " + contentLength);
                apkUrl = url;
                checkPermission();
            }
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_jiu_ji_jie_tiao_boss;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewActivityJiuJiJieTiaojghsdf.this);
        ...
        JiuJiJieTiaojghsdfDownloadUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new JiuJiJieTiaojghsdfDownloadUtil.OnDownloadListener() {
            @Override
