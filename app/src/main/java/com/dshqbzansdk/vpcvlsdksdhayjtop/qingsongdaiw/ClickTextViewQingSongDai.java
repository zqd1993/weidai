...
public class ClickTextViewQingSongDai extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewQingSongDai(Context context) {
        super(context);
    }

    public ClickTextViewQingSongDai(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewQingSongDai(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private SpannableString getClickableSpan(int i, ClickSpanModel spanModel) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#bb9d65")), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
