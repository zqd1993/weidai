...
public class OpenQingSongDaiUtil {
    ...
    public static List<ClickTextViewQingSongDai.SpanModel> createSpanTexts() {
        List<ClickTextViewQingSongDai.SpanModel> spanModels = new ArrayList<>();
        ClickTextViewQingSongDai.ClickSpanModel spanModel = new ClickTextViewQingSongDai.ClickSpanModel();
        ClickTextViewQingSongDai.SpanModel textSpanModel = new ClickTextViewQingSongDai.SpanModel();
        ...
        textSpanModel = new ClickTextViewQingSongDai.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new ClickTextViewQingSongDai.ClickSpanModel();
    ...
    public static List<ClickTextViewQingSongDai.SpanModel> createDlSpanTexts() {
        List<ClickTextViewQingSongDai.SpanModel> spanModels = new ArrayList<>();
        ClickTextViewQingSongDai.ClickSpanModel spanModel = new ClickTextViewQingSongDai.ClickSpanModel();
        ClickTextViewQingSongDai.SpanModel textSpanModel = new ClickTextViewQingSongDai.SpanModel();
