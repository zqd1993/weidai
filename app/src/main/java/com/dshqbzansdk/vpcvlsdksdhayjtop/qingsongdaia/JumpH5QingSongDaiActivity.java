...
import com.dshqbzansdk.vpcvlsdksdhayjtop.qingsongdaiu.DownloadQingSongDaiApkUtil;
...
public class JumpH5QingSongDaiActivity extends XActivity implements EasyPermissions.PermissionCallbacks {
    ...
    public int getLayoutId() {
        return R.layout.activity_jump_h5_qing_song_dai;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpH5QingSongDaiActivity.this);
        ...
        DownloadQingSongDaiApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadQingSongDaiApkUtil.OnDownloadListener() {
            @Override
