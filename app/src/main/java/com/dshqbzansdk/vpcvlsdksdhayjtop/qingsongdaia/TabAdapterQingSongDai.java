...
public class TabAdapterQingSongDai extends BaseQuickAdapter<MainQingSongDaiActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabAdapterQingSongDai(int layoutResId, @Nullable List<MainQingSongDaiActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainQingSongDaiActivity.TabModel item) {
