...
public class TabXiangFenQiAdapter extends BaseQuickAdapter<MainXiangFenQiActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabXiangFenQiAdapter(int layoutResId, @Nullable List<MainXiangFenQiActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainXiangFenQiActivity.TabModel item) {
