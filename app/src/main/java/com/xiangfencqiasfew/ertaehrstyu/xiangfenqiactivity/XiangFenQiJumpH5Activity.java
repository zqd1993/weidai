...
import com.xiangfencqiasfew.ertaehrstyu.xiangfenqiutils.DownloadApkUtilXiangFenQi;
...
public class XiangFenQiJumpH5Activity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_xiang_fen_qi_jump_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(XiangFenQiJumpH5Activity.this);
        ...
        DownloadApkUtilXiangFenQi.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilXiangFenQi.OnDownloadListener() {
            @Override
