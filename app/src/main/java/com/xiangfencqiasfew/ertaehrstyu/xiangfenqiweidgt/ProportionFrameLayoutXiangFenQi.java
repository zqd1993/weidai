...
public class ProportionFrameLayoutXiangFenQi extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public ProportionFrameLayoutXiangFenQi(@NonNull Context context) {
        super(context);
    }

    public ProportionFrameLayoutXiangFenQi(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public ProportionFrameLayoutXiangFenQi(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
