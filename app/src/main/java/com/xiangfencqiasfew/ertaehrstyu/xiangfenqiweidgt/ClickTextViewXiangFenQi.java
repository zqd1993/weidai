...
public class ClickTextViewXiangFenQi extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewXiangFenQi(Context context) {
        super(context);
    }

    public ClickTextViewXiangFenQi(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewXiangFenQi(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
