...
public class RemindXiangFenQiDialog extends Dialog {
    ...
    public RemindXiangFenQiDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_xiang_fen_qi_normal);
    ...
    public RemindXiangFenQiDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindXiangFenQiDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindXiangFenQiDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindXiangFenQiDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindXiangFenQiDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
