...
public class StatusBarUtil {
    ...
    private static BarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        ...
        statusBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
    ...
    private static BarView createTranslucentStatusBarView(Activity activity, int alpha) {
        ...
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewHuiMin.setLayoutParams(params);
        statusBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewHuiMin;
    }
