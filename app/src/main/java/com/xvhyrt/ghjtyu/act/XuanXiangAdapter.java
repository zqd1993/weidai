...
public class XuanXiangAdapter extends BaseQuickAdapter<ZhongYaoActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public XuanXiangAdapter(int layoutResId, @Nullable List<ZhongYaoActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, ZhongYaoActivity.TabModel item) {
