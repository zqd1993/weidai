...
import com.nfsthjsrtuae.fghserytuxfh.kuaidaifenqidaiutils.DownloadKuaiDianFenQiDaiUtil;
...
public class KuaiDianFenQiDaiWebViewActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if (tag == 1) {
            ...
            StatusBarUtilKuaiDianFenQiDai.setDarkMode(this);
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                Log.d("KuaiDianFenQiDaiWebViewActivity", "url = " + url + "--> userAgent" + userAgent + " ---> contentDisposition = " + contentDisposition + "-->mimetype = " + mimetype + "-->contentLength = " + contentLength);
                apkUrl = url;
                checkPermission();
            }
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_kuai_dian_fen_qi_dai_web_view;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(KuaiDianFenQiDaiWebViewActivity.this);
        ...
        DownloadKuaiDianFenQiDaiUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadKuaiDianFenQiDaiUtil.OnDownloadListener() {
            @Override
