...
public class XianjinChaoShiProportionFrameLayout extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public XianjinChaoShiProportionFrameLayout(@NonNull Context context) {
        super(context);
    }

    public XianjinChaoShiProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public XianjinChaoShiProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
