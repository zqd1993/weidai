...
public class WelcomeDialogXianjinChaoShi extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanTextVieXianjinChaoShi tvContent;
    ...
    public WelcomeDialogXianjinChaoShi(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_xian_jin_chao_shi_welcome);
    ...
    private List<SpanTextVieXianjinChaoShi.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanTextVieXianjinChaoShi.TextSpanModel();
