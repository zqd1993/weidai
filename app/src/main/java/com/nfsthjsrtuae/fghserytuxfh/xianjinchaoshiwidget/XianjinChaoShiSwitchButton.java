...
public class XianjinChaoShiSwitchButton extends View {
    ...
    public XianjinChaoShiSwitchButton(Context context) {
        super(context);
    }

    public XianjinChaoShiSwitchButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
