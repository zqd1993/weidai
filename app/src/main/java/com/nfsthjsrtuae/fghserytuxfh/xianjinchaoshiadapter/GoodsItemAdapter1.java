...
public class GoodsItemAdapter1 extends SimpleRecAdapter<GoodsModelXianjinChaoShi, GoodsItemAdapter1.ViewHolder> {

    public GoodsItemAdapter1(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_goods_item_main;
    }
