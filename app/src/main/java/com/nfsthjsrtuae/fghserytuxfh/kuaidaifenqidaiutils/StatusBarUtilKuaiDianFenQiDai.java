 ...
 */
public class StatusBarUtilKuaiDianFenQiDai {
     ...
     * @return 状态栏矩形条
     */
    private static StatusKuaiDianFenQiDaiBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusKuaiDianFenQiDaiBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusKuaiDianFenQiDaiBarView statusKuaiDianFenQiDaiBarView = new StatusKuaiDianFenQiDaiBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusKuaiDianFenQiDaiBarView.setLayoutParams(params);
        statusKuaiDianFenQiDaiBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        statusKuaiDianFenQiDaiBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusKuaiDianFenQiDaiBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusKuaiDianFenQiDaiBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusKuaiDianFenQiDaiBarView statusKuaiDianFenQiDaiBarView = new StatusKuaiDianFenQiDaiBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusKuaiDianFenQiDaiBarView.setLayoutParams(params);
        statusKuaiDianFenQiDaiBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusKuaiDianFenQiDaiBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusKuaiDianFenQiDaiBarView;
    }
