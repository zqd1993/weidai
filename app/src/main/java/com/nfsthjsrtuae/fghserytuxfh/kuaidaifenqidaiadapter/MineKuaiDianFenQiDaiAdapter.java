...
public class MineKuaiDianFenQiDaiAdapter extends SimpleRecAdapter<MineKuaiDianFenQiDaiItemModel, MineKuaiDianFenQiDaiAdapter.ViewHolder> {

    public MineKuaiDianFenQiDaiAdapter(Context context) {
        super(context);
    }
