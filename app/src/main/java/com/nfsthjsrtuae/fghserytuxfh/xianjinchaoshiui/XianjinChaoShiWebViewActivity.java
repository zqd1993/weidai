...
public class XianjinChaoShiWebViewActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(XianjinChaoShiWebViewActivity.this);
        ...
        DownXianjinChaoShiUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownXianjinChaoShiUtil.OnDownloadListener() {
            @Override
