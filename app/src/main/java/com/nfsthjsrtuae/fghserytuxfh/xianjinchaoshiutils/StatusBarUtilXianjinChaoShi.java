 ...
 */
public class StatusBarUtilXianjinChaoShi {
     ...
     * @return 状态栏矩形条
     */
    private static StatusXianjinChaoShiBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusXianjinChaoShiBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusXianjinChaoShiBarView statusXianjinChaoShiBarView = new StatusXianjinChaoShiBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusXianjinChaoShiBarView.setLayoutParams(params);
        statusXianjinChaoShiBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        statusXianjinChaoShiBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusXianjinChaoShiBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusXianjinChaoShiBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusXianjinChaoShiBarView statusXianjinChaoShiBarView = new StatusXianjinChaoShiBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusXianjinChaoShiBarView.setLayoutParams(params);
        statusXianjinChaoShiBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusXianjinChaoShiBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusXianjinChaoShiBarView;
    }
