...
public class KuaiDianFenQiDaiProportionFrameLayout extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public KuaiDianFenQiDaiProportionFrameLayout(@NonNull Context context) {
        super(context);
    }

    public KuaiDianFenQiDaiProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public KuaiDianFenQiDaiProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
