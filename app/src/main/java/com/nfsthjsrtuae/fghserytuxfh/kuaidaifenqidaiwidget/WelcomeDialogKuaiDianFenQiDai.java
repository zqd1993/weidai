...
public class WelcomeDialogKuaiDianFenQiDai extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanTextViewKuaiDianFenQiDai tvContent;
    ...
    public WelcomeDialogKuaiDianFenQiDai(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_kuai_dian_fen_qi_dai_welcome);
    ...
    private List<SpanTextViewKuaiDianFenQiDai.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanTextViewKuaiDianFenQiDai.TextSpanModel();
