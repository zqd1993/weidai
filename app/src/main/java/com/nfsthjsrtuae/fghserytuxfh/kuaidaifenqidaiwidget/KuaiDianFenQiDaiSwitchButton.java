...
public class KuaiDianFenQiDaiSwitchButton extends View {
    ...
    public KuaiDianFenQiDaiSwitchButton(Context context) {
        super(context);
    }

    public KuaiDianFenQiDaiSwitchButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
