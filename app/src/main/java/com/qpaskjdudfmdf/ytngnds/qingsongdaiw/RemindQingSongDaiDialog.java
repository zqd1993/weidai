...
public class RemindQingSongDaiDialog extends Dialog {
    ...
    public RemindQingSongDaiDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_qing_song_dai_normal);
    ...
    public RemindQingSongDaiDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindQingSongDaiDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindQingSongDaiDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindQingSongDaiDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindQingSongDaiDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
