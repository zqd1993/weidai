 ...
 */
public class QingSongDaiStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewQingSongDai createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewQingSongDai createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewQingSongDai statusBarViewQingSongDaiHuiMin = new BarViewQingSongDai(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewQingSongDaiHuiMin.setLayoutParams(params);
        statusBarViewQingSongDaiHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewQingSongDaiHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewQingSongDaiHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarViewQingSongDai createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewQingSongDai statusBarViewQingSongDaiHuiMin = new BarViewQingSongDai(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewQingSongDaiHuiMin.setLayoutParams(params);
        statusBarViewQingSongDaiHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewQingSongDaiHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewQingSongDaiHuiMin;
    }
