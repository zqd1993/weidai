...
public class FeedbackQingSongDaiActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qing_song_dai_feedback);
        ...
        commitBtn.setOnClickListener(v -> {
            if (feedbackEt.getText().toString().trim().isEmpty()){
                MyQingSongDaiToast.showShort("请输入您的意见反馈");
                return;
            } else {
                if (xStateController != null){
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            MyQingSongDaiToast.showShort("提交成功");
                            finish();
                        }
                    }, 2000);
                }
