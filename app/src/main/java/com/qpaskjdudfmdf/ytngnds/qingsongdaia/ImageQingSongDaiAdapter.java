...
import com.qpaskjdudfmdf.ytngnds.imageloader.ILFactory;
import com.qpaskjdudfmdf.ytngnds.imageloader.ILoader;
import com.qpaskjdudfmdf.ytngnds.qingsongdaim.ProductQingSongDaiModel;
import com.youth.banner.adapter.BannerAdapter;

import java.util.List;

public class ImageQingSongDaiAdapter extends BannerAdapter<ProductQingSongDaiModel, ImageQingSongDaiAdapter.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public ImageQingSongDaiAdapter(List<ProductQingSongDaiModel> datas) {
        super(datas);
    }

    @Override
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_banner_item_qing_song_dai, parent, false);
        return new ImageQingSongDaiAdapter.ImageHolder(view);
    }

    @Override
    public void onBindView(ImageHolder holder, ProductQingSongDaiModel data, int position, int size) {
        ...
        ILFactory.getLoader().loadNet(holder.product_img, HttpApiQingSongDai.HTTP_API_URL + data.getProductLogo(),
    ...
    public interface BannerClickedListener{
        void onBannerClicked(ProductQingSongDaiModel entity);
    }
