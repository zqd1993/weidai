...
public class ConfigModelQianBao {
    ...
    public static String utrhjsaer(Object o) {
        String value = "";
        try {
            value = o.toString();
        } catch (Exception e) {
    ...
    public static double aewtfgdh(Object o) {

        return toDouble(o, 0);
    }

    public static double ggaerytdfhx(Object o, int defaultValue) {
        if (o == null) {
            return defaultValue;
        }
    ...
    public static long ttxreart(Object o, long defaultValue) {
        if (o == null) {
            return defaultValue;
        }
        long value = 0;
    ...
    public static String nnsgaert(Object o) {
        String value = "";
        try {
            value = o.toString();
        } catch (Exception e) {
    ...
    public static double iiytujdjsrtu(Object o) {

        return toDouble(o, 0);
    }

    public static double xxftujty(Object o, int defaultValue) {
        if (o == null) {
            return defaultValue;
        }
    ...
    public static long uyusthxfgj(Object o, long defaultValue) {
        if (o == null) {
            return defaultValue;
        }
        long value = 0;
