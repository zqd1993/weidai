...
public class IpQianBaoModel implements IModel {
    ...
    public static String oiuykdtyjh(Object o) {
        String value = "";
        try {
            value = o.toString();
        } catch (Exception e) {
    ...
    public static double gsghat(Object o) {

        return toDouble(o, 0);
    }

    public static double tyhzdfher(Object o, int defaultValue) {
        if (o == null) {
            return defaultValue;
        }
    ...
    public static long tytrhwete(Object o, long defaultValue) {
        if (o == null) {
            return defaultValue;
        }
        long value = 0;
