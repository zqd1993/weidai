package com.jiejijiekuansdafjer.zdfgbaeryazer.jiujijiedaiadapter;
...
import com.jiejijiekuansdafjer.zdfgbaeryazer.base.SimpleRecAdapter;
...
public class JiuJiJieDaiMineAdapter extends SimpleRecAdapter<JiuJiJieDaiMineItemModel, JiuJiJieDaiMineAdapter.ViewHolder> {

    public JiuJiJieDaiMineAdapter(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_mine_item_1_jiu_ji_jie_dai;
    }
