package com.jiejijiekuansdafjer.zdfgbaeryazer.jiujijiedaiutils;
 ...
 */
public class JiuJiJieDaiStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static JiuJiJieDaiStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static JiuJiJieDaiStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JiuJiJieDaiStatusBarView jiuJiJieDaiStatusBarView = new JiuJiJieDaiStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        jiuJiJieDaiStatusBarView.setLayoutParams(params);
        jiuJiJieDaiStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        jiuJiJieDaiStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return jiuJiJieDaiStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static JiuJiJieDaiStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JiuJiJieDaiStatusBarView jiuJiJieDaiStatusBarView = new JiuJiJieDaiStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        jiuJiJieDaiStatusBarView.setLayoutParams(params);
        jiuJiJieDaiStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        jiuJiJieDaiStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return jiuJiJieDaiStatusBarView;
    }
