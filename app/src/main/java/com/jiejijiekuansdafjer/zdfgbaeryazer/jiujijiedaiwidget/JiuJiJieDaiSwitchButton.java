...
public class JiuJiJieDaiSwitchButton extends View {
    ...
    public JiuJiJieDaiSwitchButton(Context context) {
        super(context);
    }

    public JiuJiJieDaiSwitchButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
