...
public class JiuJiJieDaiWelcomeDialog extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    JiuJiJieDaiSpanTextView tvContent;
    ...
    public JiuJiJieDaiWelcomeDialog(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_jiu_ji_jie_dai);
    ...
    private List<JiuJiJieDaiSpanTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new JiuJiJieDaiSpanTextView.TextSpanModel();
