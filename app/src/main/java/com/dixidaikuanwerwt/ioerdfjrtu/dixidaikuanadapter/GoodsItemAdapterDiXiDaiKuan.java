...
public class GoodsItemAdapterDiXiDaiKuan extends SimpleRecAdapter<GoodsModelDiXiDaiKuan, GoodsItemAdapterDiXiDaiKuan.ViewHolder> {

    public GoodsItemAdapterDiXiDaiKuan(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_di_xi_dai_kuan_goods_item;
    }

    @Override
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        GoodsModelDiXiDaiKuan model = data.get(i);
        ...
        if (!TextUtils.isEmpty(SharedDiXiDaiKuanPreferencesUtilis.getStringFromPref("API_BASE_URL"))) {
            Glide.with(context).load(SharedDiXiDaiKuanPreferencesUtilis.getStringFromPref("API_BASE_URL") + model.getImgs()).into(viewHolder.productImg);
        }
