 ...
 */
public class DiXiDaiKuanStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewDiXiDaiKuan createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewDiXiDaiKuan createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewDiXiDaiKuan statusBarViewDiXiDaiKuan = new StatusBarViewDiXiDaiKuan(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewDiXiDaiKuan.setLayoutParams(params);
        statusBarViewDiXiDaiKuan.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewDiXiDaiKuan.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewDiXiDaiKuan;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewDiXiDaiKuan createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewDiXiDaiKuan statusBarViewDiXiDaiKuan = new StatusBarViewDiXiDaiKuan(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewDiXiDaiKuan.setLayoutParams(params);
        statusBarViewDiXiDaiKuan.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewDiXiDaiKuan.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewDiXiDaiKuan;
    }
