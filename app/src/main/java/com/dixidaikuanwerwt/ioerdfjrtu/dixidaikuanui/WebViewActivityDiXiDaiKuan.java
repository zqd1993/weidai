...
import com.dixidaikuanwerwt.ioerdfjrtu.dixidaikuanutils.DiXiDaiKuanDownloadUtil;
...
public class WebViewActivityDiXiDaiKuan extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if (tag == 1) {
            ...
            DiXiDaiKuanStatusBarUtil.setDarkMode(this);
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_di_xi_dai_kuan;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewActivityDiXiDaiKuan.this);
        ...
        DiXiDaiKuanDownloadUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DiXiDaiKuanDownloadUtil.OnDownloadListener() {
            @Override
