...
public class SwitchDiXiDaiKuanButton extends View {
    ...
    public SwitchDiXiDaiKuanButton(Context context) {
        super(context);
    }

    public SwitchDiXiDaiKuanButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
