...
public class WelcomeDialogDiXiDaiKuan extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    DiXiDaiKuanSpanTextView tvContent;
    ...
    public WelcomeDialogDiXiDaiKuan(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_di_xi_dai_kuan_welcome);
    ...
    private List<DiXiDaiKuanSpanTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new DiXiDaiKuanSpanTextView.TextSpanModel();
