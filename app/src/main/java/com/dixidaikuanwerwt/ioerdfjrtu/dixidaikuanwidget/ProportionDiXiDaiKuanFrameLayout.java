...
public class ProportionDiXiDaiKuanFrameLayout extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public ProportionDiXiDaiKuanFrameLayout(@NonNull Context context) {
        super(context);
    }

    public ProportionDiXiDaiKuanFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public ProportionDiXiDaiKuanFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
