...
public class DiXiDaiKuanSpanTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<BaseSpanModel> spanModels;
    private SpanClickListener listener;

    public DiXiDaiKuanSpanTextView(Context context) {
        super(context);
    }

    public DiXiDaiKuanSpanTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public DiXiDaiKuanSpanTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
