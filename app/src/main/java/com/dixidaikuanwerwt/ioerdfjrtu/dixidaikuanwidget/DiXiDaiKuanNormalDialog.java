...
public class DiXiDaiKuanNormalDialog extends Dialog {
    ...
    public DiXiDaiKuanNormalDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_di_xi_dai_kuan_normal);
    ...
    public DiXiDaiKuanNormalDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public DiXiDaiKuanNormalDialog hideLeftBtn() {
        hideLeftBtn = true;
        return this;
    }

    public DiXiDaiKuanNormalDialog setTitle(String title) {
        this.title = title;
        return this;
    }

    public DiXiDaiKuanNormalDialog setImg(int imgRes) {
        this.imgRes = imgRes;
        return this;
    }


    public DiXiDaiKuanNormalDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public DiXiDaiKuanNormalDialog setLeftListener(View.OnClickListener listener) {
        this.leftListener = listener;
        return this;
    }

    public DiXiDaiKuanNormalDialog setRightListener(View.OnClickListener listener) {
        this.rightListener = listener;
        return this;
    }

    public DiXiDaiKuanNormalDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
//        this.tvCancel.setText(tvCancel);
        return this;
    }

    public DiXiDaiKuanNormalDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
