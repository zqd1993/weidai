...
import com.zhouzhuanzijianrdgfg.haerawyry.zhouzhuanzijinutils.ZhouZhuanZiJinDownloadUtil;
...
public class ZhouZhuanZiJinWebViewActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
...
//        header_layout.setVisibility(View.GONE);
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_zhou_zhuan_zi_jin;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(ZhouZhuanZiJinWebViewActivity.this);
        ...
        ZhouZhuanZiJinDownloadUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new ZhouZhuanZiJinDownloadUtil.OnDownloadListener() {
            @Override
