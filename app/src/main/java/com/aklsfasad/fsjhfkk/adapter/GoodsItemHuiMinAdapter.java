...
public class GoodsItemHuiMinAdapter extends SimpleRecAdapter<GoodsHuiMinModel, GoodsItemHuiMinAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        if (!TextUtils.isEmpty(SharedPreferencesUtilisHuiMin.getStringFromPref("API_BASE_URL"))) {
            ILFactory.getLoader().loadNet(viewHolder.productImg, SharedPreferencesUtilisHuiMin.getStringFromPref("API_BASE_URL") + model.getProductLogo(), new ILoader.Options(R.mipmap.app_logo, R.mipmap.app_logo));
        }
