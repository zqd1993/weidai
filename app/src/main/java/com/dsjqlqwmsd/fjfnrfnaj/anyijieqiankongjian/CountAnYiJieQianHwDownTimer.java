package com.dsjqlqwmsd.fjfnrfnaj.anyijieqiankongjian;

import android.content.Context;
import android.content.res.Resources;
import android.widget.TextView;

import com.dsjqlqwmsd.fjfnrfnaj.WAnYiJieQianHwApp;
import com.dsjqlqwmsd.fjfnrfnaj.R;

import java.util.Date;


public class CountAnYiJieQianHwDownTimer extends android.os.CountDownTimer {
    ...
    public CountAnYiJieQianHwDownTimer(TextView textView, long millisInFuture, long countDownInterval) {
    ...
    public void onTick(long last) {
        ...
        timeTv.setTextColor(WAnYiJieQianHwApp.getContext().getResources().getColor(R.color.color_bdbdc5)); //设置按钮为灰色，这时是不能点击的
    }
    ...
    public void onFinish() {
        ...
        timeTv.setTextColor(WAnYiJieQianHwApp.getContext().getResources().getColor(R.color.white));  //还原背景色
