...
public class StartPageAnYiJieQianHwRemindDialog extends Dialog {

    @BindView(R.id.two_btn)
    TextView twoBtn;
    @BindView(R.id.tv_txt)
    ClickAnYiJieQianHwTextView tvTxt;
    @BindView(R.id.one_btn)
    TextView oneBtn;

    private OnListener onListener;

    public StartPageAnYiJieQianHwRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.an_yi_jie_qian_dialog_start_page);
        ...
        tvTxt.setText(OpenAnYiJieQianHwUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
