...
public class MainAnYiJieQianHwActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        tabModel.setIcon(R.drawable.xfhnrtu);
        tabModel.setSelectedIcon(R.drawable.vbndrtysey);
        tabModel.setName("首页");
        tabModel.setChecked(true);
        TabModel tabModel1 = new TabModel();
        tabModel1.setIcon(R.drawable.xfhnrtu);
        tabModel1.setSelectedIcon(R.drawable.vbndrtysey);
        tabModel1.setName("精选");
        tabModel1.setChecked(false);
        TabModel tabModel2 = new TabModel();
        tabModel2.setIcon(R.drawable.qrewrzdhg);
        tabModel2.setSelectedIcon(R.drawable.xdfhrty);
