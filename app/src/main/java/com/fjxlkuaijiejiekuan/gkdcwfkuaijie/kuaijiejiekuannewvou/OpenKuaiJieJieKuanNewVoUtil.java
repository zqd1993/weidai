...
import com.fjxlkuaijiejiekuan.gkdcwfkuaijie.router.Router;
...
public class OpenKuaiJieJieKuanNewVoUtil {
    ...
    public static void getValue(XActivity activity, Class<?> to, Bundle bundle) {
        HttpKuaiJieJieKuanNewVoApi.getInterfaceUtils().getValue("VIDEOTAPE")
                    ...
                    public void onNext(BaseKuaiJieJieKuanNewVoModel<ConfigKuaiJieJieKuanNewVoEntity> configEntity) {
                        if (configEntity != null) {
                            if (configEntity.getData() != null) {
                                PreferencesOpenUtilKuaiJieJieKuanNewVo.saveBool("NO_RECORD", !configEntity.getData().getVideoTape().equals("0"));
    ...
    public static List<ClickTextViewKuaiJieJieKuanNewVo.SpanModel> createSpanTexts() {
        List<ClickTextViewKuaiJieJieKuanNewVo.SpanModel> spanModels = new ArrayList<>();
        ClickTextViewKuaiJieJieKuanNewVo.ClickSpanModel spanModel = new ClickTextViewKuaiJieJieKuanNewVo.ClickSpanModel();
        ClickTextViewKuaiJieJieKuanNewVo.SpanModel textSpanModel = new ClickTextViewKuaiJieJieKuanNewVo.SpanModel();
        ...
        textSpanModel = new ClickTextViewKuaiJieJieKuanNewVo.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new ClickTextViewKuaiJieJieKuanNewVo.ClickSpanModel();
    ...
    public static List<ClickTextViewKuaiJieJieKuanNewVo.SpanModel> createDlSpanTexts() {
        List<ClickTextViewKuaiJieJieKuanNewVo.SpanModel> spanModels = new ArrayList<>();
        ClickTextViewKuaiJieJieKuanNewVo.ClickSpanModel spanModel = new ClickTextViewKuaiJieJieKuanNewVo.ClickSpanModel();
        ClickTextViewKuaiJieJieKuanNewVo.SpanModel textSpanModel = new ClickTextViewKuaiJieJieKuanNewVo.SpanModel();
