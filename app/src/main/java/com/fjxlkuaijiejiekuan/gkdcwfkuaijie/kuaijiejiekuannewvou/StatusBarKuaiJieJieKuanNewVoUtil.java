 ...
 */
public class StatusBarKuaiJieJieKuanNewVoUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarKuaiJieJieKuanNewVoView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarKuaiJieJieKuanNewVoView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarKuaiJieJieKuanNewVoView statusBarKuaiJieJieKuanNewVoViewHuiMin = new BarKuaiJieJieKuanNewVoView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarKuaiJieJieKuanNewVoViewHuiMin.setLayoutParams(params);
        statusBarKuaiJieJieKuanNewVoViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarKuaiJieJieKuanNewVoViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarKuaiJieJieKuanNewVoViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarKuaiJieJieKuanNewVoView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarKuaiJieJieKuanNewVoView statusBarKuaiJieJieKuanNewVoViewHuiMin = new BarKuaiJieJieKuanNewVoView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarKuaiJieJieKuanNewVoViewHuiMin.setLayoutParams(params);
        statusBarKuaiJieJieKuanNewVoViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarKuaiJieJieKuanNewVoViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarKuaiJieJieKuanNewVoViewHuiMin;
    }
