...
public class ClickTextViewKuaiJieJieKuanNewVo extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewKuaiJieJieKuanNewVo(Context context) {
        super(context);
    }

    public ClickTextViewKuaiJieJieKuanNewVo(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewKuaiJieJieKuanNewVo(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
