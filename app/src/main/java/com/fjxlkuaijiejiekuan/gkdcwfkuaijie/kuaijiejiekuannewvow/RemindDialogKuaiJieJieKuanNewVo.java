...
public class RemindDialogKuaiJieJieKuanNewVo extends Dialog {
    ...
    public RemindDialogKuaiJieJieKuanNewVo(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_kuai_jie_jie_kuan_new_op_normal);
    ...
    public RemindDialogKuaiJieJieKuanNewVo showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindDialogKuaiJieJieKuanNewVo setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindDialogKuaiJieJieKuanNewVo setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindDialogKuaiJieJieKuanNewVo setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindDialogKuaiJieJieKuanNewVo setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
