...
public class ZhuXiaoKuaiJieJieKuanNewVoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuai_jie_jie_kuan_new_op_zhuxiao);
        ...
        commit_btn.setOnClickListener(v -> {
            dialog = new RemindDialogKuaiJieJieKuanNewVo(this).setCancelText("取消")
