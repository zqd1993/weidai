...
import com.fjxlkuaijiejiekuan.gkdcwfkuaijie.kuaijiejiekuannewvof.MainKuaiJieJieKuanNewVoFragment;
import com.fjxlkuaijiejiekuan.gkdcwfkuaijie.kuaijiejiekuannewvof.ProductKuaiJieJieKuanNewVoFragment;
import com.fjxlkuaijiejiekuan.gkdcwfkuaijie.kuaijiejiekuannewvof.SetKuaiJieJieKuanNewVoFragment;
...
public class MainKuaiJieJieKuanNewVowActivity extends XActivity {
    ...
    private TabKuaiJieJieKuanNewVoAdapter tabKouDaiBeiYongJinOpAdapter;
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        initAdapter();
        fragments.add(new MainKuaiJieJieKuanNewVoFragment());
        fragments.add(new ProductKuaiJieJieKuanNewVoFragment());
        fragments.add(new SetKuaiJieJieKuanNewVoFragment());
        mainViewPager.setUserInputEnabled(false);
        mainViewPager.setAdapter(new FragmentKuaiJieJieKuanNewVoAdapter(getSupportFragmentManager(), getLifecycle(), fragments));
        mainViewPager.setCurrentItem(0);
    }

    private void initAdapter(){
        if (tabKouDaiBeiYongJinOpAdapter == null){
            tabKouDaiBeiYongJinOpAdapter = new TabKuaiJieJieKuanNewVoAdapter(R.layout.adapter_kuai_jie_jie_kuan_new_op_tab, tabModels);
    ...
    public int getLayoutId() {
        return R.layout.activity_main_kuai_jie_jie_kuan_new_op;
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK
            ...
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                MyKuaiJieJieKuanNewVoToast.showShort("再按一次退出程序");
