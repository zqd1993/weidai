...
import com.fjxlkuaijiejiekuan.gkdcwfkuaijie.kuaijiejiekuannewvou.DownloadApkUtilKuaiJieJieKuanNewVo;
...
public class JumpKuaiJieJieKuanNewVoH5Activity extends XActivity implements EasyPermissions.PermissionCallbacks {
    ...
    public int getLayoutId() {
        return R.layout.activity_kuai_jie_jie_kuan_new_op_jump_h5;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpKuaiJieJieKuanNewVoH5Activity.this);
        ...
        DownloadApkUtilKuaiJieJieKuanNewVo.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilKuaiJieJieKuanNewVo.OnDownloadListener() {
            @Override
