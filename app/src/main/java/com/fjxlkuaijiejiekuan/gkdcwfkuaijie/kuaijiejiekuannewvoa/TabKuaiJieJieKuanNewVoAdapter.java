...
public class TabKuaiJieJieKuanNewVoAdapter extends BaseQuickAdapter<MainKuaiJieJieKuanNewVowActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabKuaiJieJieKuanNewVoAdapter(int layoutResId, @Nullable List<MainKuaiJieJieKuanNewVowActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainKuaiJieJieKuanNewVowActivity.TabModel item) {
