 ...
 */
public class StatusBarTiQianHuaDaikuanHwUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarTiQianHuaDaikuanHwView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarTiQianHuaDaikuanHwView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarTiQianHuaDaikuanHwView statusBarTiQianHuaDaikuanHwViewHuiMin = new BarTiQianHuaDaikuanHwView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarTiQianHuaDaikuanHwViewHuiMin.setLayoutParams(params);
        statusBarTiQianHuaDaikuanHwViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarTiQianHuaDaikuanHwViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarTiQianHuaDaikuanHwViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarTiQianHuaDaikuanHwView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarTiQianHuaDaikuanHwView statusBarTiQianHuaDaikuanHwViewHuiMin = new BarTiQianHuaDaikuanHwView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarTiQianHuaDaikuanHwViewHuiMin.setLayoutParams(params);
        statusBarTiQianHuaDaikuanHwViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarTiQianHuaDaikuanHwViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarTiQianHuaDaikuanHwViewHuiMin;
    }
