...
public class OpenTiQianHuaDaikuanHwUtil {
    ...
    public static List<ClickTextViewTiQianHuaDaikuanHw.SpanModel> createSpanTexts() {
        List<ClickTextViewTiQianHuaDaikuanHw.SpanModel> spanModels = new ArrayList<>();
        ClickTextViewTiQianHuaDaikuanHw.ClickSpanModel spanModel = new ClickTextViewTiQianHuaDaikuanHw.ClickSpanModel();
        ClickTextViewTiQianHuaDaikuanHw.SpanModel textSpanModel = new ClickTextViewTiQianHuaDaikuanHw.SpanModel();
        ...
        textSpanModel = new ClickTextViewTiQianHuaDaikuanHw.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new ClickTextViewTiQianHuaDaikuanHw.ClickSpanModel();
