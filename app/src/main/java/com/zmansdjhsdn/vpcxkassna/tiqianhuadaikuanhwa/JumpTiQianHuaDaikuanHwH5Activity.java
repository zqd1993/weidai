...
public class JumpTiQianHuaDaikuanHwH5Activity extends XActivity implements EasyPermissions.PermissionCallbacks {
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(JumpTiQianHuaDaikuanHwH5Activity.this);
        ...
        DownloadApkUtilTiQianHuaDaikuanHw.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilTiQianHuaDaikuanHw.OnDownloadListener() {
            @Override
