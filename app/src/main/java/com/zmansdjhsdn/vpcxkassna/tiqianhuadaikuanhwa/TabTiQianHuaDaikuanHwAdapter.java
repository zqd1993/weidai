...
public class TabTiQianHuaDaikuanHwAdapter extends BaseQuickAdapter<MainTiQianHuaDaikuanHwActivity.TabModel, BaseViewHolder> {
    ...
    public TabTiQianHuaDaikuanHwAdapter(int layoutResId, @Nullable List<MainTiQianHuaDaikuanHwActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainTiQianHuaDaikuanHwActivity.TabModel item) {
