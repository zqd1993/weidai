...
public class ImageAdapterTiQianHuaDaikuanHw extends BannerAdapter<ProductModelTiQianHuaDaikuanHw, ImageAdapterTiQianHuaDaikuanHw.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public ImageAdapterTiQianHuaDaikuanHw(List<ProductModelTiQianHuaDaikuanHw> datas) {
        super(datas);
    }

    @Override
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_banner_item_ti_qian_hua_dai_kuan_hw, parent, false);
        return new ImageAdapterTiQianHuaDaikuanHw.ImageHolder(view);
    }

    @Override
    public void onBindView(ImageHolder holder, ProductModelTiQianHuaDaikuanHw data, int position, int size) {
        ...
        ILFactory.getLoader().loadNet(holder.product_img, HttpTiQianHuaDaikuanHwApi.HTTP_API_URL + data.getProductLogo(),
    ...
    public interface BannerClickedListener{
        void onBannerClicked(ProductModelTiQianHuaDaikuanHw entity);
    }
