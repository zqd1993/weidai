...
public class SetItemAdapterTiQianHuaDaikuanHw extends BaseQuickAdapter<SetTiQianHuaDaikuanHwModel, BaseViewHolder> {
    ...
    public SetItemAdapterTiQianHuaDaikuanHw(int layoutResId, @Nullable List<SetTiQianHuaDaikuanHwModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, SetTiQianHuaDaikuanHwModel item) {
