...
public class NormalYouXinDialog extends Dialog {
    ...
    public NormalYouXinDialog(@NonNull Context context) {
    ...
    public NormalYouXinDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public NormalYouXinDialog setTitle(String title) {
        this.title = title;
        return this;
    }

    public NormalYouXinDialog setImg(int imgRes) {
        this.imgRes = imgRes;
        return this;
    }


    public NormalYouXinDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public NormalYouXinDialog setLeftListener(View.OnClickListener listener) {
        this.leftListener = listener;
        return this;
    }

    public NormalYouXinDialog setRightListener(View.OnClickListener listener) {
        this.rightListener = listener;
        return this;
    }

    public NormalYouXinDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public NormalYouXinDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
