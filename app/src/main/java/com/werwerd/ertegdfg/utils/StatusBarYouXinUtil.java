 ...
 */
public class StatusBarYouXinUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarYouXinView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarYouXinView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarYouXinView statusBarYouXinView = new StatusBarYouXinView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarYouXinView.setLayoutParams(params);
        statusBarYouXinView.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarYouXinView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarYouXinView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarYouXinView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarYouXinView statusBarYouXinView = new StatusBarYouXinView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarYouXinView.setLayoutParams(params);
        statusBarYouXinView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarYouXinView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarYouXinView;
    }
