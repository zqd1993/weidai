...
public class WelcomeZhouZhuanXinYongKaDialog extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanTextViewZhouZhuanXinYongKa tvContent;
    ...
    public WelcomeZhouZhuanXinYongKaDialog(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_zhou_zhuan_xin_yong_ka_welcome);
    ...
    private List<SpanTextViewZhouZhuanXinYongKa.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanTextViewZhouZhuanXinYongKa.TextSpanModel();
