...
public class SwitchZhouZhuanXinYongKaButton extends View {
    ...
    public SwitchZhouZhuanXinYongKaButton(Context context) {
        super(context);
    }

    public SwitchZhouZhuanXinYongKaButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
