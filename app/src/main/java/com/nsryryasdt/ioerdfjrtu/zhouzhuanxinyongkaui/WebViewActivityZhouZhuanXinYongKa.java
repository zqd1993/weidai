...
import com.nsryryasdt.ioerdfjrtu.zhouzhuanxinyongkautils.ZhouZhuanXinYongKaDownloadUtil;
...
public class WebViewActivityZhouZhuanXinYongKa extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        if (tag == 1) {
            ...
            StatusBarUtilZhouZhuanXinYongKa.setDarkMode(this);
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                Log.d("WebViewActivityZhouZhuanXinYongKa", "url = " + url + "--> userAgent" + userAgent + " ---> contentDisposition = " + contentDisposition + "-->mimetype = " + mimetype + "-->contentLength = " + contentLength);
                apkUrl = url;
                checkPermission();
            }
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_zhou_zhuan_xin_yong_ka_web_view;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewActivityZhouZhuanXinYongKa.this);
        ...
        ZhouZhuanXinYongKaDownloadUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new ZhouZhuanXinYongKaDownloadUtil.OnDownloadListener() {
            @Override
