 ...
 */
public class StatusBarUtilZhouZhuanXinYongKa {
     ...
     * @return 状态栏矩形条
     */
    private static ZhouZhuanXinYongKaStatusBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static ZhouZhuanXinYongKaStatusBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        ZhouZhuanXinYongKaStatusBarView zhouZhuanXinYongKaStatusBarView = new ZhouZhuanXinYongKaStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        zhouZhuanXinYongKaStatusBarView.setLayoutParams(params);
        zhouZhuanXinYongKaStatusBarView.setBackgroundColor(calculateStatusColor(color, alpha));
        zhouZhuanXinYongKaStatusBarView.setId(FAKE_STATUS_BAR_VIEW_ID);
        return zhouZhuanXinYongKaStatusBarView;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static ZhouZhuanXinYongKaStatusBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        ZhouZhuanXinYongKaStatusBarView zhouZhuanXinYongKaStatusBarView = new ZhouZhuanXinYongKaStatusBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        zhouZhuanXinYongKaStatusBarView.setLayoutParams(params);
        zhouZhuanXinYongKaStatusBarView.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        zhouZhuanXinYongKaStatusBarView.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return zhouZhuanXinYongKaStatusBarView;
    }
