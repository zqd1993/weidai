...
public class FeedBackActivityJieKuanZhiJia extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        commitBtn.setOnClickListener(v -> {
            if (TextUtils.isEmpty(feedbackEt.getText().toString().trim())){
                JieKuanZhiJiaToastUtil.showShort("请输入提交内容");
                return;
            }
            rotateLoading.start();
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    rotateLoading.stop();
                    JieKuanZhiJiaToastUtil.showShort("提交成功");
                    finish();
                }
            }, 2000);
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_feedback_jie_kuan_zhi_jia;
    }
