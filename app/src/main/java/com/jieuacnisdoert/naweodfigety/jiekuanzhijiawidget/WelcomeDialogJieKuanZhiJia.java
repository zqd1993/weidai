...
public class WelcomeDialogJieKuanZhiJia extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    JieKuanZhiJiaSpanTextView tvContent;
    ...
    public WelcomeDialogJieKuanZhiJia(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_jie_kuan_zhi_jia);
    ...
    private List<JieKuanZhiJiaSpanTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new JieKuanZhiJiaSpanTextView.TextSpanModel();
