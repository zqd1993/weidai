...
public class JieKuanZhiJiaSwitchButton extends View {
    ...
    public JieKuanZhiJiaSwitchButton(Context context) {
        super(context);
    }

    public JieKuanZhiJiaSwitchButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
