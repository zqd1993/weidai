...
public class JieKuanZhiJiaDaiProportionFrameLayout extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public JieKuanZhiJiaDaiProportionFrameLayout(@NonNull Context context) {
        super(context);
    }

    public JieKuanZhiJiaDaiProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public JieKuanZhiJiaDaiProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
