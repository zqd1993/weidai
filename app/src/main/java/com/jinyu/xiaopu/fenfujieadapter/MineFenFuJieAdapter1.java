...
public class MineFenFuJieAdapter1 extends SimpleRecAdapter<FenFuJieMineItemModel, MineFenFuJieAdapter1.ViewHolder> {

    public MineFenFuJieAdapter1(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_mine_item_1_fen_fu_jie;
    }
