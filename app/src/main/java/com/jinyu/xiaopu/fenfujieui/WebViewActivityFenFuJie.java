...
import com.jinyu.xiaopu.fenfujieutils.DownloadFenFuJieApkUtil;
...
public class WebViewActivityFenFuJie extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_fen_fu_jie_web_view;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewActivityFenFuJie.this);
        ...
        DownloadFenFuJieApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadFenFuJieApkUtil.OnDownloadListener() {
            @Override
