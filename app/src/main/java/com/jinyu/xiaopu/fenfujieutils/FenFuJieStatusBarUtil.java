 ...
 */
public class FenFuJieStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewFenFuJie createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewFenFuJie createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewFenFuJie statusBarViewFenFuJie = new StatusBarViewFenFuJie(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewFenFuJie.setLayoutParams(params);
        statusBarViewFenFuJie.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewFenFuJie.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewFenFuJie;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewFenFuJie createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewFenFuJie statusBarViewFenFuJie = new StatusBarViewFenFuJie(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewFenFuJie.setLayoutParams(params);
        statusBarViewFenFuJie.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewFenFuJie.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewFenFuJie;
    }
