...
public class WelcomeFenFuJieDialog extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    FenFuJieSpanTextView tvContent;
    ...
    public WelcomeFenFuJieDialog(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_fen_fu_jie);
    ...
    private List<FenFuJieSpanTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new FenFuJieSpanTextView.TextSpanModel();
