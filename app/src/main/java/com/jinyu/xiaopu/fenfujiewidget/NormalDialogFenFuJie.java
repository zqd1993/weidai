...
public class NormalDialogFenFuJie extends Dialog {
    ...
    public NormalDialogFenFuJie(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_fen_fu_jie_normal);
    ...
    public NormalDialogFenFuJie showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public NormalDialogFenFuJie hideLeftBtn() {
        hideLeftBtn = true;
        return this;
    }

    public NormalDialogFenFuJie setTitle(String title) {
        this.title = title;
        return this;
    }

    public NormalDialogFenFuJie setImg(int imgRes) {
        this.imgRes = imgRes;
        return this;
    }


    public NormalDialogFenFuJie setContent(String content) {
        this.content = content;
        return this;
    }

    public NormalDialogFenFuJie setLeftListener(View.OnClickListener listener) {
        this.leftListener = listener;
        return this;
    }

    public NormalDialogFenFuJie setRightListener(View.OnClickListener listener) {
        this.rightListener = listener;
        return this;
    }

    public NormalDialogFenFuJie setCancelText(String tvCancel) {
        cancel = tvCancel;
//        this.tvCancel.setText(tvCancel);
        return this;
    }

    public NormalDialogFenFuJie setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
