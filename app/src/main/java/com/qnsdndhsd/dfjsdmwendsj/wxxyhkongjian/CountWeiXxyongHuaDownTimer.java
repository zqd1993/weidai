...
public class CountWeiXxyongHuaDownTimer extends android.os.CountDownTimer {
    ...
    public CountWeiXxyongHuaDownTimer(TextView textView, long millisInFuture, long countDownInterval) {
    ...
    public void onTick(long last) {
        ...
        timeTv.setTextColor(WeiXxyongHuaApp.getContext().getResources().getColor(R.color.color_bdbdc5)); //设置按钮为灰色，这时是不能点击的
    }
    ...
    public void onFinish() {
        ...
        timeTv.setTextColor(WeiXxyongHuaApp.getContext().getResources().getColor(R.color.white));  //还原背景色
