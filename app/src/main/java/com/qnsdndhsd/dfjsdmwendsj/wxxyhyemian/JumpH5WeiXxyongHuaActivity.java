...
import com.qnsdndhsd.dfjsdmwendsj.wxxyhgongju.DownloadApkUtilWeiXxyongHua;
...
public class JumpH5WeiXxyongHuaActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ...
        DownloadApkUtilWeiXxyongHua.get().download(url, setFilePath(), apkName[apkName.length - 1], new DownloadApkUtilWeiXxyongHua.OnDownloadListener() {
            @Override
