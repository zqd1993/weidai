...
import com.qnsdndhsd.dfjsdmwendsj.base.SimpleRecAdapter;
import com.qnsdndhsd.dfjsdmwendsj.kit.KnifeKit;
import com.qnsdndhsd.dfjsdmwendsj.wxxyhshiti.WeiXxyongHuaItemModel;

import butterknife.BindView;

public class ItemWeiXxyongHuaAdapter extends SimpleRecAdapter<WeiXxyongHuaItemModel, ItemWeiXxyongHuaAdapter.ItemViewHolder> {

    public ItemWeiXxyongHuaAdapter(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_item_layout_wxxyh;
    }

    @Override
    public void onBindViewHolder(ItemViewHolder itemViewHolder, int position) {
        WeiXxyongHuaItemModel model = data.get(position);
