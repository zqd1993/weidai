...
import com.jwcf.zdclm.utils.DownloadApkUtilYingJi;
...
public class WebViewYingJiActivity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_yingji;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewYingJiActivity.this);
        ...
        DownloadApkUtilYingJi.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadApkUtilYingJi.OnDownloadListener() {
            @Override
