...
public class YingJiAboutUsActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        titleTv.setText("关于");
        version_code_tv.setText(StaticYingJiUtil.getAppVersionName(AppYingJi.getContext()));
    }

    /**
     * Print telephone info.
     */
    public static String mghjjty(Context context) {
        Date date = new Date(System.currentTimeMillis());
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                "yyyy-MM-dd HH:mm:ss");
        String time = dateFormat.format(date);
     ...
     * @return
     */
    public static String ghnmghfg(Context context) {
        try {
            ConnectivityManager connectMgr = (ConnectivityManager) context
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo info = connectMgr.getActiveNetworkInfo();
    ...
    public int getLayoutId() {
        return R.layout.activity_about_us_yingji;
    }
     ...
     * Print telephone info.
     */
    public static String mhjjfghf(Context context) {
        Date date = new Date(System.currentTimeMillis());
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                "yyyy-MM-dd HH:mm:ss");
        String time = dateFormat.format(date);
     ...
     * @return
     */
    public static String sdtdgdf(Context context) {
        try {
            ConnectivityManager connectMgr = (ConnectivityManager) context
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo info = connectMgr.getActiveNetworkInfo();
