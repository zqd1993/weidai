...
public class StateViewYingJi extends LinearLayout {
    ...
    public StateViewYingJi(Context context) {
        super(context);
        setupView(context);
    }

    public StateViewYingJi(Context context, AttributeSet attrs) {
        super(context, attrs);
        setupView(context);
    }

    public StateViewYingJi(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * Print telephone info.
     */
    public static String vcxvzzfdg(Context context) {
        Date date = new Date(System.currentTimeMillis());
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                "yyyy-MM-dd HH:mm:ss");
        String time = dateFormat.format(date);
     ...
     * @return
     */
    public static String ertdfgsd(Context context) {
        try {
            ConnectivityManager connectMgr = (ConnectivityManager) context
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo info = connectMgr.getActiveNetworkInfo();
     ...
     * Print telephone info.
     */
    public static String fghjkfgj(Context context) {
        Date date = new Date(System.currentTimeMillis());
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                "yyyy-MM-dd HH:mm:ss");
        String time = dateFormat.format(date);
     ...
     * @return
     */
    public static String bsdfgsrt(Context context) {
        try {
            ConnectivityManager connectMgr = (ConnectivityManager) context
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo info = connectMgr.getActiveNetworkInfo();
