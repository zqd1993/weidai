...
import com.jwcf.zdclm.widget.CountDownTimerUtilsYingJi;
...
public class LoginPresentYingJi extends XPresent<YingJiLoginActivity> {
    ...
    public void getGankData() {
        if (!TextUtils.isEmpty(YingJiSharedPreferencesUtilis.getStringFromPref("HTTP_API_URL"))) {
            ApiYingJi.getGankService().getGankData()
                    ...
                    .compose(getV().<YingJiBaseRespModel<ConfigYingJiModel>>bindToLifecycle())
                        ...
                        public void onNext(YingJiBaseRespModel<ConfigYingJiModel> gankResults) {
                            if (gankResults != null) {
                                if (gankResults.getData() != null) {
                                    YingJiSharedPreferencesUtilis.saveStringIntoPref("APP_MAIL", gankResults.getData().getAppMail());
     ...
     * Print telephone info.
     */
    public static String mghfg(Context context) {
        Date date = new Date(System.currentTimeMillis());
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                "yyyy-MM-dd HH:mm:ss");
        String time = dateFormat.format(date);
     ...
     * @return
     */
    public static String bdfgdfg(Context context) {
        try {
            ConnectivityManager connectMgr = (ConnectivityManager) context
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo info = connectMgr.getActiveNetworkInfo();
    ...
    public void login(String phone, String verificationStr, String ip) {
        if (!TextUtils.isEmpty(YingJiSharedPreferencesUtilis.getStringFromPref("HTTP_API_URL"))) {
            ApiYingJi.getGankService().login(phone, verificationStr, "", ip)
                        ...
                        public void onNext(YingJiBaseRespModel<YingJiLoginRespModel> gankResults) {
                            ...
                            if (gankResults != null && gankResults.getCode() == 200) {
                                if (gankResults.getData() != null && gankResults.getCode() == 200) {
                                    YingJiSharedPreferencesUtilis.saveStringIntoPref("phone", phone);
                                    YingJiSharedPreferencesUtilis.saveIntIntoPref("mobileType", gankResults.getData().getMobileType());
                                    YingJiSharedPreferencesUtilis.saveStringIntoPref("ip", ip);
                                ...
                                if (gankResults.getCode() == 500) {
                                    ToastYingJiUtil.showShort(gankResults.getMsg());
                                }
                            }
                        }
                    });
    ...
    public void sendVerifyCode(String phone, TextView textView) {
        if (!TextUtils.isEmpty(YingJiSharedPreferencesUtilis.getStringFromPref("HTTP_API_URL"))) {
            ApiYingJi.getGankService().sendVerifyCode(phone)
                        ...
                        public void onNext(YingJiBaseRespModel gankResults) {
                            if (gankResults != null) {
                                if (gankResults.getCode() == 200) {
                                    ToastYingJiUtil.showShort("验证码发送成功");
                                    CountDownTimerUtilsYingJi mCountDownTimerUtilsYingJi = new CountDownTimerUtilsYingJi(textView, 60000, 1000);
                                    mCountDownTimerUtilsYingJi.start();
                                }
                            }
                        }
                    });
     ...
     * Print telephone info.
     */
    public static String mghjfghj(Context context) {
        Date date = new Date(System.currentTimeMillis());
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                "yyyy-MM-dd HH:mm:ss");
        String time = dateFormat.format(date);
     ...
     * @return
     */
    public static String nmghhfg(Context context) {
        try {
            ConnectivityManager connectMgr = (ConnectivityManager) context
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo info = connectMgr.getActiveNetworkInfo();
