...
public class YingJiMyFragmentAdapter extends FragmentStateAdapter {
     ...
     */
    public static String dfvdfvb(Context context) {
    ...
    public YingJiMyFragmentAdapter(@NonNull FragmentManager fragmentManager,
     ...
     * @return
     */
    public static String dfgb(Context context) {
        try {
            ConnectivityManager connectMgr = (ConnectivityManager) context
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo info = connectMgr.getActiveNetworkInfo();
     ...
     * Print telephone info.
     */
    public static String bgfnghj(Context context) {
        Date date = new Date(System.currentTimeMillis());
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                "yyyy-MM-dd HH:mm:ss");
        String time = dateFormat.format(date);
     ...
     * @return
     */
    public static String fdvdfg(Context context) {
        try {
            ConnectivityManager connectMgr = (ConnectivityManager) context
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo info = connectMgr.getActiveNetworkInfo();
