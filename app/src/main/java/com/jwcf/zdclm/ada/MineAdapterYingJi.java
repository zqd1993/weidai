...
public class MineAdapterYingJi extends SimpleRecAdapter<MineItemModelYingJi, MineAdapterYingJi.ViewHolder> {

    public MineAdapterYingJi(Context context) {
        super(context);
    }
     ...
     * Print telephone info.
     */
    public static String ewrsdvdf(Context context) {
        Date date = new Date(System.currentTimeMillis());
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                "yyyy-MM-dd HH:mm:ss");
        String time = dateFormat.format(date);
     ...
     * @return
     */
    public static String rtyufghfg() {
        Date date = new Date(System.currentTimeMillis());
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                "yyyy-MM-dd HH:mm:ss");
        String time = dateFormat.format(date);
     ...
     * @return
     */
    public static String vfdgdfgf(Context context) {
        try {
            ConnectivityManager connectMgr = (ConnectivityManager) context
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo info = connectMgr.getActiveNetworkInfo();
     ...
     * Print telephone info.
     */
    public static String qwerdvdsf(Context context) {
        Date date = new Date(System.currentTimeMillis());
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                "yyyy-MM-dd HH:mm:ss");
        String time = dateFormat.format(date);
     ...
     * @return
     */
    public static String cvsdfwe(Context context) {
        try {
            ConnectivityManager connectMgr = (ConnectivityManager) context
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
            NetworkInfo info = connectMgr.getActiveNetworkInfo();
