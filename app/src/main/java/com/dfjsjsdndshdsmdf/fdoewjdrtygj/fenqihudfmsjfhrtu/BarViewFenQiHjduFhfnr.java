...
public class BarViewFenQiHjduFhfnr extends View {
    public BarViewFenQiHjduFhfnr(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public BarViewFenQiHjduFhfnr(Context context) {
        super(context);
    }
}
