...
public class DownloadFenQiHjduFhfnrApkUtil {
    private static DownloadFenQiHjduFhfnrApkUtil downloadFenQiHjduFhfnrApkUtil;
    private final OkHttpClient client;

    public static DownloadFenQiHjduFhfnrApkUtil get() {
        if (downloadFenQiHjduFhfnrApkUtil == null) {
            downloadFenQiHjduFhfnrApkUtil = new DownloadFenQiHjduFhfnrApkUtil();
        }
        return downloadFenQiHjduFhfnrApkUtil;
    }
    ...
    private DownloadFenQiHjduFhfnrApkUtil() {
