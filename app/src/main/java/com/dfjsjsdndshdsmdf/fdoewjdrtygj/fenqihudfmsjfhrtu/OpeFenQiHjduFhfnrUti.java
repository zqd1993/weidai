...
import com.dfjsjsdndshdsmdf.fdoewjdrtygj.router.Router;
...
public class OpeFenQiHjduFhfnrUti {
    ...
    public static void getValue(XActivity activity, Class<?> to, Bundle bundle) {
            HttpFenQiHjduFhfnrApi.getInterfaceUtils().getValue("VIDEOTAPE")
                        ...
                        public void onNext(FenQiHjduFhfnrBaseModel<ConfigFenQiHjduFhfnrEntity> configEntity) {
                            if (configEntity != null) {
                                if (configEntity.getData() != null) {
                                    PreferencFenQiHjduFhfnrOpenUtil.saveBool("NO_RECORD", !configEntity.getData().getVideoTape().equals("0"));
    ...
    public static List<ClickTextViewFenQiHjduFhfnr.SpanModel> createSpanTexts() {
        List<ClickTextViewFenQiHjduFhfnr.SpanModel> spanModels = new ArrayList<>();
        ClickTextViewFenQiHjduFhfnr.ClickSpanModel spanModel = new ClickTextViewFenQiHjduFhfnr.ClickSpanModel();
        ClickTextViewFenQiHjduFhfnr.SpanModel textSpanModel = new ClickTextViewFenQiHjduFhfnr.SpanModel();
        ...
        textSpanModel = new ClickTextViewFenQiHjduFhfnr.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new ClickTextViewFenQiHjduFhfnr.ClickSpanModel();
    ...
    public static List<ClickTextViewFenQiHjduFhfnr.SpanModel> createDlSpanTexts() {
        List<ClickTextViewFenQiHjduFhfnr.SpanModel> spanModels = new ArrayList<>();
        ClickTextViewFenQiHjduFhfnr.ClickSpanModel spanModel = new ClickTextViewFenQiHjduFhfnr.ClickSpanModel();
        ClickTextViewFenQiHjduFhfnr.SpanModel textSpanModel = new ClickTextViewFenQiHjduFhfnr.SpanModel();
