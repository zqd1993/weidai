...
public class ImageFenQiHjduFhfnrAdapter extends BannerAdapter<ProductFenQiHjduFhfnrModel, ImageFenQiHjduFhfnrAdapter.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public ImageFenQiHjduFhfnrAdapter(List<ProductFenQiHjduFhfnrModel> datas) {
        super(datas);
    }

    @Override
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_fen_qas_han_jnfe_banner_item, parent, false);
        return new ImageFenQiHjduFhfnrAdapter.ImageHolder(view);
    }
    ...
    @Override
    public void onBindView(ImageHolder holder, ProductFenQiHjduFhfnrModel data, int position, int size) {
        ...
        ILFactory.getLoader().loadNet(holder.product_img, HttpFenQiHjduFhfnrApi.HTTP_API_URL + data.getProductLogo(),
    ...
    public interface BannerClickedListener {
        void onBannerClicked(ProductFenQiHjduFhfnrModel entity);
    }
