...
public class TabFenQiHjduFhfnrAdapter extends BaseQuickAdapter<MainFenQiHjduFhfnrActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabFenQiHjduFhfnrAdapter(int layoutResId, @Nullable List<MainFenQiHjduFhfnrActivity.TabModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainFenQiHjduFhfnrActivity.TabModel item) {
