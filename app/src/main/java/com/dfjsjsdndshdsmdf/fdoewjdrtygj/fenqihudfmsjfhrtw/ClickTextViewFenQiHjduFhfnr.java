...
public class ClickTextViewFenQiHjduFhfnr extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewFenQiHjduFhfnr(Context context) {
        super(context);
    }

    public ClickTextViewFenQiHjduFhfnr(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewFenQiHjduFhfnr(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private SpannableString getClickableSpan(int i, ClickSpanModel spanModel) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#337bff")), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
