...
public class ScrollYSwipeFenQiHjduFhfnrRefreshLayout extends SwipeRefreshLayout {
    ...
    public ScrollYSwipeFenQiHjduFhfnrRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
