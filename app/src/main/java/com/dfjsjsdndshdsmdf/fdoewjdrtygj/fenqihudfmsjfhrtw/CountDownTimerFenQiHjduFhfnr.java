...
public class CountDownTimerFenQiHjduFhfnr extends android.os.CountDownTimer {

    private TextView timeTv;

    public CountDownTimerFenQiHjduFhfnr(TextView textView, long millisInFuture, long countDownInterval) {
    ...
    public void onTick(long last) {
        ...
        timeTv.setTextColor(FenQiHjduFhfnrMainApp.getContext().getResources().getColor(R.color.text_normal_color)); //设置按钮为灰色，这时是不能点击的
    }
    ...
    public void onFinish() {
        ...
        timeTv.setTextColor(FenQiHjduFhfnrMainApp.getContext().getResources().getColor(R.color.white));  //还原背景色
