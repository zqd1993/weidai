...
public class StartPageFenQiHjduFhfnrRemindDialo extends Dialog {

    @BindView(R.id.two_btn)
    TextView twoBtn;
    @BindView(R.id.tv_txt)
    ClickTextViewFenQiHjduFhfnr tvTxt;
    @BindView(R.id.one_btn)
    TextView oneBtn;

    private OnListener onListener;

    public StartPageFenQiHjduFhfnrRemindDialo(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_start_page_fen_qas_han_jnfe);
        ...
        tvTxt.setText(OpeFenQiHjduFhfnrUti.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
