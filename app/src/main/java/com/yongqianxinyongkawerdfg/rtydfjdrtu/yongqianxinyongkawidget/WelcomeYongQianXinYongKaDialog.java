...
public class WelcomeYongQianXinYongKaDialog extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanTextViewYongQianXinYongKa tvContent;
    ...
    public WelcomeYongQianXinYongKaDialog(@NonNull Context context, String title) {
    ...
    private List<SpanTextViewYongQianXinYongKa.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanTextViewYongQianXinYongKa.TextSpanModel();
