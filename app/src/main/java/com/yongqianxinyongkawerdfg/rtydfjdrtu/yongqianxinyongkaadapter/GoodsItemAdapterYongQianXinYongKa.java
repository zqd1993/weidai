...
public class GoodsItemAdapterYongQianXinYongKa extends SimpleRecAdapter<YongQianXinYongKaGoodsModel, GoodsItemAdapterYongQianXinYongKa.ViewHolder> {

    public GoodsItemAdapterYongQianXinYongKa(Context context) {
        super(context);
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        YongQianXinYongKaGoodsModel model = data.get(i);
        viewHolder.productNameTv.setText(model.getTitle());
        Glide.with(context).load(YongQianXinYongKaApi.API_BASE_URL + model.getImgs()).into(viewHolder.productImg);
