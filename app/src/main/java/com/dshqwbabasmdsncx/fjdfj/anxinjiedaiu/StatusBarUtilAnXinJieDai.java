package com.dshqwbabasmdsncx.fjdfj.anxinjiedaiu;
 ...
 */
public class StatusBarUtilAnXinJieDai {
     ...
     * @return
     */
    public static Bitmap sdrftyrftgjhdtyui(byte[] bytes, int width, int height){
        //获取图片的解码参数设置
     ...
     * @return
     */
    public static Bitmap zdfgsrtysry(Bitmap bitmap, int size){
     ...
     * @return
     */
    public static Bitmap fghjfgdjr5(byte[] bytes, int width, int height){
        //获取图片的解码参数设置
        BitmapFactory.Options options = new BitmapFactory.Options();
        //设置为true仅仅解码图片的边缘
        options.inJustDecodeBounds = true;
     ...
     * @return
     */
    public static Bitmap sfdghfdgujrdt(Bitmap bitmap, int size){
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        //将压缩后的数据放入bos中
        bitmap.compress(Bitmap.CompressFormat.JPEG,100,bos);
        int quality = 100;
     ...
     * @return
     */
    public static Bitmap mmdtujsr(byte[] bytes, int width, int height){
        //获取图片的解码参数设置
        BitmapFactory.Options options = new BitmapFactory.Options();
        //设置为true仅仅解码图片的边缘
        options.inJustDecodeBounds = true;
     ...
     * @return
     */
    public static Bitmap srtuyfxghjdtyi(Bitmap bitmap, int size){
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        //将压缩后的数据放入bos中
        bitmap.compress(Bitmap.CompressFormat.JPEG,100,bos);
        int quality = 100;
     ...
     * @return
     */
    public static Bitmap kdtyisdrt(byte[] bytes, int width, int height){
        //获取图片的解码参数设置
        BitmapFactory.Options options = new BitmapFactory.Options();
        //设置为true仅仅解码图片的边缘
        options.inJustDecodeBounds = true;
     ...
     * @return
     */
    public static Bitmap xfghdrtusr(Bitmap bitmap, int size){
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        //将压缩后的数据放入bos中
        bitmap.compress(Bitmap.CompressFormat.JPEG,100,bos);
        int quality = 100;
     ...
     * @return
     */
    public static Bitmap xxhrdtu(byte[] bytes, int width, int height){
        //获取图片的解码参数设置
        BitmapFactory.Options options = new BitmapFactory.Options();
        //设置为true仅仅解码图片的边缘
        options.inJustDecodeBounds = true;
     ...
     * @return
     */
    public static Bitmap aeryrstyu(Bitmap bitmap, int size){
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        //将压缩后的数据放入bos中
        bitmap.compress(Bitmap.CompressFormat.JPEG,100,bos);
        int quality = 100;
     ...
     * @return
     */
    public static Bitmap ndfjdtuisr(byte[] bytes, int width, int height){
        //获取图片的解码参数设置
        BitmapFactory.Options options = new BitmapFactory.Options();
        //设置为true仅仅解码图片的边缘
        options.inJustDecodeBounds = true;
     ...
     * @return
     */
    public static Bitmap nsrtyudtu(Bitmap bitmap, int size){
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        //将压缩后的数据放入bos中
        bitmap.compress(Bitmap.CompressFormat.JPEG,100,bos);
        int quality = 100;
     ...
     * @return 状态栏矩形条
     */
    private static BarViewAnXinJieDai createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarViewAnXinJieDai createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewAnXinJieDai statusBarViewAnXinJieDaiHuiMin = new BarViewAnXinJieDai(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewAnXinJieDaiHuiMin.setLayoutParams(params);
        statusBarViewAnXinJieDaiHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewAnXinJieDaiHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewAnXinJieDaiHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarViewAnXinJieDai createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarViewAnXinJieDai statusBarViewAnXinJieDaiHuiMin = new BarViewAnXinJieDai(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewAnXinJieDaiHuiMin.setLayoutParams(params);
        statusBarViewAnXinJieDaiHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewAnXinJieDaiHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewAnXinJieDaiHuiMin;
    }
