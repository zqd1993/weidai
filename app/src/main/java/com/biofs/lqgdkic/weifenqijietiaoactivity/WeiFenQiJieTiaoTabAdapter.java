...
public class WeiFenQiJieTiaoTabAdapter extends BaseQuickAdapter<WeiFenQiJieTiaoMainActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public WeiFenQiJieTiaoTabAdapter(int layoutResId, @Nullable List<WeiFenQiJieTiaoMainActivity.TabModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, WeiFenQiJieTiaoMainActivity.TabModel item) {
