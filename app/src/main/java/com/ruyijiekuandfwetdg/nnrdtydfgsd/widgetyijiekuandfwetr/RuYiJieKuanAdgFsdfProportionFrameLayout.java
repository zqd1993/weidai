...
public class RuYiJieKuanAdgFsdfProportionFrameLayout extends FrameLayout {

    private float proporty = 1.333333f;

    private boolean isWidth = false;

    public RuYiJieKuanAdgFsdfProportionFrameLayout(@NonNull Context context) {
        super(context);
    }

    public RuYiJieKuanAdgFsdfProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public RuYiJieKuanAdgFsdfProportionFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
