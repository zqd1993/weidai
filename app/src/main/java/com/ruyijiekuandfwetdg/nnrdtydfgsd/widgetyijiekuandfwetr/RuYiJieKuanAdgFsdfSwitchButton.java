...
public class RuYiJieKuanAdgFsdfSwitchButton extends View {
    ...
    public RuYiJieKuanAdgFsdfSwitchButton(Context context) {
        super(context);
    }

    public RuYiJieKuanAdgFsdfSwitchButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
