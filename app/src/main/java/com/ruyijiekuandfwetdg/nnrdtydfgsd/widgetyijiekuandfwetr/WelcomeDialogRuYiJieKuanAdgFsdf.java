...
public class WelcomeDialogRuYiJieKuanAdgFsdf extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    RuYiJieKuanAdgFsdfSpanTextView tvContent;
    ...
    public WelcomeDialogRuYiJieKuanAdgFsdf(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_ru_yi_jie_kuan_dfs_wetg);
    ...
    private List<RuYiJieKuanAdgFsdfSpanTextView.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new RuYiJieKuanAdgFsdfSpanTextView.TextSpanModel();
