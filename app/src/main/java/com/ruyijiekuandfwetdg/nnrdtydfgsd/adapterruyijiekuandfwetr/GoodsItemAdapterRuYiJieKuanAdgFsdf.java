...
public class GoodsItemAdapterRuYiJieKuanAdgFsdf extends SimpleRecAdapter<RuYiJieKuanAdgFsdfGoodsModel, GoodsItemAdapterRuYiJieKuanAdgFsdf.ViewHolder> {

    public GoodsItemAdapterRuYiJieKuanAdgFsdf(Context context) {
        super(context);
    }
