...
public class RuYiJieKuanAdgFsdfMineAdapter extends SimpleRecAdapter<MineItemModelRuYiJieKuanAdgFsdf, RuYiJieKuanAdgFsdfMineAdapter.ViewHolder> {

    public RuYiJieKuanAdgFsdfMineAdapter(Context context) {
        super(context);
    }
    ...
    public int getLayoutId() {
        return R.layout.adapter_mine_item_ru_yi_jie_kuan_dfs_wetg;
    }
