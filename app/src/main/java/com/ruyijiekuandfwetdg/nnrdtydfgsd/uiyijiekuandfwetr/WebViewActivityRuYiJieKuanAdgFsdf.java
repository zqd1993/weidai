...
import com.ruyijiekuandfwetdg.nnrdtydfgsd.utilsyijiekuandfwetr.RuYiJieKuanAdgFsdfDownloadUtil;
...
public class WebViewActivityRuYiJieKuanAdgFsdf extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public int getLayoutId() {
        return R.layout.activity_web_view_ru_yi_jie_kuan_dfs_wetg;
    }
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(WebViewActivityRuYiJieKuanAdgFsdf.this);
        ...
        RuYiJieKuanAdgFsdfDownloadUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new RuYiJieKuanAdgFsdfDownloadUtil.OnDownloadListener() {
            @Override
