 ...
 */
public class RuYiJieKuanAdgFsdfStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewRuYiJieKuanAdgFsdf createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static StatusBarViewRuYiJieKuanAdgFsdf createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewRuYiJieKuanAdgFsdf statusBarViewRuYiJieKuanAdgFsdf = new StatusBarViewRuYiJieKuanAdgFsdf(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewRuYiJieKuanAdgFsdf.setLayoutParams(params);
        statusBarViewRuYiJieKuanAdgFsdf.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarViewRuYiJieKuanAdgFsdf.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarViewRuYiJieKuanAdgFsdf;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static StatusBarViewRuYiJieKuanAdgFsdf createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        StatusBarViewRuYiJieKuanAdgFsdf statusBarViewRuYiJieKuanAdgFsdf = new StatusBarViewRuYiJieKuanAdgFsdf(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarViewRuYiJieKuanAdgFsdf.setLayoutParams(params);
        statusBarViewRuYiJieKuanAdgFsdf.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarViewRuYiJieKuanAdgFsdf.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarViewRuYiJieKuanAdgFsdf;
    }
