...
public class ImageMeiJienFenSsdfQiAdapter extends BannerAdapter<ProductMeiJienFenSsdfQiModel, ImageMeiJienFenSsdfQiAdapter.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public ImageMeiJienFenSsdfQiAdapter(List<ProductMeiJienFenSsdfQiModel> datas) {
        super(datas);
    }
    ...
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_banner_item_mei_jie_fen_qi, parent, false);
        return new ImageMeiJienFenSsdfQiAdapter.ImageHolder(view);
    }

    @Override
    public void onBindView(ImageHolder holder, ProductMeiJienFenSsdfQiModel data, int position, int size) {
        ...
        holder.shuliang_tv.setText(String.valueOf(data.getPassingRate()));
            ILFactory.getLoader().loadNet(holder.goods_pic, HttpMeiJienFenSsdfQiApi.HTTP_API_URL + data.getProductLogo(),
    ...
    public interface BannerClickedListener{
        void onBannerClicked(ProductMeiJienFenSsdfQiModel entity);
    }
