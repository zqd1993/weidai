...
import com.meijiefenqifjsdkqwj.pfdioewjnsd.meijiefenqif.MainMeiJienFenSsdfQiFragment;
import com.meijiefenqifjsdkqwj.pfdioewjnsd.meijiefenqif.ProductFragmentMeiJienFenSsdfQi;
import com.meijiefenqifjsdkqwj.pfdioewjnsd.meijiefenqif.SetMeiJienFenSsdfQiFragment;
...
public class MeiJienFenSsdfQiMainActivity extends XActivity {
    ...
    private MeiJienFenSsdfQiTabAdapter meiJienFenSsdfQiTabAdapter;
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        tabModel.setIcon(R.drawable.mxdrtgfb);
        tabModel.setSelectedIcon(R.drawable.jgfhsty);
        tabModel.setName("首页");
        tabModel.setChecked(true);
        TabModel tabModel1 = new TabModel();
        tabModel1.setIcon(R.drawable.lhxfbcvb);
        tabModel1.setSelectedIcon(R.drawable.grghxgfh);
        tabModel1.setName("精选");
        tabModel1.setChecked(false);
        TabModel tabModel2 = new TabModel();
        tabModel2.setIcon(R.drawable.bdfzgrth);
        tabModel2.setSelectedIcon(R.drawable.zcvdftrt);
        ...
        initAdapter();
        fragments.add(new MainMeiJienFenSsdfQiFragment());
        fragments.add(new ProductFragmentMeiJienFenSsdfQi());
        fragments.add(new SetMeiJienFenSsdfQiFragment());
        mainViewPager.setUserInputEnabled(false);
        mainViewPager.setAdapter(new MeiJienFenSsdfQiFragmentAdapter(getSupportFragmentManager(), getLifecycle(), fragments));
    ...
    private void initAdapter(){
        if (meiJienFenSsdfQiTabAdapter == null){
            meiJienFenSsdfQiTabAdapter = new MeiJienFenSsdfQiTabAdapter(R.layout.adapter_tab_mei_jie_fen_qi, tabModels);
            meiJienFenSsdfQiTabAdapter.setHasStableIds(true);
            meiJienFenSsdfQiTabAdapter.setClickedListener(position -> {
                mainViewPager.setCurrentItem(position, false);
            });
            bottomRvy.setHasFixedSize(true);
            bottomRvy.setLayoutManager(new GridLayoutManager(this, 3));
            bottomRvy.setAdapter(meiJienFenSsdfQiTabAdapter);
        }
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_mei_jie_fen_qi_main;
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK
            ...
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                MyMeiJienFenSsdfQiToast.showShort("再按一次退出程序");
