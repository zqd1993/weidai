...
public class MeiJienFenSsdfQiTabAdapter extends BaseQuickAdapter<MeiJienFenSsdfQiMainActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public MeiJienFenSsdfQiTabAdapter(int layoutResId, @Nullable List<MeiJienFenSsdfQiMainActivity.TabModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MeiJienFenSsdfQiMainActivity.TabModel item) {
