...
public class BarMeiJienFenSsdfQiView extends View {
    public BarMeiJienFenSsdfQiView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public BarMeiJienFenSsdfQiView(Context context) {
        super(context);
    }
