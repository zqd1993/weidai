...
import com.meijiefenqifjsdkqwj.pfdioewjnsd.router.Router;
...
public class MeiJienFenSsdfQiOpenUtil {
    ...
    public static void showErrorInfo(Context context, NetError error) {
        if (error != null) {
            if (error.getType() == NetError.ParseError){
                MyMeiJienFenSsdfQiToast.showShort("数据解析异常");
            } else if (error.getType() == NetError.AuthError){
                MyMeiJienFenSsdfQiToast.showShort("身份验证异常");
            } else if (error.getType() == NetError.BusinessError){
                MyMeiJienFenSsdfQiToast.showShort("业务异常");
            } else if (error.getType() == NetError.NoConnectError){
                MyMeiJienFenSsdfQiToast.showShort("网络无连接");
            } else if (error.getType() == NetError.NoDataError){
                MyMeiJienFenSsdfQiToast.showShort("数据为空");
            } else if (error.getType() == NetError.OtherError){
                MyMeiJienFenSsdfQiToast.showShort("其他异常");
            }
        }
    }
    ...
    public static void getValue(XActivity activity, Class<?> to, Bundle bundle) {
            HttpMeiJienFenSsdfQiApi.getInterfaceUtils().getValue("VIDEOTAPE")
                        ...
                        public void onNext(BaseMeiJienFenSsdfQiModel<ConfigEntityMeiJienFenSsdfQi> configEntity) {
                            if (configEntity != null) {
                                if (configEntity.getData() != null) {
                                    PreferencesMeiJienFenSsdfQiOpenUtil.saveBool("NO_RECORD", !configEntity.getData().getVideoTape().equals("0"));
    ...
    public static List<ClickMeiJienFenSsdfQiTextView.SpanModel> createSpanTexts(){
        List<ClickMeiJienFenSsdfQiTextView.SpanModel> spanModels = new ArrayList<>();
        ClickMeiJienFenSsdfQiTextView.ClickSpanModel spanModel = new ClickMeiJienFenSsdfQiTextView.ClickSpanModel();
        ClickMeiJienFenSsdfQiTextView.SpanModel textSpanModel = new ClickMeiJienFenSsdfQiTextView.SpanModel();
        ...
        textSpanModel = new ClickMeiJienFenSsdfQiTextView.SpanModel();
        textSpanModel.setStr("和");
        spanModels.add(textSpanModel);

        spanModel = new ClickMeiJienFenSsdfQiTextView.ClickSpanModel();
    ...
    public static List<ClickMeiJienFenSsdfQiTextView.SpanModel> createDlSpanTexts() {
        List<ClickMeiJienFenSsdfQiTextView.SpanModel> spanModels = new ArrayList<>();
        ClickMeiJienFenSsdfQiTextView.ClickSpanModel spanModel = new ClickMeiJienFenSsdfQiTextView.ClickSpanModel();
        ClickMeiJienFenSsdfQiTextView.SpanModel textSpanModel = new ClickMeiJienFenSsdfQiTextView.SpanModel();
