...
public class PreferencesMeiJienFenSsdfQiOpenUtil {

    public static void saveInt(String key, int value) {
        MeiJienFenSsdfQiMainApp.getPreferences().edit().putInt(key, value).commit();
    }
    ...
    public static int getInt(String key) {
        return MeiJienFenSsdfQiMainApp.getPreferences().getInt(key, 0);
    }

    public static void saveBool(String key, boolean value) {
        MeiJienFenSsdfQiMainApp.getPreferences().edit().putBoolean(key, value).commit();
    }

    public static void saveString(String key, String value) {
        MeiJienFenSsdfQiMainApp.getPreferences().edit().putString(key, value).commit();
    }
    ...
    public static String getString(String key) {
        return MeiJienFenSsdfQiMainApp.getPreferences().getString(key, "");
    }

    public static boolean getBool(String key) {
        return MeiJienFenSsdfQiMainApp.getPreferences().getBoolean(key, false);
    }
