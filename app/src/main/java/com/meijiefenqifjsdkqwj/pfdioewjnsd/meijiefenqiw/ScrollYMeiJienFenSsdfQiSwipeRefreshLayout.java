...
public class ScrollYMeiJienFenSsdfQiSwipeRefreshLayout extends SwipeRefreshLayout {
    ...
    public ScrollYMeiJienFenSsdfQiSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
