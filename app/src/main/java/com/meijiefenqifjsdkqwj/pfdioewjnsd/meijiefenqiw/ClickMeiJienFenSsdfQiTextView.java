...
public class ClickMeiJienFenSsdfQiTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickMeiJienFenSsdfQiTextView(Context context) {
        super(context);
    }
    ...
    public ClickMeiJienFenSsdfQiTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickMeiJienFenSsdfQiTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private SpannableString getClickableSpan(int i, ClickSpanModel spanModel) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#fd7d18")), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
