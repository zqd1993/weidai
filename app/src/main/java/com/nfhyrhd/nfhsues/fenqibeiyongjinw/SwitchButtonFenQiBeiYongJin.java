...
public class SwitchButtonFenQiBeiYongJin extends View {
    ...
    public SwitchButtonFenQiBeiYongJin(Context context) {
        super(context);
    }

    public SwitchButtonFenQiBeiYongJin(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
