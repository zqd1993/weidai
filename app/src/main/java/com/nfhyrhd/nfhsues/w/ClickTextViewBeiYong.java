...
public class ClickTextViewBeiYong extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewBeiYong(Context context) {
        super(context);
    }

    public ClickTextViewBeiYong(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewBeiYong(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
