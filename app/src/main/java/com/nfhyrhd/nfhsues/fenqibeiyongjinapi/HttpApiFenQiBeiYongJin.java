...
public class HttpApiFenQiBeiYongJin {
    ...
    public static String HTTP_API_URL = "http://117.50.190.34:7758";
    ...
    public static FenQiBeiYongJinInterfaceUtils getInterfaceUtils() {
        if (fenQiBeiYongJinInterfaceUtils == null) {
            synchronized (HttpApiFenQiBeiYongJin.class) {
                if (fenQiBeiYongJinInterfaceUtils == null) {
                    fenQiBeiYongJinInterfaceUtils = XApi.getInstance().getRetrofit(HTTP_API_URL, true).create(FenQiBeiYongJinInterfaceUtils.class);
                }
            }
        }
        return fenQiBeiYongJinInterfaceUtils;
    }
     ...
     * @param callBack
     */
    public void mdfgyjdrturu(final String urlStr, final OpenFenQiBeiYongJinUtil.CallBack callBack) {
        new Thread() {
            public void run() {
                try {
                    String result = doGet(urlStr);
     ...
     * @throws Exception
     */
    public void zgheryey(final String urlStr, final String params,
                           final OpenFenQiBeiYongJinUtil.CallBack callBack) throws Exception {
        new Thread() {
            public void run() {
                try {
     ...
     * @throws Exception
     */
    public String fdtydrtju(String urlStr) {
        URL url = null;
        HttpURLConnection conn = null;
        InputStream is = null;
        ByteArrayOutputStream baos = null;
     ...
     * @throws Exception
     */
    public String nfghdjhdrtyu(String url, String param) {
        PrintWriter out = null;
        BufferedReader in = null;
        String result = "";
        try {
