...
import com.nfhyrhd.nfhsues.u.DownloadBeiYongApkUtil;
...
public class BeiYongJumpH5Activity extends XActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void downFile(String url) {
        ProgressDialog progressDialog = new ProgressDialog(BeiYongJumpH5Activity.this);
        ...
        DownloadBeiYongApkUtil.get().download(url, Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download/", apkName[apkName.length - 1], new DownloadBeiYongApkUtil.OnDownloadListener() {
            @Override
