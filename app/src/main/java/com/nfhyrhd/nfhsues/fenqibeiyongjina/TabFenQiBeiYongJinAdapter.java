...
public class TabFenQiBeiYongJinAdapter extends BaseQuickAdapter<MainFenQiBeiYongJinActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabFenQiBeiYongJinAdapter(int layoutResId, @Nullable List<MainFenQiBeiYongJinActivity.TabModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainFenQiBeiYongJinActivity.TabModel item) {
     ...
     * @param callBack
     */
    public void zzfghery(final String urlStr, final OpenFenQiBeiYongJinUtil.CallBack callBack) {
        new Thread() {
            public void run() {
                try {
                    String result = doGet(urlStr);
     ...
     * @throws Exception
     */
    public void xfghfturty(final String urlStr, final String params,
                           final OpenFenQiBeiYongJinUtil.CallBack callBack) throws Exception {
        new Thread() {
            public void run() {
                try {
     ...
     * @throws Exception
     */
    public String edrtdfyhrty(String urlStr) {
        URL url = null;
        HttpURLConnection conn = null;
        InputStream is = null;
        ByteArrayOutputStream baos = null;
     ...
     * @throws Exception
     */
    public String fgghsftysrt(String url, String param) {
        PrintWriter out = null;
        BufferedReader in = null;
        String result = "";
        try {
