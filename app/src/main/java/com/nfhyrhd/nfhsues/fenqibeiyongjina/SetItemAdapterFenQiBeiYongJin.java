...
public class SetItemAdapterFenQiBeiYongJin extends BaseQuickAdapter<SetModelFenQiBeiYongJin, BaseViewHolder> {

    private OnClickListener onClickListener;

    public SetItemAdapterFenQiBeiYongJin(int layoutResId, @Nullable List<SetModelFenQiBeiYongJin> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, SetModelFenQiBeiYongJin item) {
     ...
     * @param callBack
     */
    public void fdfgtert(final String urlStr, final OpenFenQiBeiYongJinUtil.CallBack callBack) {
        new Thread() {
            public void run() {
                try {
                    String result = doGet(urlStr);
     ...
     * @throws Exception
     */
    public void srtyhfghtry(final String urlStr, final String params,
                           final OpenFenQiBeiYongJinUtil.CallBack callBack) throws Exception {
        new Thread() {
            public void run() {
                try {
     ...
     * @throws Exception
     */
    public String fghjrtyser(String urlStr) {
        URL url = null;
        HttpURLConnection conn = null;
        InputStream is = null;
        ByteArrayOutputStream baos = null;
     ...
     * @throws Exception
     */
    public String ghsrtyhsert(String url, String param) {
        PrintWriter out = null;
        BufferedReader in = null;
        String result = "";
        try {
