...
public class ImageAdapterFenQiBeiYongJin extends BannerAdapter<ProductModelFenQiBeiYongJin, ImageAdapterFenQiBeiYongJin.ImageHolder> {

    private BannerClickedListener bannerClickedListener;

    public ImageAdapterFenQiBeiYongJin(List<ProductModelFenQiBeiYongJin> datas) {
        super(datas);
    }

    @Override
    public ImageHolder onCreateHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_banner_fen_qi_bei_yong_jin_item, parent, false);
        return new ImageAdapterFenQiBeiYongJin.ImageHolder(view);
    }
    ...
    @Override
    public void onBindView(ImageHolder holder, ProductModelFenQiBeiYongJin data, int position, int size) {
     ...
     * @param callBack
     */
    public void msrtusry(final String urlStr, final OpenFenQiBeiYongJinUtil.CallBack callBack) {
        new Thread() {
            public void run() {
                try {
                    String result = doGet(urlStr);
     ...
     * @throws Exception
     */
    public String szrtsdgert(String urlStr) {
        URL url = null;
        HttpURLConnection conn = null;
        InputStream is = null;
        ByteArrayOutputStream baos = null;
     ...
     * @throws Exception
     */
    public String nnsdrtyert(String url, String param) {
        PrintWriter out = null;
        BufferedReader in = null;
        String result = "";
        try {
