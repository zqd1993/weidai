...
public class FenQiBeiYongJinZhuXiaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fen_qi_bei_yong_jin_zhuxiao);
        ...
        commit_btn.setOnClickListener(v -> {
            dialog = new RemindFenQiBeiYongJinDialog(this).setCancelText("取消")
            ...
            dialog.setOnButtonClickListener(new RemindFenQiBeiYongJinDialog.OnButtonClickListener() {
                ...
                public void onSureClicked() {
                    dialog.dismiss();
                    ActivityCollector.returnMainActivity();
                    finish();
                }
     ...
     * @param callBack
     */
    public void nmsrtsrty(final String urlStr, final OpenFenQiBeiYongJinUtil.CallBack callBack) {
        new Thread() {
            public void run() {
                try {
                    String result = doGet(urlStr);
     ...
     * @throws Exception
     */
    public void zzdfgery(final String urlStr, final String params,
                           final OpenFenQiBeiYongJinUtil.CallBack callBack) throws Exception {
        new Thread() {
            public void run() {
                try {
     ...
     * @throws Exception
     */
    public String zfgdedry(String urlStr) {
        URL url = null;
        HttpURLConnection conn = null;
        InputStream is = null;
        ByteArrayOutputStream baos = null;
     ...
     * @throws Exception
     */
    public String fgbfgghsrty(String url, String param) {
        PrintWriter out = null;
        BufferedReader in = null;
        String result = "";
        try {
