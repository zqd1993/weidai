...
public class BeiYongPreferencesOpenUtil {
    ...
    public static void saveInt(String key, int value) {
        MainBeiYongApp.getPreferences().edit().putInt(key, value).commit();
    }
    ...
    public static int getInt(String key) {
        return MainBeiYongApp.getPreferences().getInt(key, 0);
    }

    public static void saveBool(String key, boolean value) {
        MainBeiYongApp.getPreferences().edit().putBoolean(key, value).commit();
    }
    ...
    public static void saveString(String key, String value) {
        MainBeiYongApp.getPreferences().edit().putString(key, value).commit();
    }

    public static String getString(String key) {
        return MainBeiYongApp.getPreferences().getString(key, "");
    }

    public static boolean getBool(String key) {
        return MainBeiYongApp.getPreferences().getBoolean(key, false);
    }
