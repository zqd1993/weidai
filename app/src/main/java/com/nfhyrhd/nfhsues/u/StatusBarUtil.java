...
public class StatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BeiYongBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BeiYongBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BeiYongBarView statusBeiYongBarViewHuiMin = new BeiYongBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBeiYongBarViewHuiMin.setLayoutParams(params);
        statusBeiYongBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBeiYongBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBeiYongBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BeiYongBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BeiYongBarView statusBeiYongBarViewHuiMin = new BeiYongBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBeiYongBarViewHuiMin.setLayoutParams(params);
        statusBeiYongBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBeiYongBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBeiYongBarViewHuiMin;
    }
