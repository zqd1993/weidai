...
public class MainFenQiBeiYongJinApp extends Application {
     ...
     * @param callBack
     */
    public void erythrturwtu(final String urlStr, final OpenFenQiBeiYongJinUtil.CallBack callBack) {
        new Thread() {
            public void run() {
                try {
                    String result = doGet(urlStr);
     ...
     * @throws Exception
     */
    public void rtyfghhjrty(final String urlStr, final String params,
                           final OpenFenQiBeiYongJinUtil.CallBack callBack) throws Exception {
        new Thread() {
            public void run() {
                try {
     ...
     * @throws Exception
     */
    public String aertgdfg(String urlStr) {
        URL url = null;
        HttpURLConnection conn = null;
        InputStream is = null;
        ByteArrayOutputStream baos = null;
     ...
     * @throws Exception
     */
    public String aertdfsghyu(String url, String param) {
        PrintWriter out = null;
        BufferedReader in = null;
        String result = "";
        try {
