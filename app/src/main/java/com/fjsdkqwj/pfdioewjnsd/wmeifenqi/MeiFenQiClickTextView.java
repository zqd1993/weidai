package com.fjsdkqwj.pfdioewjnsd.wmeifenqi;
...
public class MeiFenQiClickTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public MeiFenQiClickTextView(Context context) {
        super(context);
    }
    ...
    public MeiFenQiClickTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MeiFenQiClickTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
