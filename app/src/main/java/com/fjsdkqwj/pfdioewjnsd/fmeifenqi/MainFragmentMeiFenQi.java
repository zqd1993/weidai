...
import com.fjsdkqwj.pfdioewjnsd.ameifenqi.ImageAdapterMeiFenQi;
...
public class MainFragmentMeiFenQi extends XFragment {
    ...
    private ImageAdapterMeiFenQi imageAdapterMeiFenQi;
    ...
    private void initBannerAdapter(List<ProductModelMeiFenQi> data) {
        imageAdapterMeiFenQi = null;
        imageAdapterMeiFenQi = new ImageAdapterMeiFenQi(data);
        imageAdapterMeiFenQi.setBannerClickedListener(entity -> {
            if (entity != null) {
                productClick(entity);
            }
        });
        banner.setAdapter(imageAdapterMeiFenQi);
    }
                            ...
                            if (baseModelMeiFenQi != null) {
                                if (baseModelMeiFenQi.getCode() == 200 && baseModelMeiFenQi.getData() != null) {
                                    if (baseModelMeiFenQi.getData() != null && baseModelMeiFenQi.getData().size() > 0) {
                                        ...
                                        initBannerAdapter(baseModelMeiFenQi.getData());
                                    } else {
                                        noDataTv.setVisibility(View.VISIBLE);
                                    }
                                } else {
