...
public class MeiFenQiTabAdapter extends BaseQuickAdapter<MainMeiFenQiActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public MeiFenQiTabAdapter(int layoutResId, @Nullable List<MainMeiFenQiActivity.TabModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MainMeiFenQiActivity.TabModel item) {
