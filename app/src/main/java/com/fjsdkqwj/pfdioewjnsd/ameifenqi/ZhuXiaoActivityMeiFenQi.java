...
public class ZhuXiaoActivityMeiFenQi extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhuxiao_mei_fen_qi);
        ...
        commit_btn.setOnClickListener(v -> {
            dialog = new RemindMeiFenQiDialog(this).setCancelText("取消")
