...
public class MeiFenQiSetItemAdapter extends BaseQuickAdapter<MeiFenQiSetModel, BaseViewHolder> {

    private OnClickListener onClickListener;

    public MeiFenQiSetItemAdapter(int layoutResId, @Nullable List<MeiFenQiSetModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MeiFenQiSetModel item) {
