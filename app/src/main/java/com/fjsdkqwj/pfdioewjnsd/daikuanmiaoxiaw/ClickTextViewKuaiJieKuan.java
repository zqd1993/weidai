package com.fjsdkqwj.pfdioewjnsd.daikuanmiaoxiaw;
...
public class ClickTextViewKuaiJieKuan extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewKuaiJieKuan(Context context) {
        super(context);
    }

    public ClickTextViewKuaiJieKuan(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewKuaiJieKuan(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private SpannableString getClickableSpan(int i, ClickSpanModel spanModel) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#e07a58")), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
