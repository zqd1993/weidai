 ...
 */
public class StatusBarKuaiJieKuanUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarDaiKuaiJieKuanView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarDaiKuaiJieKuanView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarDaiKuaiJieKuanView statusBarDaiKuaiJieKuanViewHuiMin = new BarDaiKuaiJieKuanView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarDaiKuaiJieKuanViewHuiMin.setLayoutParams(params);
        statusBarDaiKuaiJieKuanViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarDaiKuaiJieKuanViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarDaiKuaiJieKuanViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarDaiKuaiJieKuanView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarDaiKuaiJieKuanView statusBarDaiKuaiJieKuanViewHuiMin = new BarDaiKuaiJieKuanView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarDaiKuaiJieKuanViewHuiMin.setLayoutParams(params);
        statusBarDaiKuaiJieKuanViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarDaiKuaiJieKuanViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarDaiKuaiJieKuanViewHuiMin;
    }
