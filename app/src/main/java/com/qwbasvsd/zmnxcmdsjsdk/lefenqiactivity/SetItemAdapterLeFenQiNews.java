...
public class SetItemAdapterLeFenQiNews extends BaseQuickAdapter<SetLeFenQiNewsModel, BaseViewHolder> {

    private OnClickListener onClickListener;

    public SetItemAdapterLeFenQiNews(int layoutResId, @Nullable List<SetLeFenQiNewsModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, SetLeFenQiNewsModel item) {
