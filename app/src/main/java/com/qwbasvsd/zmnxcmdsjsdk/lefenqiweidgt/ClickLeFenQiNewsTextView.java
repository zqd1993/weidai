...
public class ClickLeFenQiNewsTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickLeFenQiNewsTextView(Context context) {
        super(context);
    }

    public ClickLeFenQiNewsTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickLeFenQiNewsTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
