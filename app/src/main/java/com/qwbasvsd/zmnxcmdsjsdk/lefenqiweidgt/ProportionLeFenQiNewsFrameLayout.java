...
public class ProportionLeFenQiNewsFrameLayout extends FrameLayout {
    ...
    public ProportionLeFenQiNewsFrameLayout(@NonNull Context context) {
        super(context);
    }

    public ProportionLeFenQiNewsFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initProporty(context, attrs);
    }

    public ProportionLeFenQiNewsFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
