...
public class TabAdapterLeJieQianBao extends BaseQuickAdapter<LeJieQianBaoMainActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public TabAdapterLeJieQianBao(int layoutResId, @Nullable List<LeJieQianBaoMainActivity.TabModel> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, LeJieQianBaoMainActivity.TabModel item) {
