...
public class SetItemAdapterLeJieQianBao extends BaseQuickAdapter<SetModelLeJieQianBao, BaseViewHolder> {

    private OnClickListener onClickListener;

    public SetItemAdapterLeJieQianBao(int layoutResId, @Nullable List<SetModelLeJieQianBao> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NonNull BaseViewHolder helper, SetModelLeJieQianBao item) {
