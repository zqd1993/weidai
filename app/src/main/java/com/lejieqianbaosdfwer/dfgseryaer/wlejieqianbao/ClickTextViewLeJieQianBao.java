...
public class ClickTextViewLeJieQianBao extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public ClickTextViewLeJieQianBao(Context context) {
        super(context);
    }

    public ClickTextViewLeJieQianBao(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ClickTextViewLeJieQianBao(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private SpannableString getClickableSpan(int i, ClickSpanModel spanModel) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#0540f0")), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
