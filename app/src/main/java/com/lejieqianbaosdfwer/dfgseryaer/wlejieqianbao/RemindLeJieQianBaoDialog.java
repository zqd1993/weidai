package com.lejieqianbaosdfwer.dfgseryaer.wlejieqianbao;
...
public class RemindLeJieQianBaoDialog extends Dialog {
    ...
    public RemindLeJieQianBaoDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_le_jie_qian_bao_normal);
    ...
    public RemindLeJieQianBaoDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public RemindLeJieQianBaoDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public RemindLeJieQianBaoDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public RemindLeJieQianBaoDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public RemindLeJieQianBaoDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
