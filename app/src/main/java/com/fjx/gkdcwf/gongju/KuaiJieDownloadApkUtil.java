...
public class KuaiJieDownloadApkUtil {
    private static KuaiJieDownloadApkUtil downloadApkUtil;
    ...
    public static KuaiJieDownloadApkUtil get() {
        if (downloadApkUtil == null) {
            downloadApkUtil = new KuaiJieDownloadApkUtil();
        }
        return downloadApkUtil;
    }

    private KuaiJieDownloadApkUtil() {
