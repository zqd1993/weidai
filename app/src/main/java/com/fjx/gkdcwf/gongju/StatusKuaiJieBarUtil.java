 ...
 */
public class StatusKuaiJieBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static BarKuaiJieView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static BarKuaiJieView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarKuaiJieView statusBarKuaiJieViewHuiMin = new BarKuaiJieView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarKuaiJieViewHuiMin.setLayoutParams(params);
        statusBarKuaiJieViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusBarKuaiJieViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusBarKuaiJieViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static BarKuaiJieView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        BarKuaiJieView statusBarKuaiJieViewHuiMin = new BarKuaiJieView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarKuaiJieViewHuiMin.setLayoutParams(params);
        statusBarKuaiJieViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusBarKuaiJieViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusBarKuaiJieViewHuiMin;
    }
