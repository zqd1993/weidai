...
public class StartPageKuaiJieRemindDialog extends Dialog {

    @BindView(R.id.two_btn)
    TextView twoBtn;
    @BindView(R.id.tv_txt)
    ClickKuaiJieTextView tvTxt;
    @BindView(R.id.one_btn)
    TextView oneBtn;

    private OnListener onListener;

    public StartPageKuaiJieRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_kuaijie_start_page);
        ...
        tvTxt.setText(OpenKuaiJieUtil.createSpanTexts(), position -> {
            switch (position) {
                case 1:
                    if (onListener != null) {
