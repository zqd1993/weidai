...
public class KuaiJieSetItemAdapter extends BaseQuickAdapter<SetModel, BaseViewHolder> {

    private OnClickListener onClickListener;

    public KuaiJieSetItemAdapter(int layoutResId, @Nullable List<SetModel> data) {
