...
public class ZhuXiaoActivityKuaiJie extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuaijie_zhuxiao);
        ...
        commit_btn.setOnClickListener(v -> {
            dialog = new RemindKuaiJieDialog(this).setCancelText("取消")
