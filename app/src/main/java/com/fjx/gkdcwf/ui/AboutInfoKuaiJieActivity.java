...
public class AboutInfoKuaiJieActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TextView versionTv = findViewById(R.id.version_code_tv);
        versionTv.setText("当前版本号：v" + OpenKuaiJieUtil.getAppVersion(KuaiJieApp.getContext()));
