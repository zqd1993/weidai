 ...
 */
public class JiXinStatusBarUtil {
     ...
     * @return 状态栏矩形条
     */
    private static JiXinBarView createStatusBarView(Activity activity, @ColorInt int color) {
     ...
     * @return 状态栏矩形条
     */
    private static JiXinBarView createStatusBarView(Activity activity, @ColorInt int color, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JiXinBarView statusJiXinBarViewHuiMin = new JiXinBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusJiXinBarViewHuiMin.setLayoutParams(params);
        statusJiXinBarViewHuiMin.setBackgroundColor(calculateStatusColor(color, alpha));
        statusJiXinBarViewHuiMin.setId(FAKE_STATUS_BAR_VIEW_ID);
        return statusJiXinBarViewHuiMin;
    }
...
//            Log.w(e.getMessage());
     ...
     * @return 半透明 View
     */
    private static JiXinBarView createTranslucentStatusBarView(Activity activity, int alpha) {
        // 绘制一个和状态栏一样高的矩形
        JiXinBarView statusJiXinBarViewHuiMin = new JiXinBarView(activity);
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusJiXinBarViewHuiMin.setLayoutParams(params);
        statusJiXinBarViewHuiMin.setBackgroundColor(Color.argb(alpha, 0, 0, 0));
        statusJiXinBarViewHuiMin.setId(FAKE_TRANSLUCENT_VIEW_ID);
        return statusJiXinBarViewHuiMin;
    }
