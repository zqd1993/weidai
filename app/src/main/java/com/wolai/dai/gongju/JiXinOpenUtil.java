...
public class JiXinOpenUtil {
    ...
    public static List<JiXinClickTextView.SpanModel> createSpanTexts(){
        List<JiXinClickTextView.SpanModel> spanModels = new ArrayList<>();
        JiXinClickTextView.ClickSpanModel spanModel = new JiXinClickTextView.ClickSpanModel();
        JiXinClickTextView.SpanModel textSpanModel = new JiXinClickTextView.SpanModel();
    ...
    public static List<JiXinClickTextView.SpanModel> createDlSpanTexts() {
        List<JiXinClickTextView.SpanModel> spanModels = new ArrayList<>();
        JiXinClickTextView.ClickSpanModel spanModel = new JiXinClickTextView.ClickSpanModel();
        JiXinClickTextView.SpanModel textSpanModel = new JiXinClickTextView.SpanModel();
