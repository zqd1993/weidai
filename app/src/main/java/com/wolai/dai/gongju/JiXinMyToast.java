...
//        mac = getMachineHardwareAddress();
    ...
    private JiXinMyToast() {
    }


    public static void showToast(String text) {
        Toast.makeText(JixinApp.getContext(), text, Toast.LENGTH_SHORT).show();
    }

    public static void showToast(int id) {
        Toast.makeText(JixinApp.getContext().getApplicationContext(), id, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showShort(String message) {
        ...
        Toast.makeText(JixinApp.getContext(), message, Toast.LENGTH_SHORT).show();
    }
