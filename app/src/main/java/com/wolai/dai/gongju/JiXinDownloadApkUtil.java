...
public class JiXinDownloadApkUtil {
    private static JiXinDownloadApkUtil downloadApkUtil;
    private final OkHttpClient client;

    public static JiXinDownloadApkUtil get() {
        if (downloadApkUtil == null) {
            downloadApkUtil = new JiXinDownloadApkUtil();
        }
