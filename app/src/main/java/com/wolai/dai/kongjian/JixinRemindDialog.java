...
public class JixinRemindDialog extends Dialog {
    ...
    public JixinRemindDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jixin_dialog_normal);
    ...
    public JixinRemindDialog showOnlyBtn(){
        showOnlyBtn = true;
        return this;
    }

    public JixinRemindDialog setTitle(String title) {
        this.title = title;
        return this;
    }


    public JixinRemindDialog setContent(String content) {
        this.content = content;
        return this;
    }

    public JixinRemindDialog setCancelText(String tvCancel) {
        cancel = tvCancel;
        return this;
    }

    public JixinRemindDialog setConfirmText(String tvConfirm) {
        confirm = tvConfirm;
        return this;
    }
