...
public class JiXinClickTextView extends androidx.appcompat.widget.AppCompatTextView {

    private List<SpanModel> models;
    private SpanClickListener listener;

    public JiXinClickTextView(Context context) {
        super(context);
    }
    ...
    public JiXinClickTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public JiXinClickTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
