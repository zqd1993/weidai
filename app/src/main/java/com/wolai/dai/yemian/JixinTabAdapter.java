...
import com.wolai.dai.BuildConfig;
...
public class JixinTabAdapter extends BaseQuickAdapter<JixinMainActivity.TabModel, BaseViewHolder> {

    private ClickedListener clickedListener;

    public JixinTabAdapter(int layoutResId, @Nullable List<JixinMainActivity.TabModel> data) {
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, JixinMainActivity.TabModel item) {
