...
public class ShouJiDaiFeedBackActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        commitBtn.setOnClickListener(v -> {
            if (TextUtils.isEmpty(feedbackEt.getText().toString().trim())){
                ShouJiDaiToastUtil.showShort("请输入提交内容");
                return;
            }
            rotateLoading.start();
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    rotateLoading.stop();
                    ShouJiDaiToastUtil.showShort("提交成功");
                    finish();
                }
            }, 2000);
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_shou_ji_dai_feedback;
    }
