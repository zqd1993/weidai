...
public class HomePageActivityShouJiDai extends XActivity<MainShouJiDaiPresent> {
    ...
    private MyShouJiDaiFragmentAdapter myShouJiDaiFragmentAdapter;
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        mFragments.add(HomePageFragmentShouJiDai.getInstant(1));
        mFragments.add(HomePageFragmentShouJiDai.getInstant(2));
        mFragments.add(new MineShouJiDaiFragment());

        homeViewPager.setAdapter(new MyShouJiDaiFragmentAdapter(getSupportFragmentManager(), getLifecycle(), mFragments));
    }
    ...
    public int getLayoutId() {
        return R.layout.activity_home_page_shou_ji_dai;
    }

    @Override
    public MainShouJiDaiPresent newP() {
        return new MainShouJiDaiPresent();
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK
            ...
            if ((System.currentTimeMillis() - exitTime) > 2000) {
                ShouJiDaiToastUtil.showShort("再按一次退出程序");
