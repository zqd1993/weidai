...
import com.tergbaedd.bbbdstrga.sjdpresent.ShouJiDaiHomePagePresent;
...
public class HomePageFragmentShouJiDai extends XFragment<ShouJiDaiHomePagePresent> {
    ...
    public static HomePageFragmentShouJiDai getInstant(int tag) {
        HomePageFragmentShouJiDai homePageFragmentShouJiDai = new HomePageFragmentShouJiDai();
        Bundle bundle = new Bundle();
        bundle.putInt("tag", tag);
        homePageFragmentShouJiDai.setArguments(bundle);
        return homePageFragmentShouJiDai;
    }
    ...
    public int getLayoutId() {
        return R.layout.fragment_shou_ji_dai_home_page;
    }

    @Override
    public ShouJiDaiHomePagePresent newP() {
        return new ShouJiDaiHomePagePresent();
    }

    private void productClick(ShouJiDaiGoodsModel model){
        if (model != null) {
            getP().productClick(model);
        }
    }

    public void jumpWebActivity (ShouJiDaiGoodsModel model){
        if (model != null) {
    ...
    public void initGoodsItemAdapter(List<ShouJiDaiGoodsModel> mData) {
        if (goodsItemAdapterShouJiDai == null) {
            goodsItemAdapterShouJiDai = new GoodsItemAdapterShouJiDai(getActivity());
            goodsItemAdapterShouJiDai.setRecItemClick(new RecyclerItemCallback<ShouJiDaiGoodsModel, GoodsItemAdapterShouJiDai.ViewHolder>() {
                @Override
                public void onItemClick(int position, ShouJiDaiGoodsModel model, int tag, GoodsItemAdapterShouJiDai.ViewHolder holder) {
    ...
    public void setModel(ShouJiDaiGoodsModel shouJiDaiGoodsModel){
        this.shouJiDaiGoodsModel = shouJiDaiGoodsModel;
    }
}
