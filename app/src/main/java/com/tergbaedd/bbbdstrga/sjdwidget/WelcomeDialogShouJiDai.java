...
public class WelcomeDialogShouJiDai extends Dialog {

    @BindView(R.id.tv_title)
    TextView tvTitle;
    @BindView(R.id.tv_content)
    SpanTextViewShouJiDai tvContent;
    ...
    public WelcomeDialogShouJiDai(@NonNull Context context, String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_welcome_shou_ji_dai);
    ...
    private List<SpanTextViewShouJiDai.BaseSpanModel> createSpanTexts(){
        ...
        textSpanModel = new SpanTextViewShouJiDai.TextSpanModel();
