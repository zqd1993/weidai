...
public class SpanTextViewShouJiDai extends androidx.appcompat.widget.AppCompatTextView {

    private List<BaseSpanModel> spanModels;
    private SpanClickListener listener;

    public SpanTextViewShouJiDai(Context context) {
        super(context);
    }

    public SpanTextViewShouJiDai(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public SpanTextViewShouJiDai(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
